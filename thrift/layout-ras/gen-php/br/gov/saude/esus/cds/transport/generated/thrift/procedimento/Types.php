...
class FichaProcedimentoChildThrift {
        ...
        case 9:
          if ($ftype == TType::LST) {
            ...
            for ($_i10 = 0; $_i10 < $_size6; ++$_i10)
            {
              ...
              $this->outrosSiaProcedimentosV321 []= $elem11;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->outrosSiaProcedimentosV321 !== null) {
      ...
      $xfer += $output->writeFieldBegin('outrosSiaProcedimentosV321', TType::LST, 9);
      {
        $output->writeListBegin(TType::STRING, count($this->outrosSiaProcedimentosV321));
        {
          foreach ($this->outrosSiaProcedimentosV321 as $iter13)
          {

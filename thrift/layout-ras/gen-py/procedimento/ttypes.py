...
class FichaProcedimentoChildThrift:
  ...
  thrift_spec = (
    ...
    (9, TType.LIST, 'outrosSiaProcedimentosV321', (TType.STRING,None), None, ), # 9
  ...
  def __init__(self, numProntuario=None, cnsCidadao=None, dtNascimento=None, sexo=None, localAtendimento=None, turno=None, statusEscutaInicialOrientacao=None, procedimentos=None, outrosSiaProcedimentosV321=None, dataHoraInicialAtendimento=None, dataHoraFinalAtendimento=None, cpfCidadao=None,):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i10 in xrange(_size6):
            ...
            self.outrosSiaProcedimentosV321.append(_elem11)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 10:
  ...
  def write(self, oprot):
    ...
    if self.outrosSiaProcedimentosV321 is not None:
      oprot.writeFieldBegin('outrosSiaProcedimentosV321', TType.LIST, 9)
      oprot.writeListBegin(TType.STRING, len(self.outrosSiaProcedimentosV321))
      for iter13 in self.outrosSiaProcedimentosV321:
...
class FichaProcedimentoMasterThrift:
  ...
  thrift_spec = (
    ...
    (3, TType.STRUCT, 'headerTransport', (common.ttypes.UnicaLotacaoHeaderThrift, common.ttypes.UnicaLotacaoHeaderThrift.thrift_spec), None, ), # 3

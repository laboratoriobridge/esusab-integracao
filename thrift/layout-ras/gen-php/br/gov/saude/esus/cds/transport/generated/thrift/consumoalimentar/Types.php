<?php
namespace br\gov\saude\esus\cds\transport\generated\thrift\consumoalimentar;
...
class FichaConsumoAlimentarThrift {
  ...
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\consumoalimentar\PerguntaQuestionarioCriancasMenoresSeisMesesThrift[]
   */
  public $perguntasQuestionarioCriancasMenoresSeisMeses = null;
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\consumoalimentar\PerguntaQuestionarioCriancasDeSeisVinteTresMesesThrift[]
   */
  public $perguntasQuestionarioCriancasDeSeisVinteTresMeses = null;
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\consumoalimentar\PerguntaQuestionarioCriancasComMaisDoisAnosThrift[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        7 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\consumoalimentar\PerguntaQuestionarioCriancasMenoresSeisMesesThrift',
            ),
          ),
        8 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\consumoalimentar\PerguntaQuestionarioCriancasDeSeisVinteTresMesesThrift',
            ),
          ),
        9 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\consumoalimentar\PerguntaQuestionarioCriancasComMaisDoisAnosThrift',
            ),
          ),
        10 => array(
          'var' => 'uuidFicha',
      ...
      switch ($fid)
      {
        ...
        case 7:
          if ($ftype == TType::LST) {
            ...
            {
              $elem12 = null;
              $elem12 = new \br\gov\saude\esus\cds\transport\generated\thrift\consumoalimentar\PerguntaQuestionarioCriancasMenoresSeisMesesThrift();
        ...
        case 8:
          if ($ftype == TType::LST) {
            ...
            {
              $elem18 = null;
              $elem18 = new \br\gov\saude\esus\cds\transport\generated\thrift\consumoalimentar\PerguntaQuestionarioCriancasDeSeisVinteTresMesesThrift();
        ...
        case 9:
          if ($ftype == TType::LST) {
            ...
            {
              $elem24 = null;
              $elem24 = new \br\gov\saude\esus\cds\transport\generated\thrift\consumoalimentar\PerguntaQuestionarioCriancasComMaisDoisAnosThrift();

...
type
  ...
  IFamiliaRowThrift = interface(IBase)
    ...
    property CpfResponsavel: string read GetCpfResponsavel write SetCpfResponsavel;
    ...
    function Get__isset_CpfResponsavel: Boolean;
    ...
    property __isset_CpfResponsavel: Boolean read Get__isset_CpfResponsavel;
  end;
  ...
  private
    ...
    F__isset_CpfResponsavel: Boolean;
...
function TFamiliaRowThriftImpl.GetCpfResponsavel: string;
begin
  Result := FCpfResponsavel;
end;

procedure TFamiliaRowThriftImpl.SetCpfResponsavel( const Value: string);
begin
  F__isset_CpfResponsavel := True;
  FCpfResponsavel := Value;
end;

function TFamiliaRowThriftImpl.Get__isset_CpfResponsavel: Boolean;
begin
  Result := F__isset_CpfResponsavel;
end;
...
begin
  ...
  if (__isset_CpfResponsavel) then
  begin
    field_.Name := 'cpfResponsavel';
    field_.Type_  := TType.String_;
    field_.ID := 8;
    oprot.WriteFieldBegin(field_);
...
begin
  ...
  try
    ...
    if (__isset_CpfResponsavel) then begin
      if not _first5 then _sb4.Append(',');
      _first5 := FALSE;
      _sb4.Append('CpfResponsavel: ');
      _sb4.Append(CpfResponsavel);
    end;
    _sb4.Append(')');
...
function TCadastroDomiciliarThriftImpl.GetDadosGeraisV2000: IHeaderCdsCadastroThrift;
begin
  Result := FDadosGeraisV2000;
end;

procedure TCadastroDomiciliarThriftImpl.SetDadosGeraisV2000( const Value: IHeaderCdsCadastroThrift);
begin
  F__isset_DadosGeraisV2000 := True;
  FDadosGeraisV2000 := Value;
end;

function TCadastroDomiciliarThriftImpl.Get__isset_DadosGeraisV2000: Boolean;
begin
...
begin
  ...
  try
    ...
    if (DadosGeraisV2000 <> nil) and __isset_DadosGeraisV2000 then begin
      if not _first17 then _sb16.Append(',');
      _first17 := FALSE;
      _sb16.Append('DadosGeraisV2000: ');
      if (DadosGeraisV2000 = nil) then _sb16.Append('<null>') else _sb16.Append(DadosGeraisV2000.ToString());
    end;

...
namespace br.gov.saude.esus.cds.transport.generated.thrift.atendimentodomiciliar
{
  ...
  public partial class FichaAtendimentoDomiciliarChildThrift : TBase
  {
    ...
    private List<string> _outrosProcedimentosV321;
    private long _condutaDesfecho;
    private bool _statusInicioAcompanhamentoPosObitoV200;
    ...
    public List<string> OutrosProcedimentosV321
    {
      get
      {
        return _outrosProcedimentosV321;
      }
      set
      {
        __isset.outrosProcedimentosV321 = true;
        this._outrosProcedimentosV321 = value;
      }
    }
    ...
    public bool StatusInicioAcompanhamentoPosObitoV200
    {
      get
      {
        return _statusInicioAcompanhamentoPosObitoV200;
      }
      set
      {
        __isset.statusInicioAcompanhamentoPosObitoV200 = true;
        this._statusInicioAcompanhamentoPosObitoV200 = value;
      }
    }
    ...
    public struct Isset {
      ...
      public bool outrosProcedimentosV321;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 12:
              if (field.Type == TType.List) {
                {
                  OutrosProcedimentosV321 = new List<string>();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (OutrosProcedimentosV321 != null && __isset.outrosProcedimentosV321) {
          field.Name = "outrosProcedimentosV321";
          field.Type = TType.List;
          field.ID = 12;
          oprot.WriteFieldBegin(field);
          {
            oprot.WriteListBegin(new TList(TType.String, OutrosProcedimentosV321.Count));
            foreach (string _iter11 in OutrosProcedimentosV321)
            {
        ...
        if (__isset.statusInicioAcompanhamentoPosObitoV200) {
          field.Name = "statusInicioAcompanhamentoPosObitoV200";
    ...
    public override string ToString() {
      ...
      if (OutrosProcedimentosV321 != null && __isset.outrosProcedimentosV321) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("OutrosProcedimentosV321: ");
        __sb.Append(OutrosProcedimentosV321);
      }
      if (__isset.condutaDesfecho) {
        if(!__first) { __sb.Append(", "); }
      ...
      if (__isset.statusInicioAcompanhamentoPosObitoV200) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("StatusInicioAcompanhamentoPosObitoV200: ");
        __sb.Append(StatusInicioAcompanhamentoPosObitoV200);
      }
      if (CpfCidadao != null && __isset.cpfCidadao) {
        if(!__first) { __sb.Append(", "); }

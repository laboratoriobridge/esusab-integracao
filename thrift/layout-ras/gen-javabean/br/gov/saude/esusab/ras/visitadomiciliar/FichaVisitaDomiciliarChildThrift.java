...
public class FichaVisitaDomiciliarChildThrift implements org.apache.thrift.TBase<FichaVisitaDomiciliarChildThrift, FichaVisitaDomiciliarChildThrift._Fields>, java.io.Serializable, Cloneable, Comparable<FichaVisitaDomiciliarChildThrift> {
  ...
  private static final org.apache.thrift.protocol.TField UUID_FCD_FIELD_DESC = new org.apache.thrift.protocol.TField("uuidFcd", org.apache.thrift.protocol.TType.STRING, (short)22);
  ...
  private String uuidFcd; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.LONGITUDE, new org.apache.thrift.meta_data.FieldMetaData("longitude", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
    tmpMap.put(_Fields.UUID_FCD, new org.apache.thrift.meta_data.FieldMetaData("uuidFcd", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public FichaVisitaDomiciliarChildThrift(FichaVisitaDomiciliarChildThrift other) {
    ...
    if (other.isSetUuidFcd()) {
      this.uuidFcd = other.uuidFcd;
    }
  }
  ...
  public String getUuidFcd() {
    return this.uuidFcd;
  }

  public void setUuidFcd(String uuidFcd) {
    this.uuidFcd = uuidFcd;
  }

  public void unsetUuidFcd() {
    this.uuidFcd = null;
  }

  /** Returns true if field uuidFcd is set (has been assigned a value) and false otherwise */
  public boolean isSetUuidFcd() {
    return this.uuidFcd != null;
  }

  public void setUuidFcdIsSet(boolean value) {
    if (!value) {
      this.uuidFcd = null;
    }
  }
  ...
  public boolean equals(FichaVisitaDomiciliarChildThrift that) {
    ...
    boolean this_present_uuidFcd = true && this.isSetUuidFcd();
    boolean that_present_uuidFcd = true && that.isSetUuidFcd();
    if (this_present_uuidFcd || that_present_uuidFcd) {
      if (!(this_present_uuidFcd && that_present_uuidFcd))
        return false;
      if (!this.uuidFcd.equals(that.uuidFcd))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_uuidFcd = true && (isSetUuidFcd());
    list.add(present_uuidFcd);
    if (present_uuidFcd)
      list.add(uuidFcd);
  ...
  public int compareTo(FichaVisitaDomiciliarChildThrift other) {
    ...
    lastComparison = Boolean.valueOf(isSetUuidFcd()).compareTo(other.isSetUuidFcd());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUuidFcd()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.uuidFcd, other.uuidFcd);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class FichaVisitaDomiciliarChildThriftStandardScheme extends StandardScheme<FichaVisitaDomiciliarChildThrift> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, FichaVisitaDomiciliarChildThrift struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 22: // UUID_FCD
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.uuidFcd = iprot.readString();
              struct.setUuidFcdIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FichaVisitaDomiciliarChildThrift struct) throws org.apache.thrift.TException {
      ...
      if (struct.uuidFcd != null) {
        if (struct.isSetUuidFcd()) {
          oprot.writeFieldBegin(UUID_FCD_FIELD_DESC);
          oprot.writeString(struct.uuidFcd);
          oprot.writeFieldEnd();
        }
      }

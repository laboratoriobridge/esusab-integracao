...
namespace br.gov.saude.esus.cds.transport.generated.thrift.procedimento
{
  ...
  public partial class FichaProcedimentoChildThrift : TBase
  {
    ...
    private List<string> _outrosSiaProcedimentosV321;
    ...
    public List<string> OutrosSiaProcedimentosV321
    {
      get
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 9:
              if (field.Type == TType.List) {
                {
                  OutrosSiaProcedimentosV321 = new List<string>();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (OutrosSiaProcedimentosV321 != null && __isset.outrosSiaProcedimentosV321) {
          ...
          oprot.WriteFieldBegin(field);
          {
            oprot.WriteListBegin(new TList(TType.String, OutrosSiaProcedimentosV321.Count));
            foreach (string _iter7 in OutrosSiaProcedimentosV321)
            {

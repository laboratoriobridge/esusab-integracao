            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.atendimentosOdontologicos = new ArrayList<FichaAtendimentoOdontologicoChildThrift>(_list56.size);
                FichaAtendimentoOdontologicoChildThrift _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = new FichaAtendimentoOdontologicoChildThrift();
                  _elem57.read(iprot);
                  struct.atendimentosOdontologicos.add(_elem57);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.atendimentosOdontologicos != null) {
        if (struct.isSetAtendimentosOdontologicos()) {
          oprot.writeFieldBegin(ATENDIMENTOS_ODONTOLOGICOS_FIELD_DESC);
          {
            ...
            for (FichaAtendimentoOdontologicoChildThrift _iter59 : struct.atendimentosOdontologicos)
            {
              _iter59.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetAtendimentosOdontologicos()) {
        {
          ...
          for (FichaAtendimentoOdontologicoChildThrift _iter60 : struct.atendimentosOdontologicos)
          {
            _iter60.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.atendimentosOdontologicos = new ArrayList<FichaAtendimentoOdontologicoChildThrift>(_list61.size);
          FichaAtendimentoOdontologicoChildThrift _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = new FichaAtendimentoOdontologicoChildThrift();
            _elem62.read(iprot);
            struct.atendimentosOdontologicos.add(_elem62);
          }
        }
        struct.setAtendimentosOdontologicosIsSet(true);
      }

...
FichaAvaliacaoElegibilidadeThrift = module.exports.FichaAvaliacaoElegibilidadeThrift = function(args) {
  ...
  if (args) {
    ...
    if (args.nomeSocialCidadao !== undefined && args.nomeSocialCidadao !== null) {
    ...
    if (args.endereco !== undefined && args.endereco !== null) {
      this.endereco = new common_ttypes.EnderecoLocalPermanenciaThrift(args.endereco);
    }
    if (args.atencaoDomiciliarProcedencia !== undefined && args.atencaoDomiciliarProcedencia !== null) {
    ...
    if (args.cid10Principal !== undefined && args.cid10Principal !== null) {
      this.cid10Principal = args.cid10Principal;
    }
    if (args.cid10SecundarioUm !== undefined && args.cid10SecundarioUm !== null) {
      this.cid10SecundarioUm = args.cid10SecundarioUm;
    }
    if (args.cid10SecundarioDois !== undefined && args.cid10SecundarioDois !== null) {
      this.cid10SecundarioDois = args.cid10SecundarioDois;
    }
    if (args.conclusaoDestinoElegivel !== undefined && args.conclusaoDestinoElegivel !== null) {
      this.conclusaoDestinoElegivel = args.conclusaoDestinoElegivel;
    }
    if (args.conclusaoDestinoInelegivel !== undefined && args.conclusaoDestinoInelegivel !== null) {
      this.conclusaoDestinoInelegivel = Thrift.copyList(args.conclusaoDestinoInelegivel, [null]);
    }
    if (args.cuidadorCidadao !== undefined && args.cuidadorCidadao !== null) {
...
FichaAvaliacaoElegibilidadeThrift.prototype.write = function(output) {
  ...
  if (this.stCidadaoNaoPossuiCpf !== null && this.stCidadaoNaoPossuiCpf !== undefined) {
    output.writeFieldBegin('stCidadaoNaoPossuiCpf', Thrift.Type.BOOL, 38);
  ...
  if (this.justificativaCidadaoNaoPossuiCpf !== null && this.justificativaCidadaoNaoPossuiCpf !== undefined) {
    output.writeFieldBegin('justificativaCidadaoNaoPossuiCpf', Thrift.Type.I64, 39);

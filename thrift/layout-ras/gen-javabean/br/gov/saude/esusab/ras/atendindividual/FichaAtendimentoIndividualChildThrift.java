      ...
      if (struct.exame != null) {
        if (struct.isSetExame()) {
          oprot.writeFieldBegin(EXAME_FIELD_DESC);
          {
            ...
            for (br.gov.saude.esusab.ras.common.ExameThrift _iter32 : struct.exame)
            {
              _iter32.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.condutas != null) {
        if (struct.isSetCondutas()) {
          oprot.writeFieldBegin(CONDUTAS_FIELD_DESC);
          {
            ...
            for (long _iter34 : struct.condutas)
            {
      ...
      if (struct.emultis != null) {
        if (struct.isSetEmultis()) {
          oprot.writeFieldBegin(EMULTIS_FIELD_DESC);
          {
            ...
            for (long _iter38 : struct.emultis)
            {
      ...
      if (struct.problemasCondicoes != null) {
        if (struct.isSetProblemasCondicoes()) {
          oprot.writeFieldBegin(PROBLEMAS_CONDICOES_FIELD_DESC);
          {
            ...
            for (br.gov.saude.esusab.ras.common.ProblemaCondicaoThrift _iter39 : struct.problemasCondicoes)
            {
              _iter39.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetExame()) {
        {
          ...
          for (br.gov.saude.esusab.ras.common.ExameThrift _iter40 : struct.exame)
          {
            _iter40.write(oprot);
          }
        }
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.exame = new ArrayList<br.gov.saude.esusab.ras.common.ExameThrift>(_list48.size);
          br.gov.saude.esusab.ras.common.ExameThrift _elem49;
          for (int _i50 = 0; _i50 < _list48.size; ++_i50)
          {
            _elem49 = new br.gov.saude.esusab.ras.common.ExameThrift();
            _elem49.read(iprot);
            struct.exame.add(_elem49);
          }
        }
        struct.setExameIsSet(true);
      }
      ...
      if (incoming.get(15)) {
        {
          ...
          struct.nasfs = new ArrayList<Long>(_list51.size);
          long _elem52;
      ...
      if (incoming.get(16)) {
        {
          ...
          struct.condutas = new ArrayList<Long>(_list54.size);
          long _elem55;
      ...
      if (incoming.get(24)) {
        {
          ...
          struct.medicamentos = new ArrayList<br.gov.saude.esusab.ras.common.MedicamentoThrift>(_list57.size);
          br.gov.saude.esusab.ras.common.MedicamentoThrift _elem58;
          for (int _i59 = 0; _i59 < _list57.size; ++_i59)
          {
            _elem58 = new br.gov.saude.esusab.ras.common.MedicamentoThrift();
            _elem58.read(iprot);
            struct.medicamentos.add(_elem58);
          }
        }
        struct.setMedicamentosIsSet(true);
      }
      if (incoming.get(25)) {
        {
          ...
          struct.encaminhamentos = new ArrayList<br.gov.saude.esusab.ras.common.EncaminhamentoExternoThrift>(_list60.size);
          br.gov.saude.esusab.ras.common.EncaminhamentoExternoThrift _elem61;
          for (int _i62 = 0; _i62 < _list60.size; ++_i62)
          {
            _elem61 = new br.gov.saude.esusab.ras.common.EncaminhamentoExternoThrift();
            _elem61.read(iprot);
            struct.encaminhamentos.add(_elem61);
          }
        }
        struct.setEncaminhamentosIsSet(true);
      }
      if (incoming.get(26)) {
        {
          ...
          struct.resultadosExames = new ArrayList<br.gov.saude.esusab.ras.common.ResultadosExameThrift>(_list63.size);
          br.gov.saude.esusab.ras.common.ResultadosExameThrift _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = new br.gov.saude.esusab.ras.common.ResultadosExameThrift();
            _elem64.read(iprot);
            struct.resultadosExames.add(_elem64);
          }
        }
        struct.setResultadosExamesIsSet(true);
      }
      ...
      if (incoming.get(30)) {
        {
          ...
          struct.emultis = new ArrayList<Long>(_list66.size);
          long _elem67;
          for (int _i68 = 0; _i68 < _list66.size; ++_i68)
          {
            _elem67 = iprot.readI64();
            struct.emultis.add(_elem67);
          }
        }
        struct.setEmultisIsSet(true);
      }

...
type FichaAtendimentoOdontologicoChildThrift struct {
  ...
  OutrosSiaProcedimentosV321 []*ProcedimentoQuantidadeThrift `thrift:"outrosSiaProcedimentosV321,13" json:"outrosSiaProcedimentosV321,omitempty"`
  ...
  ResultadosExames []*common.ResultadoExameThrift `thrift:"resultadosExames,21" json:"resultadosExames,omitempty"`
}
...
var FichaAtendimentoOdontologicoChildThrift_OutrosSiaProcedimentosV321_DEFAULT []*ProcedimentoQuantidadeThrift

func (p *FichaAtendimentoOdontologicoChildThrift) GetOutrosSiaProcedimentosV321() []*ProcedimentoQuantidadeThrift {
...
var FichaAtendimentoOdontologicoChildThrift_ResultadosExames_DEFAULT []*common.ResultadoExameThrift

func (p *FichaAtendimentoOdontologicoChildThrift) GetResultadosExames() []*common.ResultadoExameThrift {
...
func (p *FichaAtendimentoOdontologicoChildThrift) IsSetOutrosSiaProcedimentosV321() bool {
...
func (p *FichaAtendimentoOdontologicoChildThrift)  readField13(iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.OutrosSiaProcedimentosV321 = append(p.OutrosSiaProcedimentosV321, _elem5)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *FichaAtendimentoOdontologicoChildThrift)  readField19(iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    _elem6 := &common.MedicamentoThrift{}
    if err := _elem6.Read(iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem6), err)
    }
    p.Medicamentos = append(p.Medicamentos, _elem6)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *FichaAtendimentoOdontologicoChildThrift)  readField20(iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    _elem7 := &common.EncaminhamentoExternoThrift{}
    if err := _elem7.Read(iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem7), err)
    }
    p.Encaminhamentos = append(p.Encaminhamentos, _elem7)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *FichaAtendimentoOdontologicoChildThrift)  readField21(iprot thrift.TProtocol) error {
  ...
  tSlice := make([]*common.ResultadoExameThrift, 0, size)
  p.ResultadosExames =  tSlice
  for i := 0; i < size; i ++ {
    _elem8 := &common.ResultadoExameThrift{}
    if err := _elem8.Read(iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem8), err)
    }
    p.ResultadosExames = append(p.ResultadosExames, _elem8)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *FichaAtendimentoOdontologicoChildThrift) writeField13(oprot thrift.TProtocol) (err error) {
  if p.IsSetOutrosSiaProcedimentosV321() {
    if err := oprot.WriteFieldBegin("outrosSiaProcedimentosV321", thrift.LIST, 13); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 13:outrosSiaProcedimentosV321: ", p), err) }
    if err := oprot.WriteListBegin(thrift.STRUCT, len(p.OutrosSiaProcedimentosV321)); err != nil {
      return thrift.PrependError("error writing list begin: ", err)
    }
    ...
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 13:outrosSiaProcedimentosV321: ", p), err) }
  }
  return err
}
...
func (p *FichaAtendimentoOdontologicoMasterThrift)  readField3(iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    _elem9 := &FichaAtendimentoOdontologicoChildThrift{}
    if err := _elem9.Read(iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem9), err)
    }
    p.AtendimentosOdontologicos = append(p.AtendimentosOdontologicos, _elem9)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }

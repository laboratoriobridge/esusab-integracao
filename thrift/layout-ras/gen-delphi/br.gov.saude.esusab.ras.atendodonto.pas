...
function TFichaAtendimentoOdontologicoChildThriftImpl.GetExame: IThriftList<IExameThrift>;
begin
  Result := FExame;
end;

procedure TFichaAtendimentoOdontologicoChildThriftImpl.SetExame( const Value: IThriftList<IExameThrift>);
begin
  F__isset_Exame := True;
  FExame := Value;
end;

function TFichaAtendimentoOdontologicoChildThriftImpl.Get__isset_Exame: Boolean;
begin
  Result := F__isset_Exame;
end;

function TFichaAtendimentoOdontologicoChildThriftImpl.GetSolicitacoesOci: IThriftList<ISolicitacaoOciThrift>;
begin
  Result := FSolicitacoesOci;
end;

procedure TFichaAtendimentoOdontologicoChildThriftImpl.SetSolicitacoesOci( const Value: IThriftList<ISolicitacaoOciThrift>);
begin
  F__isset_SolicitacoesOci := True;
  FSolicitacoesOci := Value;
end;

function TFichaAtendimentoOdontologicoChildThriftImpl.Get__isset_SolicitacoesOci: Boolean;
begin
...
var
  ...
  _list29: IList;
  _i30: Integer;
  _elem31: IExameThrift;
  _list32: IList;
  _i33: Integer;
  _elem34: ISolicitacaoOciThrift;
      ...
      case field_.ID of
        ...
        30: begin
          ...
          begin
            ...
            begin
              _elem31 := TExameThriftImpl.Create;
              _elem31.Read(iprot);
              Exame.Add(_elem31);
            end;
            iprot.ReadListEnd();
        ...
        42: begin
          ...
          begin
            ...
            begin
              _elem34 := TSolicitacaoOciThriftImpl.Create;
              _elem34.Read(iprot);
              SolicitacoesOci.Add(_elem34);
            end;
            iprot.ReadListEnd();
          end else
          begin
...
var
  ...
  _iter42: Int64;
  list_43 : IList;
  _iter44: IProcedimentoQuantidadeThrift;
  list_45 : IList;
  _iter46: IMedicamentoThrift;
  list_47 : IList;
  _iter48: IEncaminhamentoExternoThrift;
  list_49 : IList;
  _iter50: IResultadosExameThrift;
  list_51 : IList;
  _iter52: IProblemaCondicaoThrift;
  list_53 : IList;
  _iter54: IExameThrift;
  list_55 : IList;
  _iter56: ISolicitacaoOciThrift;
begin
  tracker := oprot.NextRecursionLevel;
  ...
  begin
    ...
    field_.ID := 8;
    oprot.WriteFieldBegin(field_);
    list_35 := TListImpl.Create(TType.I64, TiposEncamOdonto.Count);
    oprot.WriteListBegin( list_35);
    for _iter36 in TiposEncamOdonto do
    begin
  ...
  begin
    ...
    field_.ID := 9;
    oprot.WriteFieldBegin(field_);
    list_37 := TListImpl.Create(TType.I64, TiposFornecimOdonto.Count);
    oprot.WriteListBegin( list_37);
    for _iter38 in TiposFornecimOdonto do
    begin
  ...
  begin
    ...
    field_.ID := 10;
    oprot.WriteFieldBegin(field_);
    list_39 := TListImpl.Create(TType.I64, TiposVigilanciaSaudeBucal.Count);
    oprot.WriteListBegin( list_39);
    for _iter40 in TiposVigilanciaSaudeBucal do
    begin
  ...
  begin
    ...
    field_.ID := 11;
    oprot.WriteFieldBegin(field_);
    list_41 := TListImpl.Create(TType.I64, TiposConsultaOdonto.Count);
    oprot.WriteListBegin( list_41);
    for _iter42 in TiposConsultaOdonto do
    begin
  ...
  begin
    ...
    field_.ID := 12;
    oprot.WriteFieldBegin(field_);
    list_43 := TListImpl.Create(TType.Struct, ProcedimentosRealizados.Count);
    oprot.WriteListBegin( list_43);
    for _iter44 in ProcedimentosRealizados do
    begin
      _iter44.Write(oprot);
    end;
    oprot.WriteListEnd();
  ...
  begin
    ...
    field_.ID := 19;
    oprot.WriteFieldBegin(field_);
    list_45 := TListImpl.Create(TType.Struct, Medicamentos.Count);
    oprot.WriteListBegin( list_45);
    for _iter46 in Medicamentos do
    begin
      _iter46.Write(oprot);
    end;
    oprot.WriteListEnd();
  ...
  begin
    ...
    field_.ID := 20;
    oprot.WriteFieldBegin(field_);
    list_47 := TListImpl.Create(TType.Struct, Encaminhamentos.Count);
    oprot.WriteListBegin( list_47);
    for _iter48 in Encaminhamentos do
    begin
      _iter48.Write(oprot);
    end;
    oprot.WriteListEnd();
  ...
  begin
    ...
    field_.ID := 21;
    oprot.WriteFieldBegin(field_);
    list_49 := TListImpl.Create(TType.Struct, ResultadosExames.Count);
    oprot.WriteListBegin( list_49);
    for _iter50 in ResultadosExames do
    begin
      _iter50.Write(oprot);
    end;
    oprot.WriteListEnd();
  ...
  begin
    ...
    field_.ID := 28;
    oprot.WriteFieldBegin(field_);
    list_51 := TListImpl.Create(TType.Struct, ProblemasCondicoes.Count);
    oprot.WriteListBegin( list_51);
    for _iter52 in ProblemasCondicoes do
    begin
      _iter52.Write(oprot);
    end;
    oprot.WriteListEnd();
  ...
  begin
    ...
    field_.ID := 30;
    oprot.WriteFieldBegin(field_);
    list_53 := TListImpl.Create(TType.Struct, Exame.Count);
    oprot.WriteListBegin( list_53);
    for _iter54 in Exame do
    begin
      _iter54.Write(oprot);
    end;
    oprot.WriteListEnd();
  ...
  begin
    ...
    field_.ID := 42;
    oprot.WriteFieldBegin(field_);
    list_55 := TListImpl.Create(TType.Struct, SolicitacoesOci.Count);
    oprot.WriteListBegin( list_55);
    for _iter56 in SolicitacoesOci do
    begin
      _iter56.Write(oprot);
    end;
    oprot.WriteListEnd();
...
begin
  ...
  try
    ...
    if (Ivcf <> nil) and __isset_Ivcf then begin
      ...
      _first58 := FALSE;
      _sb57.Append('Ivcf: ');
      if (Ivcf = nil) then _sb57.Append('<null>') else _sb57.Append(Ivcf.ToString());
    end;
    ...
    if _first58 then {prevent warning};
  finally
    _sb57.Free;
  end;
end;
...
var
  ...
  _list59: IList;
  _i60: Integer;
  _elem61: IFichaAtendimentoOdontologicoChildThrift;
      ...
      case field_.ID of
        ...
        3: begin
          ...
          begin
            ...
            _list59 := iprot.ReadListBegin();
            for _i60 := 0 to _list59.Count - 1 do
            begin
              _elem61 := TFichaAtendimentoOdontologicoChildThriftImpl.Create;
              _elem61.Read(iprot);
              AtendimentosOdontologicos.Add(_elem61);
            end;
            iprot.ReadListEnd();
          end else
          begin
...
var
  ...
  tracker : IProtocolRecursionTracker;
  list_62 : IList;
  _iter63: IFichaAtendimentoOdontologicoChildThrift;
begin
  tracker := oprot.NextRecursionLevel;
  ...
  begin
    ...
    field_.ID := 3;
    oprot.WriteFieldBegin(field_);
    list_62 := TListImpl.Create(TType.Struct, AtendimentosOdontologicos.Count);
    oprot.WriteListBegin( list_62);
    for _iter63 in AtendimentosOdontologicos do
    begin
      _iter63.Write(oprot);
    end;
    oprot.WriteListEnd();
...
var
  _sb64 : TThriftStringBuilder;
begin
  _sb64 := TThriftStringBuilder.Create('(');
  try
    _sb64.Append(', UuidFicha: ');
    _sb64.Append(UuidFicha);
    if (HeaderTransport <> nil) and __isset_HeaderTransport then begin
      _sb64.Append(', HeaderTransport: ');
      if (HeaderTransport = nil) then _sb64.Append('<null>') else _sb64.Append(HeaderTransport.ToString());
    end;
    if (AtendimentosOdontologicos <> nil) and __isset_AtendimentosOdontologicos then begin
      _sb64.Append(', AtendimentosOdontologicos: ');
      _sb64.Append(AtendimentosOdontologicos);
    end;
    if (__isset_TpCdsOrigem) then begin
      _sb64.Append(', TpCdsOrigem: ');
      _sb64.Append(TpCdsOrigem);
    end;
    _sb64.Append(')');
    Result := _sb64.ToString;
  finally
    _sb64.Free;
  end;
end;

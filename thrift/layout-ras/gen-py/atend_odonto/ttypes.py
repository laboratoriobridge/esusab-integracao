...
class FichaAtendimentoOdontologicoChildThrift:
  ...
  thrift_spec = (
    ...
    (13, TType.LIST, 'outrosSiaProcedimentosV321', (TType.STRUCT,(ProcedimentoQuantidadeThrift, ProcedimentoQuantidadeThrift.thrift_spec)), None, ), # 13
    ...
    (19, TType.LIST, 'medicamentos', (TType.STRUCT,(common.ttypes.MedicamentoThrift, common.ttypes.MedicamentoThrift.thrift_spec)), None, ), # 19
    (20, TType.LIST, 'encaminhamentos', (TType.STRUCT,(common.ttypes.EncaminhamentoExternoThrift, common.ttypes.EncaminhamentoExternoThrift.thrift_spec)), None, ), # 20
    (21, TType.LIST, 'resultadosExames', (TType.STRUCT,(common.ttypes.ResultadoExameThrift, common.ttypes.ResultadoExameThrift.thrift_spec)), None, ), # 21
  )

  def __init__(self, dtNascimento=None, cnsCidadao=None, numProntuario=None, gestante=None, necessidadesEspeciais=None, localAtendimento=None, tipoAtendimento=None, tiposEncamOdonto=None, tiposFornecimOdonto=None, tiposVigilanciaSaudeBucal=None, tiposConsultaOdonto=None, procedimentosRealizados=None, outrosSiaProcedimentosV321=None, sexo=None, turno=None, dataHoraInicialAtendimento=None, dataHoraFinalAtendimento=None, cpfCidadao=None, medicamentos=None, encaminhamentos=None, resultadosExames=None,):
    ...
    self.outrosSiaProcedimentosV321 = outrosSiaProcedimentosV321
    self.sexo = sexo
    self.turno = turno
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          self.outrosSiaProcedimentosV321 = []
          (_etype33, _size30) = iprot.readListBegin()
          for _i34 in xrange(_size30):
            _elem35 = ProcedimentoQuantidadeThrift()
            _elem35.read(iprot)
            self.outrosSiaProcedimentosV321.append(_elem35)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 14:
        ...
        if ftype == TType.LIST:
          ...
          for _i40 in xrange(_size36):
            _elem41 = common.ttypes.MedicamentoThrift()
            _elem41.read(iprot)
            self.medicamentos.append(_elem41)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 20:
        if ftype == TType.LIST:
          ...
          for _i46 in xrange(_size42):
            _elem47 = common.ttypes.EncaminhamentoExternoThrift()
            _elem47.read(iprot)
            self.encaminhamentos.append(_elem47)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 21:
        if ftype == TType.LIST:
          ...
          for _i52 in xrange(_size48):
            _elem53 = common.ttypes.ResultadoExameThrift()
            _elem53.read(iprot)
            self.resultadosExames.append(_elem53)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.procedimentosRealizados is not None:
      ...
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.outrosSiaProcedimentosV321 is not None:
      oprot.writeFieldBegin('outrosSiaProcedimentosV321', TType.LIST, 13)
      oprot.writeListBegin(TType.STRUCT, len(self.outrosSiaProcedimentosV321))
      for iter59 in self.outrosSiaProcedimentosV321:
        iter59.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.medicamentos is not None:
      ...
      for iter60 in self.medicamentos:
        iter60.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.encaminhamentos is not None:
      ...
      for iter61 in self.encaminhamentos:
        iter61.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.resultadosExames is not None:
      ...
      for iter62 in self.resultadosExames:
        iter62.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.outrosSiaProcedimentosV321)
...
class FichaAtendimentoOdontologicoMasterThrift:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'headerTransport', (common.ttypes.VariasLotacoesHeaderThrift, common.ttypes.VariasLotacoesHeaderThrift.thrift_spec), None, ), # 2

...
function TFichaVisitaDomiciliarChildThriftImpl.GetNumCartaoSus: string;
begin
  Result := FNumCartaoSus;
end;

procedure TFichaVisitaDomiciliarChildThriftImpl.SetNumCartaoSus( const Value: string);
begin
  F__isset_NumCartaoSus := True;
  FNumCartaoSus := Value;
end;

function TFichaVisitaDomiciliarChildThriftImpl.Get__isset_NumCartaoSus: Boolean;
begin

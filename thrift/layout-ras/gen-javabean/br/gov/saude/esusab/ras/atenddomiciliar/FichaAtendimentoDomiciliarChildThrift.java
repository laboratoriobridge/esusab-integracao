...
public class FichaAtendimentoDomiciliarChildThrift implements org.apache.thrift.TBase<FichaAtendimentoDomiciliarChildThrift, FichaAtendimentoDomiciliarChildThrift._Fields>, java.io.Serializable, Cloneable, Comparable<FichaAtendimentoDomiciliarChildThrift> {
  ...
  public List<Long> condicoesAvaliadas; // optional
  public String cid; // optional
  public String ciap; // optional
  public List<String> procedimentos; // optional
  public long condutaDesfecho; // optional
  ...
  public FichaAtendimentoDomiciliarChildThrift setTurno(long turno) {
    this.turno = turno;
    setTurnoIsSet(true);
    return this;
  }
  ...
  public FichaAtendimentoDomiciliarChildThrift setCnsCidadao(String cnsCidadao) {
  ...
  public FichaAtendimentoDomiciliarChildThrift setDataNascimento(long dataNascimento) {
  ...
  public FichaAtendimentoDomiciliarChildThrift setSexo(long sexo) {
    this.sexo = sexo;
    setSexoIsSet(true);
    return this;
  }
  ...
  public FichaAtendimentoDomiciliarChildThrift setLocalAtendimento(long localAtendimento) {
  ...
  public FichaAtendimentoDomiciliarChildThrift setAtencaoDomiciliarModalidade(long atencaoDomiciliarModalidade) {
  ...
  public FichaAtendimentoDomiciliarChildThrift setTipoAtendimento(long tipoAtendimento) {
  ...
  public FichaAtendimentoDomiciliarChildThrift setCondicoesAvaliadas(List<Long> condicoesAvaliadas) {
  ...
  public FichaAtendimentoDomiciliarChildThrift setCid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public FichaAtendimentoDomiciliarChildThrift setCiap(String ciap) {
    this.ciap = ciap;
    return this;
  }
  ...
  public FichaAtendimentoDomiciliarChildThrift setProcedimentos(List<String> procedimentos) {
  ...
  public FichaAtendimentoDomiciliarChildThrift setCondutaDesfecho(long condutaDesfecho) {
  ...
  public FichaAtendimentoDomiciliarChildThrift setCpfCidadao(String cpfCidadao) {
  ...
  public FichaAtendimentoDomiciliarChildThrift setProblemasCondicoes(List<br.gov.saude.esusab.ras.common.ProblemaCondicaoThrift> problemasCondicoes) {

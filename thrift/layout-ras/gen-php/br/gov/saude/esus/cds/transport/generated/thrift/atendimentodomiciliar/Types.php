<?php
namespace br\gov\saude\esus\cds\transport\generated\thrift\atendimentodomiciliar;
...
class FichaAtendimentoDomiciliarChildThrift {
   ...
   * @var string[]
   */
  public $outrosProcedimentosV321 = null;
  /**
   * @var int
   */
   ...
   * @var bool
   */
  public $statusInicioAcompanhamentoPosObitoV200 = null;
  /**
   * @var string
   */
  ...
  public function __construct($vals=null) {
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        14 => array(
          'var' => 'statusInicioAcompanhamentoPosObitoV200',
          'type' => TType::BOOL,
          ),
        15 => array(
          'var' => 'cpfCidadao',
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['outrosProcedimentosV321'])) {
        $this->outrosProcedimentosV321 = $vals['outrosProcedimentosV321'];
      }
      if (isset($vals['condutaDesfecho'])) {
        $this->condutaDesfecho = $vals['condutaDesfecho'];
      }
      if (isset($vals['statusInicioAcompanhamentoPosObitoV200'])) {
        $this->statusInicioAcompanhamentoPosObitoV200 = $vals['statusInicioAcompanhamentoPosObitoV200'];
      }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 12:
          if ($ftype == TType::LST) {
            $this->outrosProcedimentosV321 = array();
            $_size12 = 0;
            $_etype15 = 0;
            ...
            for ($_i16 = 0; $_i16 < $_size12; ++$_i16)
            {
              ...
              $this->outrosProcedimentosV321 []= $elem17;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 14:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->statusInicioAcompanhamentoPosObitoV200);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->outrosProcedimentosV321 !== null) {
      if (!is_array($this->outrosProcedimentosV321)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('outrosProcedimentosV321', TType::LST, 12);
      {
        $output->writeListBegin(TType::STRING, count($this->outrosProcedimentosV321));
        {
          foreach ($this->outrosProcedimentosV321 as $iter20)
          {
    ...
    if ($this->statusInicioAcompanhamentoPosObitoV200 !== null) {
      $xfer += $output->writeFieldBegin('statusInicioAcompanhamentoPosObitoV200', TType::BOOL, 14);
      $xfer += $output->writeBool($this->statusInicioAcompanhamentoPosObitoV200);
      $xfer += $output->writeFieldEnd();
    }
...
class FichaAtendimentoDomiciliarMasterThrift {
   ...
   */
  public $headerTransportV200 = null;
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\atendimentodomiciliar\FichaAtendimentoDomiciliarChildThrift[]
   */
  ...
  public function __construct($vals=null) {
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        4 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\atendimentodomiciliar\FichaAtendimentoDomiciliarChildThrift',
            ),
          ),
        5 => array(
          'var' => 'headerTransport',
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['headerTransportV200'])) {
        $this->headerTransportV200 = $vals['headerTransportV200'];
      }
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::STRUCT) {
            $this->headerTransportV200 = new \br\gov\saude\esus\cds\transport\generated\thrift\common\UnicaLotacaoHeaderThrift();
            $xfer += $this->headerTransportV200->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 4:
          if ($ftype == TType::LST) {
            ...
            {
              $elem26 = null;
              $elem26 = new \br\gov\saude\esus\cds\transport\generated\thrift\atendimentodomiciliar\FichaAtendimentoDomiciliarChildThrift();
  ...
  public function write($output) {
    ...
    if ($this->headerTransportV200 !== null) {
      if (!is_object($this->headerTransportV200)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('headerTransportV200', TType::STRUCT, 3);
      $xfer += $this->headerTransportV200->write($output);
      $xfer += $output->writeFieldEnd();
    }

...
class CadastroDomiciliarThrift {
  ...
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\cadastrodomiciliar\InstituicaoPermanenciaThrift
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        14 => array(
          ...
          'type' => TType::STRUCT,
          'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\cadastrodomiciliar\InstituicaoPermanenciaThrift',
          ),
        15 => array(
          'var' => 'headerTransport',
          'type' => TType::STRUCT,
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 14:
          if ($ftype == TType::STRUCT) {
            $this->instituicaoPermanencia = new \br\gov\saude\esus\cds\transport\generated\thrift\cadastrodomiciliar\InstituicaoPermanenciaThrift();
  ...
  public function write($output) {
    ...
    if ($this->dadosGeraisV2000 !== null) {
      ...
      $xfer += $output->writeFieldBegin('dadosGeraisV2000', TType::STRUCT, 3);

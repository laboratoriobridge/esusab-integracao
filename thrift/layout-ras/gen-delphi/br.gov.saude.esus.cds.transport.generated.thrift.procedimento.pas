...
unit br.gov.saude.esus.cds.transport.generated.thrift.procedimento;
...
const
  cbr_gov_saude_esus_cds_transport_generated_thrift_procedimento_Option_AnsiStr_Binary = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_procedimento_Option_Register_Types = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_procedimento_Option_ConstPrefix    = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_procedimento_Option_Events         = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_procedimento_Option_XmlDoc         = False;
...
type
  ...
  IFichaProcedimentoChildThrift = interface(IBase)
    ...
    function GetOutrosSiaProcedimentosV321: IThriftList<string>;
    procedure SetOutrosSiaProcedimentosV321( const Value: IThriftList<string>);
    ...
    property OutrosSiaProcedimentosV321: IThriftList<string> read GetOutrosSiaProcedimentosV321 write SetOutrosSiaProcedimentosV321;
  ...
  private
    ...
    FOutrosSiaProcedimentosV321: IThriftList<string>;
...
function TFichaProcedimentoChildThriftImpl.GetOutrosSiaProcedimentosV321: IThriftList<string>;
begin
  Result := FOutrosSiaProcedimentosV321;
end;

procedure TFichaProcedimentoChildThriftImpl.SetOutrosSiaProcedimentosV321( const Value: IThriftList<string>);
begin
  F__isset_OutrosSiaProcedimentosV321 := True;
  FOutrosSiaProcedimentosV321 := Value;
end;

function TFichaProcedimentoChildThriftImpl.Get__isset_OutrosSiaProcedimentosV321: Boolean;
begin
    ...
    begin
      ...
      case field_.ID of
        ...
        9: begin
          if (field_.Type_ = TType.List) then
          begin
            OutrosSiaProcedimentosV321 := TThriftListImpl<string>.Create;
            _list3 := iprot.ReadListBegin();
            for _i4 := 0 to _list3.Count - 1 do
            begin
              _elem5 := iprot.ReadString();
              OutrosSiaProcedimentosV321.Add(_elem5);
            end;
            iprot.ReadListEnd();
          end else
          begin
...
begin
  ...
  begin
    ...
    field_.ID := 9;
    oprot.WriteFieldBegin(field_);
    list_8 := TListImpl.Create(TType.String_, OutrosSiaProcedimentosV321.Count);
    oprot.WriteListBegin( list_8);
    for _iter9 in OutrosSiaProcedimentosV321 do
    begin
...
begin
  ...
  try
    ...
    if (OutrosSiaProcedimentosV321 <> nil) and __isset_OutrosSiaProcedimentosV321 then begin
      if not _first11 then _sb10.Append(',');
      _first11 := FALSE;
      _sb10.Append('OutrosSiaProcedimentosV321: ');
      _sb10.Append(OutrosSiaProcedimentosV321);
    end;

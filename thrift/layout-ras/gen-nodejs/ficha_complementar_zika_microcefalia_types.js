...
FichaComplementarZikaMicrocefaliaThrift = module.exports.FichaComplementarZikaMicrocefaliaThrift = function(args) {
  ...
  if (args) {
    ...
    if (args.dataRealizacaoTesteOlhinho !== undefined && args.dataRealizacaoTesteOlhinho !== null) {
      this.dataRealizacaoTesteOlhinho = args.dataRealizacaoTesteOlhinho;
    }
    if (args.coResultadoTesteOlhinho !== undefined && args.coResultadoTesteOlhinho !== null) {
      this.coResultadoTesteOlhinho = args.coResultadoTesteOlhinho;
    }
    if (args.dataRealizacaoExameFundoOlho !== undefined && args.dataRealizacaoExameFundoOlho !== null) {
      this.dataRealizacaoExameFundoOlho = args.dataRealizacaoExameFundoOlho;
    }
    if (args.coResultadoExameFundoOlho !== undefined && args.coResultadoExameFundoOlho !== null) {
      this.coResultadoExameFundoOlho = args.coResultadoExameFundoOlho;
    }
    if (args.dataRealizacaoTesteOrelhinha !== undefined && args.dataRealizacaoTesteOrelhinha !== null) {
      this.dataRealizacaoTesteOrelhinha = args.dataRealizacaoTesteOrelhinha;
    }
    if (args.coResultadoTesteOrelhinha !== undefined && args.coResultadoTesteOrelhinha !== null) {
      this.coResultadoTesteOrelhinha = args.coResultadoTesteOrelhinha;
    }
    if (args.dataRealizacaoUSTransfontanela !== undefined && args.dataRealizacaoUSTransfontanela !== null) {
      this.dataRealizacaoUSTransfontanela = args.dataRealizacaoUSTransfontanela;
    }
    if (args.coResultadoUsTransfontanela !== undefined && args.coResultadoUsTransfontanela !== null) {
      this.coResultadoUsTransfontanela = args.coResultadoUsTransfontanela;
    }
    if (args.dataRealizacaoTomografiaComputadorizada !== undefined && args.dataRealizacaoTomografiaComputadorizada !== null) {
      this.dataRealizacaoTomografiaComputadorizada = args.dataRealizacaoTomografiaComputadorizada;
    }
    if (args.coResultadoTomografiaComputadorizada !== undefined && args.coResultadoTomografiaComputadorizada !== null) {
      this.coResultadoTomografiaComputadorizada = args.coResultadoTomografiaComputadorizada;
    }
    if (args.dataRealizacaoRessonanciaMagnetica !== undefined && args.dataRealizacaoRessonanciaMagnetica !== null) {
      this.dataRealizacaoRessonanciaMagnetica = args.dataRealizacaoRessonanciaMagnetica;
    }
    if (args.coResultadoRessonanciaMagnetica !== undefined && args.coResultadoRessonanciaMagnetica !== null) {
...
FichaComplementarZikaMicrocefaliaThrift.prototype.write = function(output) {
  ...
  if (this.stCidadaoNaoPossuiCpf !== null && this.stCidadaoNaoPossuiCpf !== undefined) {
    output.writeFieldBegin('stCidadaoNaoPossuiCpf', Thrift.Type.BOOL, 21);
  ...
  if (this.justificativaCidadaoNaoPossuiCpf !== null && this.justificativaCidadaoNaoPossuiCpf !== undefined) {
    output.writeFieldBegin('justificativaCidadaoNaoPossuiCpf', Thrift.Type.I64, 22);

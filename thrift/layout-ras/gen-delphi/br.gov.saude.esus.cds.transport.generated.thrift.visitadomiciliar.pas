...
unit br.gov.saude.esus.cds.transport.generated.thrift.visitadomiciliar;
...
const
  cbr_gov_saude_esus_cds_transport_generated_thrift_visitadomiciliar_Option_AnsiStr_Binary = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_visitadomiciliar_Option_Register_Types = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_visitadomiciliar_Option_ConstPrefix    = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_visitadomiciliar_Option_Events         = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_visitadomiciliar_Option_XmlDoc         = False;
...
type
  ...
  IFichaVisitaDomiciliarChildThrift = interface(IBase)
    ...
    function GetUuidFcd: string;
    procedure SetUuidFcd( const Value: string);
    ...
    property UuidFcd: string read GetUuidFcd write SetUuidFcd;
    ...
    function Get__isset_UuidFcd: Boolean;
    ...
    property __isset_UuidFcd: Boolean read Get__isset_UuidFcd;
  end;
...
function TFichaVisitaDomiciliarChildThriftImpl.GetUuidFcd: string;
begin
  Result := FUuidFcd;
end;

procedure TFichaVisitaDomiciliarChildThriftImpl.SetUuidFcd( const Value: string);
begin
  F__isset_UuidFcd := True;
  FUuidFcd := Value;
end;

function TFichaVisitaDomiciliarChildThriftImpl.Get__isset_UuidFcd: Boolean;
begin
  Result := F__isset_UuidFcd;
end;

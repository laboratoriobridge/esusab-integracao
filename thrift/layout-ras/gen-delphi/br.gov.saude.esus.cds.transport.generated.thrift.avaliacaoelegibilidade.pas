...
type
  ...
  IFichaAvaliacaoElegibilidadeThrift = interface(IBase)
    ...
    function GetHeaderTransportV200: IUnicaLotacaoHeaderThrift;
    procedure SetHeaderTransportV200( const Value: IUnicaLotacaoHeaderThrift);
    ...
    property HeaderTransportV200: IUnicaLotacaoHeaderThrift read GetHeaderTransportV200 write SetHeaderTransportV200;
    ...
    function Get__isset_HeaderTransportV200: Boolean;
    ...
    property __isset_HeaderTransportV200: Boolean read Get__isset_HeaderTransportV200;
  ...
  private
    ...
    FHeaderTransportV200: IUnicaLotacaoHeaderThrift;
    FCnsCidadao: string;
    FNomeCidadao: string;
    ...
    F__isset_HeaderTransportV200: Boolean;
...
function TFichaAvaliacaoElegibilidadeThriftImpl.GetHeaderTransportV200: IUnicaLotacaoHeaderThrift;
begin
  Result := FHeaderTransportV200;
end;

procedure TFichaAvaliacaoElegibilidadeThriftImpl.SetHeaderTransportV200( const Value: IUnicaLotacaoHeaderThrift);
begin
  F__isset_HeaderTransportV200 := True;
  FHeaderTransportV200 := Value;
end;

function TFichaAvaliacaoElegibilidadeThriftImpl.Get__isset_HeaderTransportV200: Boolean;
begin
  Result := F__isset_HeaderTransportV200;
end;
    ...
    begin
      ...
      case field_.ID of
        ...
        3: begin
          ...
          begin
            HeaderTransportV200 := TUnicaLotacaoHeaderThriftImpl.Create;
            HeaderTransportV200.Read(iprot);
          end else
          begin
            TProtocolUtil.Skip(iprot, field_.Type_);
          end;
...
begin
  ...
  if (HeaderTransportV200 <> nil) and __isset_HeaderTransportV200 then
  begin
    field_.Name := 'headerTransportV200';
    field_.Type_  := TType.Struct;
    field_.ID := 3;
    oprot.WriteFieldBegin(field_);
    HeaderTransportV200.Write(oprot);
    oprot.WriteFieldEnd();
  end;
...
begin
  ...
  try
    ...
    if (HeaderTransportV200 <> nil) and __isset_HeaderTransportV200 then begin
      _sb10.Append(', HeaderTransportV200: ');
      if (HeaderTransportV200 = nil) then _sb10.Append('<null>') else _sb10.Append(HeaderTransportV200.ToString());
    end;

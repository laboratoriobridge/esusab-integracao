...
var
  ...
  _list10: IList;
  _i11: Integer;
  _elem12: IFichaProcedimentoChildThrift;
      ...
      case field_.ID of
        ...
        4: begin
          ...
          begin
            ...
            begin
              _elem12 := TFichaProcedimentoChildThriftImpl.Create;
              _elem12.Read(iprot);
...
var
  ...
  field_ : IField;
  list_13 : IList;
  _iter14: IFichaProcedimentoChildThrift;
begin
  ...
  begin
    ...
    field_.ID := 4;
    oprot.WriteFieldBegin(field_);
    list_13 := TListImpl.Create(TType.Struct, AtendProcedimentos.Count);
    oprot.WriteListBegin( list_13);
    for _iter14 in AtendProcedimentos do
    begin
      _iter14.Write(oprot);
    end;
    oprot.WriteListEnd();
...
begin
  ...
  try
    ...
    if (HeaderTransport = nil) then sb.Append('<null>') else sb.Append(HeaderTransport.ToString());

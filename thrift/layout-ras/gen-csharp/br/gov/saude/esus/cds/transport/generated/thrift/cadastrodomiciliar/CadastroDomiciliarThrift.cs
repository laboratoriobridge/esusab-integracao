...
namespace br.gov.saude.esus.cds.transport.generated.thrift.cadastrodomiciliar
{
  ...
  public partial class CadastroDomiciliarThrift : TBase
  {
    ...
    private br.gov.saude.esus.cds.transport.generated.thrift.common.HeaderCdsCadastroThrift _dadosGeraisV2000;
    ...
    public br.gov.saude.esus.cds.transport.generated.thrift.common.HeaderCdsCadastroThrift DadosGeraisV2000
    {
      get
      {
        return _dadosGeraisV2000;
      }
      set
      {
        __isset.dadosGeraisV2000 = true;
        this._dadosGeraisV2000 = value;
      }
    }
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 3:
              if (field.Type == TType.Struct) {
                DadosGeraisV2000 = new br.gov.saude.esus.cds.transport.generated.thrift.common.HeaderCdsCadastroThrift();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (DadosGeraisV2000 != null && __isset.dadosGeraisV2000) {
          field.Name = "dadosGeraisV2000";
          field.Type = TType.Struct;
          field.ID = 3;
          oprot.WriteFieldBegin(field);
    ...
    public override string ToString() {
      ...
      if (DadosGeraisV2000 != null && __isset.dadosGeraisV2000) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("DadosGeraisV2000: ");
        __sb.Append(DadosGeraisV2000== null ? "<null>" : DadosGeraisV2000.ToString());
      }
      if (EnderecoLocalPermanencia != null && __isset.enderecoLocalPermanencia) {
        if(!__first) { __sb.Append(", "); }
        __first = false;

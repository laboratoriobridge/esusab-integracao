      ...
      if (struct.exame != null) {
        if (struct.isSetExame()) {
          oprot.writeFieldBegin(EXAME_FIELD_DESC);
          {
            ...
            for (ExameThrift _iter25 : struct.exame)
            {
              _iter25.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.condutas != null) {
        if (struct.isSetCondutas()) {
          oprot.writeFieldBegin(CONDUTAS_FIELD_DESC);
          {
            ...
            for (long _iter27 : struct.condutas)
            {
      ...
      if (struct.isSetExame()) {
        {
          ...
          for (ExameThrift _iter28 : struct.exame)
          {
            _iter28.write(oprot);
          }
        }
      ...
      if (struct.isSetCondutas()) {
        {
          ...
          for (long _iter30 : struct.condutas)
          {
      ...
      if (incoming.get(14)) {
        {
          ...
          struct.exame = new ArrayList<ExameThrift>(_list31.size);
          ExameThrift _elem32;
          for (int _i33 = 0; _i33 < _list31.size; ++_i33)
          {
            _elem32 = new ExameThrift();
            _elem32.read(iprot);
            struct.exame.add(_elem32);
          }
        }
        struct.setExameIsSet(true);
      }
      ...
      if (incoming.get(18)) {
        {
          ...
          struct.nasfs = new ArrayList<Long>(_list34.size);
          long _elem35;
          for (int _i36 = 0; _i36 < _list34.size; ++_i36)
          {
            _elem35 = iprot.readI64();
            struct.nasfs.add(_elem35);
          }
        }
        struct.setNasfsIsSet(true);
      }
      if (incoming.get(19)) {
        {
          ...
          struct.condutas = new ArrayList<Long>(_list37.size);
          long _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = iprot.readI64();
            struct.condutas.add(_elem38);
          }
        }
        struct.setCondutasIsSet(true);
      }

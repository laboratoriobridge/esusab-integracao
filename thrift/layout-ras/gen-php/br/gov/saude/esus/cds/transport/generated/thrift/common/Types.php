...
class VariasLotacoesHeaderThrift {
   ...
   */
  public $lotacaoFormPrincipalV2000 = null;
  /**
   * @var string
   */
  public $profissionalCNS1v2000 = null;
  /**
   * @var string
   */
  public $cboCodigo_2002_1v2000 = null;
  /**
   * @var string
   */
  public $profissionalCNS2v2000 = null;
  /**
   * @var string
   */
  public $cboCodigo_2002_2v2000 = null;
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\common\LotacaoHeaderThrift
   */
  ...
  public function __construct($vals=null) {
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'lotacaoFormPrincipalV2000',
          'type' => TType::STRUCT,
          'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\common\UnicaLotacaoHeaderThrift',
          ),
        2 => array(
          'var' => 'profissionalCNS1v2000',
          'type' => TType::STRING,
          ),
        3 => array(
          'var' => 'cboCodigo_2002_1v2000',
          'type' => TType::STRING,
          ),
        4 => array(
          'var' => 'profissionalCNS2v2000',
          'type' => TType::STRING,
          ),
        5 => array(
          'var' => 'cboCodigo_2002_2v2000',
          'type' => TType::STRING,
          ),
        6 => array(
          'var' => 'lotacaoFormPrincipal',
          'type' => TType::STRUCT,
          'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\common\LotacaoHeaderThrift',
          ),
        7 => array(
    ...
    if (is_array($vals)) {
      if (isset($vals['lotacaoFormPrincipalV2000'])) {
        $this->lotacaoFormPrincipalV2000 = $vals['lotacaoFormPrincipalV2000'];
      }
      if (isset($vals['profissionalCNS1v2000'])) {
        $this->profissionalCNS1v2000 = $vals['profissionalCNS1v2000'];
      }
      if (isset($vals['cboCodigo_2002_1v2000'])) {
        $this->cboCodigo_2002_1v2000 = $vals['cboCodigo_2002_1v2000'];
      }
      if (isset($vals['profissionalCNS2v2000'])) {
        $this->profissionalCNS2v2000 = $vals['profissionalCNS2v2000'];
      }
      if (isset($vals['cboCodigo_2002_2v2000'])) {
        $this->cboCodigo_2002_2v2000 = $vals['cboCodigo_2002_2v2000'];
      }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->lotacaoFormPrincipalV2000 = new \br\gov\saude\esus\cds\transport\generated\thrift\common\UnicaLotacaoHeaderThrift();
            $xfer += $this->lotacaoFormPrincipalV2000->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 2:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->profissionalCNS1v2000);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 3:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->cboCodigo_2002_1v2000);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 4:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->profissionalCNS2v2000);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 5:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->cboCodigo_2002_2v2000);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 6:
          if ($ftype == TType::STRUCT) {
            $this->lotacaoFormPrincipal = new \br\gov\saude\esus\cds\transport\generated\thrift\common\LotacaoHeaderThrift();
        ...
        case 7:
          if ($ftype == TType::STRUCT) {
            $this->lotacaoFormAtendimentoCompartilhado = new \br\gov\saude\esus\cds\transport\generated\thrift\common\LotacaoHeaderThrift();
  ...
  public function write($output) {
    ...
    if ($this->lotacaoFormPrincipalV2000 !== null) {
      if (!is_object($this->lotacaoFormPrincipalV2000)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('lotacaoFormPrincipalV2000', TType::STRUCT, 1);
      $xfer += $this->lotacaoFormPrincipalV2000->write($output);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->profissionalCNS1v2000 !== null) {
      $xfer += $output->writeFieldBegin('profissionalCNS1v2000', TType::STRING, 2);
      $xfer += $output->writeString($this->profissionalCNS1v2000);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->cboCodigo_2002_1v2000 !== null) {
      $xfer += $output->writeFieldBegin('cboCodigo_2002_1v2000', TType::STRING, 3);
      $xfer += $output->writeString($this->cboCodigo_2002_1v2000);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->profissionalCNS2v2000 !== null) {
      $xfer += $output->writeFieldBegin('profissionalCNS2v2000', TType::STRING, 4);
      $xfer += $output->writeString($this->profissionalCNS2v2000);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->cboCodigo_2002_2v2000 !== null) {
      $xfer += $output->writeFieldBegin('cboCodigo_2002_2v2000', TType::STRING, 5);
      $xfer += $output->writeString($this->cboCodigo_2002_2v2000);
      $xfer += $output->writeFieldEnd();
    }
      ...
      switch ($fid)
      {
        ...
        case 6:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \br\gov\saude\esus\cds\transport\generated\thrift\common\ResultadoExameThrift();

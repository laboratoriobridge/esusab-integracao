...
class CondicoesDeSaudeThrift:
  ...
  thrift_spec = (
    ...
    (28, TType.BOOL, 'statusTratamentoPsiquicoOuProblemaMentalV2000', None, None, ), # 28
  ...
  def __init__(self, descricaoCausaInternacaoEm12Meses=None, descricaoOutraCondicao1=None, descricaoOutraCondicao2=None, descricaoOutraCondicao3=None, descricaoPlantasMedicinaisUsadas=None, doencaCardiaca=None, doencaRespiratoria=None, doencaRins=None, maternidadeDeReferencia=None, situacaoPeso=None, statusEhDependenteAlcool=None, statusEhDependenteOutrasDrogas=None, statusEhFumante=None, statusEhGestante=None, statusEstaAcamado=None, statusEstaDomiciliado=None, statusTemDiabetes=None, statusTemDoencaRespiratoria=None, statusTemHanseniase=None, statusTemHipertensaoArterial=None, statusTemTeveCancer=None, statusTemTeveDoencasRins=None, statusTemTuberculose=None, statusTeveAvcDerrame=None, statusTeveDoencaCardiaca=None, statusTeveInfarto=None, statusTeveInternadoEm12Meses=None, statusTratamentoPsiquicoOuProblemaMentalV2000=None, statusUsaOutrasPraticasIntegrativasOuComplementares=None, statusUsaPlantaMedicinais=None, statusDiagnosticoMental=None,):
    ...
    self.statusTratamentoPsiquicoOuProblemaMentalV2000 = statusTratamentoPsiquicoOuProblemaMentalV2000
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.BOOL:
          self.statusTratamentoPsiquicoOuProblemaMentalV2000 = iprot.readBool()
        else:
          iprot.skip(ftype)
      elif fid == 29:
        if ftype == TType.BOOL:
  ...
  def write(self, oprot):
    ...
    if self.statusTeveInternadoEm12Meses is not None:
      ...
      oprot.writeFieldEnd()
    if self.statusTratamentoPsiquicoOuProblemaMentalV2000 is not None:
      oprot.writeFieldBegin('statusTratamentoPsiquicoOuProblemaMentalV2000', TType.BOOL, 28)
      oprot.writeBool(self.statusTratamentoPsiquicoOuProblemaMentalV2000)
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.statusTratamentoPsiquicoOuProblemaMentalV2000)
...
class IdentificacaoUsuarioCidadaoThrift:
  ...
  thrift_spec = (
    ...
    (4, TType.I64, 'dataNascimentoResponsavelV2000', None, None, ), # 4
  ...
  def __init__(self, nomeSocial=None, codigoIbgeMunicipioNascimento=None, dataNascimentoCidadao=None, dataNascimentoResponsavelV2000=None, desconheceNomeMae=None, emailCidadao=None, nacionalidadeCidadao=None, nomeCidadao=None, nomeMaeCidadao=None, cnsCidadao=None, cnsResponsavelFamiliar=None, telefoneCelular=None, numeroNisPisPasep=None, paisNascimento=None, racaCorCidadao=None, sexoCidadao=None, statusEhResponsavel=None, etnia=None, nomePaiCidadao=None, desconheceNomePai=None, dtNaturalizacao=None, portariaNaturalizacao=None, dtEntradaBrasil=None, microArea=None, stForaArea=None, cpfCidadao=None, cpfResponsavelFamiliar=None,):
    ...
    self.dataNascimentoResponsavelV2000 = dataNascimentoResponsavelV2000
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.I64:
          self.dataNascimentoResponsavelV2000 = iprot.readI64()
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.BOOL:
  ...
  def write(self, oprot):
    ...
    if self.dataNascimentoCidadao is not None:
      ...
      oprot.writeFieldEnd()
    if self.dataNascimentoResponsavelV2000 is not None:
      oprot.writeFieldBegin('dataNascimentoResponsavelV2000', TType.I64, 4)
      oprot.writeI64(self.dataNascimentoResponsavelV2000)
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.dataNascimentoResponsavelV2000)
...
class InformacoesSocioDemograficasThrift:
  ...
  thrift_spec = (
    ...
    (3, TType.I64, 'motivoSaidaCidadaoV2000', None, None, ), # 3
    ...
    (8, TType.I64, 'responsavelPorCriancaV2000', None, None, ), # 8
  ...
  def __init__(self, deficienciasCidadao=None, grauInstrucaoCidadao=None, motivoSaidaCidadaoV2000=None, ocupacaoCodigoCbo2002=None, orientacaoSexualCidadao=None, povoComunidadeTradicional=None, relacaoParentescoCidadao=None, responsavelPorCriancaV2000=None, situacaoMercadoTrabalhoCidadao=None, statusDesejaInformarOrientacaoSexual=None, statusFrequentaBenzedeira=None, statusFrequentaEscola=None, statusMembroPovoComunidadeTradicional=None, statusParticipaGrupoComunitario=None, statusPossuiPlanoSaudePrivado=None, statusTemAlgumaDeficiencia=None, identidadeGeneroCidadao=None, statusDesejaInformarIdentidadeGenero=None, responsavelPorCrianca=None,):
    ...
    self.responsavelPorCriancaV2000 = responsavelPorCriancaV2000
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.I64:
          self.motivoSaidaCidadaoV2000 = iprot.readI64()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.STRING:
        ...
        if ftype == TType.I64:
          self.responsavelPorCriancaV2000 = iprot.readI64()
        else:
          iprot.skip(ftype)
      elif fid == 9:
        if ftype == TType.I64:
  ...
  def write(self, oprot):
    ...
    if self.grauInstrucaoCidadao is not None:
      ...
      oprot.writeFieldEnd()
    if self.motivoSaidaCidadaoV2000 is not None:
      oprot.writeFieldBegin('motivoSaidaCidadaoV2000', TType.I64, 3)
      oprot.writeI64(self.motivoSaidaCidadaoV2000)
      oprot.writeFieldEnd()
    ...
    if self.relacaoParentescoCidadao is not None:
      ...
      oprot.writeFieldEnd()
    if self.responsavelPorCriancaV2000 is not None:
      oprot.writeFieldBegin('responsavelPorCriancaV2000', TType.I64, 8)
      oprot.writeI64(self.responsavelPorCriancaV2000)
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.motivoSaidaCidadaoV2000)
    ...
    value = (value * 31) ^ hash(self.responsavelPorCriancaV2000)
...
class CadastroIndividualThrift:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'dadosGeraisV2000', (common.ttypes.HeaderCdsCadastroThrift, common.ttypes.HeaderCdsCadastroThrift.thrift_spec), None, ), # 2
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.dadosGeraisV2000 = common.ttypes.HeaderCdsCadastroThrift()
          self.dadosGeraisV2000.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.STRUCT:
  ...
  def write(self, oprot):
    ...
    if self.condicoesDeSaude is not None:
      ...
      oprot.writeFieldEnd()
    if self.dadosGeraisV2000 is not None:
      oprot.writeFieldBegin('dadosGeraisV2000', TType.STRUCT, 2)
      self.dadosGeraisV2000.write(oprot)
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.dadosGeraisV2000)

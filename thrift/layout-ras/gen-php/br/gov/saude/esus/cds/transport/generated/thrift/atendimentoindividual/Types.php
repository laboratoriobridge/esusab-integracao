<?php
namespace br\gov\saude\esus\cds\transport\generated\thrift\atendimentoindividual;
...
class OutrosSiaThrift {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('OutrosSiaThrift');
...
class FichaAtendimentoIndividualChildThrift {
  ...
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\atendimentoindividual\ProblemaCondicaoAvaliacaoAIThrift
   */
  public $problemaCondicaoAvaliada = null;
  /**
   * @var string[]
   */
  public $examesSolicitadosV321 = null;
  /**
   * @var string[]
   */
  public $examesAvaliadosV321 = null;
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\atendimentoindividual\OutrosSiaThrift[]
   */
  public $exame = null;
  /**
   * @var bool
  ...
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\common\MedicamentoThrift[]
   */
  public $medicamentos = null;
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\common\EncaminhamentoExternoThrift[]
   */
  public $encaminhamentos = null;
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\common\ResultadosExameThrift[]
   */
  ...
  public function __construct($vals=null) {
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        14 => array(
          ...
          'type' => TType::STRUCT,
          'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\atendimentoindividual\ProblemaCondicaoAvaliacaoAIThrift',
          ),
        15 => array(
          'var' => 'examesSolicitadosV321',
          'type' => TType::LST,
          'etype' => TType::STRING,
          'elem' => array(
            'type' => TType::STRING,
        ...
        17 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\atendimentoindividual\OutrosSiaThrift',
            ),
          ),
        18 => array(
          'var' => 'vacinaEmDia',
        ...
        31 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\common\MedicamentoThrift',
            ),
          ),
        32 => array(
          'var' => 'encaminhamentos',
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\common\EncaminhamentoExternoThrift',
            ),
          ),
        33 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\common\ResultadosExameThrift',
            ),
          ),
        );
    }
    if (is_array($vals)) {
      ...
      if (isset($vals['examesSolicitadosV321'])) {
        $this->examesSolicitadosV321 = $vals['examesSolicitadosV321'];
      }
      if (isset($vals['examesAvaliadosV321'])) {
        $this->examesAvaliadosV321 = $vals['examesAvaliadosV321'];
      }
      if (isset($vals['exame'])) {
      ...
      switch ($fid)
      {
        ...
        case 14:
          if ($ftype == TType::STRUCT) {
            $this->problemaCondicaoAvaliada = new \br\gov\saude\esus\cds\transport\generated\thrift\atendimentoindividual\ProblemaCondicaoAvaliacaoAIThrift();
        ...
        case 15:
          if ($ftype == TType::LST) {
            $this->examesSolicitadosV321 = array();
            $_size14 = 0;
            $_etype17 = 0;
            ...
            for ($_i18 = 0; $_i18 < $_size14; ++$_i18)
            {
              ...
              $this->examesSolicitadosV321 []= $elem19;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 16:
          if ($ftype == TType::LST) {
            $this->examesAvaliadosV321 = array();
            $_size20 = 0;
            $_etype23 = 0;
            ...
            for ($_i24 = 0; $_i24 < $_size20; ++$_i24)
            {
              ...
              $this->examesAvaliadosV321 []= $elem25;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 17:
          if ($ftype == TType::LST) {
            ...
            {
              $elem31 = null;
              $elem31 = new \br\gov\saude\esus\cds\transport\generated\thrift\atendimentoindividual\OutrosSiaThrift();
        ...
        case 22:
          if ($ftype == TType::LST) {
            ...
            {
              $elem43 = null;
              $xfer += $input->readI64($elem43);
              $this->condutas []= $elem43;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 31:
          if ($ftype == TType::LST) {
            ...
            {
              $elem49 = null;
              $elem49 = new \br\gov\saude\esus\cds\transport\generated\thrift\common\MedicamentoThrift();
              $xfer += $elem49->read($input);
              $this->medicamentos []= $elem49;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 32:
          if ($ftype == TType::LST) {
            ...
            {
              $elem55 = null;
              $elem55 = new \br\gov\saude\esus\cds\transport\generated\thrift\common\EncaminhamentoExternoThrift();
              $xfer += $elem55->read($input);
              $this->encaminhamentos []= $elem55;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 33:
          if ($ftype == TType::LST) {
            ...
            {
              $elem61 = null;
              $elem61 = new \br\gov\saude\esus\cds\transport\generated\thrift\common\ResultadosExameThrift();
              $xfer += $elem61->read($input);
              $this->resultadosExames []= $elem61;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->examesSolicitadosV321 !== null) {
      if (!is_array($this->examesSolicitadosV321)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('examesSolicitadosV321', TType::LST, 15);
      {
        $output->writeListBegin(TType::STRING, count($this->examesSolicitadosV321));
        {
          foreach ($this->examesSolicitadosV321 as $iter62)
          {
    ...
    if ($this->examesAvaliadosV321 !== null) {
      if (!is_array($this->examesAvaliadosV321)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('examesAvaliadosV321', TType::LST, 16);
      {
        $output->writeListBegin(TType::STRING, count($this->examesAvaliadosV321));
        {
          foreach ($this->examesAvaliadosV321 as $iter63)
          {
    ...
    if ($this->condutas !== null) {
      ...
      $xfer += $output->writeFieldBegin('condutas', TType::LST, 22);
      {
        ...
        {
          foreach ($this->condutas as $iter66)
          {
    ...
    if ($this->medicamentos !== null) {
      ...
      $xfer += $output->writeFieldBegin('medicamentos', TType::LST, 31);
      {
        ...
        {
          foreach ($this->medicamentos as $iter67)
          {
    ...
    if ($this->encaminhamentos !== null) {
      ...
      $xfer += $output->writeFieldBegin('encaminhamentos', TType::LST, 32);
      {
        ...
        {
          foreach ($this->encaminhamentos as $iter68)
          {
    ...
    if ($this->resultadosExames !== null) {
      ...
      $xfer += $output->writeFieldBegin('resultadosExames', TType::LST, 33);
      {
        ...
        {
          foreach ($this->resultadosExames as $iter69)
          {
...
class FichaAtendimentoIndividualMasterThrift {
  ...
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\common\VariasLotacoesHeaderThrift
   */
  public $headerTransport = null;
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\atendimentoindividual\FichaAtendimentoIndividualChildThrift[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        1 => array(
          'var' => 'headerTransport',
          'type' => TType::STRUCT,
          'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\common\VariasLotacoesHeaderThrift',
          ),
        2 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\atendimentoindividual\FichaAtendimentoIndividualChildThrift',
            ),
          ),
        3 => array(
          'var' => 'uuidFicha',
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->headerTransport = new \br\gov\saude\esus\cds\transport\generated\thrift\common\VariasLotacoesHeaderThrift();
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem75 = null;
              $elem75 = new \br\gov\saude\esus\cds\transport\generated\thrift\atendimentoindividual\FichaAtendimentoIndividualChildThrift();

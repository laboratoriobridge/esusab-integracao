...
namespace br.gov.saude.esus.cds.transport.generated.thrift.avaliacaoelegibilidade
{
  ...
  public partial class FichaAvaliacaoElegibilidadeThrift : TBase
  {
    ...
    private br.gov.saude.esus.cds.transport.generated.thrift.common.UnicaLotacaoHeaderThrift _headerTransportV200;
    ...
    private long _turno;
    private br.gov.saude.esus.cds.transport.generated.thrift.common.VariasLotacoesHeaderThrift _headerTransport;
    ...
    public br.gov.saude.esus.cds.transport.generated.thrift.common.UnicaLotacaoHeaderThrift HeaderTransportV200
    {
      get
      {
        return _headerTransportV200;
      }
      set
      {
        __isset.headerTransportV200 = true;
        this._headerTransportV200 = value;
      }
    }
    ...
    public br.gov.saude.esus.cds.transport.generated.thrift.common.VariasLotacoesHeaderThrift HeaderTransport
    {
      get
      {
    ...
    public struct Isset {
      ...
      public bool headerTransportV200;
          ...
          switch (field.ID)
          {
            ...
            case 3:
              if (field.Type == TType.Struct) {
                HeaderTransportV200 = new br.gov.saude.esus.cds.transport.generated.thrift.common.UnicaLotacaoHeaderThrift();
            ...
            case 27:
              if (field.Type == TType.Struct) {
                HeaderTransport = new br.gov.saude.esus.cds.transport.generated.thrift.common.VariasLotacoesHeaderThrift();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (HeaderTransportV200 != null && __isset.headerTransportV200) {
          field.Name = "headerTransportV200";
    ...
    public override string ToString() {
      ...
      if (HeaderTransportV200 != null && __isset.headerTransportV200) {
        __sb.Append(", HeaderTransportV200: ");
        __sb.Append(HeaderTransportV200== null ? "<null>" : HeaderTransportV200.ToString());
      }
      if (CnsCidadao != null && __isset.cnsCidadao) {

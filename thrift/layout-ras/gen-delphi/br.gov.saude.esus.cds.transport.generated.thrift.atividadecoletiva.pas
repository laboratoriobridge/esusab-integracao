...
type
  ...
  IFichaAtividadeColetivaThrift = interface(IBase)
    ...
    function GetDtAtividadeColetivaV200: Int64;
    procedure SetDtAtividadeColetivaV200( const Value: Int64);
    function GetNumParticipantesProgramadosV200: Integer;
    procedure SetNumParticipantesProgramadosV200( const Value: Integer);
    function GetOutraLocalidade: string;
    procedure SetOutraLocalidade( const Value: string);
    function GetHoraInicioV200: Int64;
    procedure SetHoraInicioV200( const Value: Int64);
    function GetHoraFimV200: Int64;
    procedure SetHoraFimV200( const Value: Int64);
    function GetInep: Int64;
    procedure SetInep( const Value: Int64);
    function GetResponsavelCnsV200: string;
    procedure SetResponsavelCnsV200( const Value: string);
    function GetResponsavelCnesUnidadeV200: string;
    procedure SetResponsavelCnesUnidadeV200( const Value: string);
    function GetResponsavelNumIneV200: string;
    procedure SetResponsavelNumIneV200( const Value: string);
    ...
    function GetPraticasTemasParaSaudeV200: IThriftList<Int64>;
    procedure SetPraticasTemasParaSaudeV200( const Value: IThriftList<Int64>);
    ...
    function GetCodigoIbgeMunicipioV200: string;
    procedure SetCodigoIbgeMunicipioV200( const Value: string);
    ...
    property DtAtividadeColetivaV200: Int64 read GetDtAtividadeColetivaV200 write SetDtAtividadeColetivaV200;
    property NumParticipantesProgramadosV200: Integer read GetNumParticipantesProgramadosV200 write SetNumParticipantesProgramadosV200;
    property OutraLocalidade: string read GetOutraLocalidade write SetOutraLocalidade;
    property HoraInicioV200: Int64 read GetHoraInicioV200 write SetHoraInicioV200;
    property HoraFimV200: Int64 read GetHoraFimV200 write SetHoraFimV200;
    property Inep: Int64 read GetInep write SetInep;
    property ResponsavelCnsV200: string read GetResponsavelCnsV200 write SetResponsavelCnsV200;
    property ResponsavelCnesUnidadeV200: string read GetResponsavelCnesUnidadeV200 write SetResponsavelCnesUnidadeV200;
    property ResponsavelNumIneV200: string read GetResponsavelNumIneV200 write SetResponsavelNumIneV200;
    ...
    property PraticasTemasParaSaudeV200: IThriftList<Int64> read GetPraticasTemasParaSaudeV200 write SetPraticasTemasParaSaudeV200;
    ...
    property CodigoIbgeMunicipioV200: string read GetCodigoIbgeMunicipioV200 write SetCodigoIbgeMunicipioV200;
    ...
    function Get__isset_DtAtividadeColetivaV200: Boolean;
    function Get__isset_NumParticipantesProgramadosV200: Boolean;
    function Get__isset_OutraLocalidade: Boolean;
    function Get__isset_HoraInicioV200: Boolean;
    function Get__isset_HoraFimV200: Boolean;
    function Get__isset_Inep: Boolean;
    function Get__isset_ResponsavelCnsV200: Boolean;
    function Get__isset_ResponsavelCnesUnidadeV200: Boolean;
    function Get__isset_ResponsavelNumIneV200: Boolean;
    ...
    function Get__isset_PraticasTemasParaSaudeV200: Boolean;
    function Get__isset_Participantes: Boolean;
    function Get__isset_TbCdsOrigem: Boolean;
    function Get__isset_CodigoIbgeMunicipioV200: Boolean;
    ...
    property __isset_DtAtividadeColetivaV200: Boolean read Get__isset_DtAtividadeColetivaV200;
    property __isset_NumParticipantesProgramadosV200: Boolean read Get__isset_NumParticipantesProgramadosV200;
    property __isset_OutraLocalidade: Boolean read Get__isset_OutraLocalidade;
    property __isset_HoraInicioV200: Boolean read Get__isset_HoraInicioV200;
    property __isset_HoraFimV200: Boolean read Get__isset_HoraFimV200;
    property __isset_Inep: Boolean read Get__isset_Inep;
    property __isset_ResponsavelCnsV200: Boolean read Get__isset_ResponsavelCnsV200;
    property __isset_ResponsavelCnesUnidadeV200: Boolean read Get__isset_ResponsavelCnesUnidadeV200;
    property __isset_ResponsavelNumIneV200: Boolean read Get__isset_ResponsavelNumIneV200;
    ...
    property __isset_PraticasTemasParaSaudeV200: Boolean read Get__isset_PraticasTemasParaSaudeV200;
    ...
    property __isset_CodigoIbgeMunicipioV200: Boolean read Get__isset_CodigoIbgeMunicipioV200;
  ...
  private
    FUuidFicha: string;
    FDtAtividadeColetivaV200: Int64;
    FNumParticipantesProgramadosV200: Integer;
    FOutraLocalidade: string;
    FHoraInicioV200: Int64;
    FHoraFimV200: Int64;
    FInep: Int64;
    FResponsavelCnsV200: string;
    FResponsavelCnesUnidadeV200: string;
    FResponsavelNumIneV200: string;
    ...
    FPraticasTemasParaSaudeV200: IThriftList<Int64>;
    FParticipantes: IThriftList<IParticipanteRowItemThrift>;
    FTbCdsOrigem: Integer;
    FCodigoIbgeMunicipioV200: string;
    ...
    F__isset_DtAtividadeColetivaV200: Boolean;
    F__isset_NumParticipantesProgramadosV200: Boolean;
    F__isset_OutraLocalidade: Boolean;
    F__isset_HoraInicioV200: Boolean;
    F__isset_HoraFimV200: Boolean;
    F__isset_Inep: Boolean;
    F__isset_ResponsavelCnsV200: Boolean;
    F__isset_ResponsavelCnesUnidadeV200: Boolean;
    F__isset_ResponsavelNumIneV200: Boolean;
    ...
    F__isset_PraticasTemasParaSaudeV200: Boolean;
    F__isset_Participantes: Boolean;
    F__isset_TbCdsOrigem: Boolean;
    F__isset_CodigoIbgeMunicipioV200: Boolean;
...
function TFichaAtividadeColetivaThriftImpl.GetDtAtividadeColetivaV200: Int64;
begin
  Result := FDtAtividadeColetivaV200;
end;

procedure TFichaAtividadeColetivaThriftImpl.SetDtAtividadeColetivaV200( const Value: Int64);
begin
  F__isset_DtAtividadeColetivaV200 := True;
  FDtAtividadeColetivaV200 := Value;
end;

function TFichaAtividadeColetivaThriftImpl.Get__isset_DtAtividadeColetivaV200: Boolean;
begin
  Result := F__isset_DtAtividadeColetivaV200;
end;

function TFichaAtividadeColetivaThriftImpl.GetNumParticipantesProgramadosV200: Integer;
begin
  Result := FNumParticipantesProgramadosV200;
end;

procedure TFichaAtividadeColetivaThriftImpl.SetNumParticipantesProgramadosV200( const Value: Integer);
begin
  F__isset_NumParticipantesProgramadosV200 := True;
  FNumParticipantesProgramadosV200 := Value;
end;

function TFichaAtividadeColetivaThriftImpl.Get__isset_NumParticipantesProgramadosV200: Boolean;
begin
  Result := F__isset_NumParticipantesProgramadosV200;
end;
...
function TFichaAtividadeColetivaThriftImpl.GetHoraInicioV200: Int64;
begin
  Result := FHoraInicioV200;
end;

procedure TFichaAtividadeColetivaThriftImpl.SetHoraInicioV200( const Value: Int64);
begin
  F__isset_HoraInicioV200 := True;
  FHoraInicioV200 := Value;
end;

function TFichaAtividadeColetivaThriftImpl.Get__isset_HoraInicioV200: Boolean;
begin
  Result := F__isset_HoraInicioV200;
end;

function TFichaAtividadeColetivaThriftImpl.GetHoraFimV200: Int64;
begin
  Result := FHoraFimV200;
end;

procedure TFichaAtividadeColetivaThriftImpl.SetHoraFimV200( const Value: Int64);
begin
  F__isset_HoraFimV200 := True;
  FHoraFimV200 := Value;
end;

function TFichaAtividadeColetivaThriftImpl.Get__isset_HoraFimV200: Boolean;
begin
  Result := F__isset_HoraFimV200;
end;
...
function TFichaAtividadeColetivaThriftImpl.GetResponsavelCnsV200: string;
begin
  Result := FResponsavelCnsV200;
end;

procedure TFichaAtividadeColetivaThriftImpl.SetResponsavelCnsV200( const Value: string);
begin
  F__isset_ResponsavelCnsV200 := True;
  FResponsavelCnsV200 := Value;
end;

function TFichaAtividadeColetivaThriftImpl.Get__isset_ResponsavelCnsV200: Boolean;
begin
  Result := F__isset_ResponsavelCnsV200;
end;

function TFichaAtividadeColetivaThriftImpl.GetResponsavelCnesUnidadeV200: string;
begin
  Result := FResponsavelCnesUnidadeV200;
end;

procedure TFichaAtividadeColetivaThriftImpl.SetResponsavelCnesUnidadeV200( const Value: string);
begin
  F__isset_ResponsavelCnesUnidadeV200 := True;
  FResponsavelCnesUnidadeV200 := Value;
end;

function TFichaAtividadeColetivaThriftImpl.Get__isset_ResponsavelCnesUnidadeV200: Boolean;
begin
  Result := F__isset_ResponsavelCnesUnidadeV200;
end;

function TFichaAtividadeColetivaThriftImpl.GetResponsavelNumIneV200: string;
begin
  Result := FResponsavelNumIneV200;
end;

procedure TFichaAtividadeColetivaThriftImpl.SetResponsavelNumIneV200( const Value: string);
begin
  F__isset_ResponsavelNumIneV200 := True;
  FResponsavelNumIneV200 := Value;
end;

function TFichaAtividadeColetivaThriftImpl.Get__isset_ResponsavelNumIneV200: Boolean;
begin
  Result := F__isset_ResponsavelNumIneV200;
end;
...
function TFichaAtividadeColetivaThriftImpl.GetPraticasTemasParaSaudeV200: IThriftList<Int64>;
begin
  Result := FPraticasTemasParaSaudeV200;
end;

procedure TFichaAtividadeColetivaThriftImpl.SetPraticasTemasParaSaudeV200( const Value: IThriftList<Int64>);
begin
  F__isset_PraticasTemasParaSaudeV200 := True;
  FPraticasTemasParaSaudeV200 := Value;
end;

function TFichaAtividadeColetivaThriftImpl.Get__isset_PraticasTemasParaSaudeV200: Boolean;
begin
  Result := F__isset_PraticasTemasParaSaudeV200;
end;
...
function TFichaAtividadeColetivaThriftImpl.GetCodigoIbgeMunicipioV200: string;
begin
  Result := FCodigoIbgeMunicipioV200;
end;

procedure TFichaAtividadeColetivaThriftImpl.SetCodigoIbgeMunicipioV200( const Value: string);
begin
  F__isset_CodigoIbgeMunicipioV200 := True;
  FCodigoIbgeMunicipioV200 := Value;
end;

function TFichaAtividadeColetivaThriftImpl.Get__isset_CodigoIbgeMunicipioV200: Boolean;
begin
  Result := F__isset_CodigoIbgeMunicipioV200;
end;
    ...
    begin
      ...
      case field_.ID of
        ...
        2: begin
          if (field_.Type_ = TType.I64) then
          begin
            DtAtividadeColetivaV200 := iprot.ReadI64();
          end else
          begin
            TProtocolUtil.Skip(iprot, field_.Type_);
          end;
        ...
        3: begin
          ...
          begin
            NumParticipantesProgramadosV200 := iprot.ReadI32();
          end else
          begin
            TProtocolUtil.Skip(iprot, field_.Type_);
          end;
        ...
        8: begin
          if (field_.Type_ = TType.String_) then
          begin
            ResponsavelCnsV200 := iprot.ReadString();
          end else
          begin
            TProtocolUtil.Skip(iprot, field_.Type_);
          end;
        ...
        9: begin
          if (field_.Type_ = TType.String_) then
          begin
            ResponsavelCnesUnidadeV200 := iprot.ReadString();
          end else
          begin
            TProtocolUtil.Skip(iprot, field_.Type_);
          end;
        ...
        10: begin
          if (field_.Type_ = TType.String_) then
          begin
            ResponsavelNumIneV200 := iprot.ReadString();
          end else
          begin
            TProtocolUtil.Skip(iprot, field_.Type_);
          end;
        ...
        17: begin
          if (field_.Type_ = TType.List) then
          begin
            PraticasTemasParaSaudeV200 := TThriftListImpl<Int64>.Create;
            _list13 := iprot.ReadListBegin();
            for _i14 := 0 to _list13.Count - 1 do
            begin
              _elem15 := iprot.ReadI64();
              PraticasTemasParaSaudeV200.Add(_elem15);
            end;
            iprot.ReadListEnd();
          end else
          begin
        ...
        20: begin
          if (field_.Type_ = TType.String_) then
          begin
            CodigoIbgeMunicipioV200 := iprot.ReadString();
          end else
          begin
            TProtocolUtil.Skip(iprot, field_.Type_);
          end;
...
var
  ...
  tracker : IProtocolRecursionTracker;
  list_25 : IList;
  _iter26: IProfissionalCboRowItemThrift;
  list_27 : IList;
  _iter28: Int64;
  list_29 : IList;
  _iter30: Int64;
  ...
  _iter32: Int64;
  list_33 : IList;
  _iter34: IParticipanteRowItemThrift;
  list_35 : IList;
  _iter36: Int64;
  list_37 : IList;
  _iter38: Int64;
begin
  ...
  oprot.WriteFieldEnd();
  if (__isset_DtAtividadeColetivaV200) then
  begin
    field_.Name := 'dtAtividadeColetivaV200';
    field_.Type_  := TType.I64;
    field_.ID := 2;
    oprot.WriteFieldBegin(field_);
    oprot.WriteI64(DtAtividadeColetivaV200);
    oprot.WriteFieldEnd();
  end;
  if (__isset_NumParticipantesProgramadosV200) then
  begin
    field_.Name := 'numParticipantesProgramadosV200';
    field_.Type_  := TType.I32;
    field_.ID := 3;
    oprot.WriteFieldBegin(field_);
    oprot.WriteI32(NumParticipantesProgramadosV200);
    oprot.WriteFieldEnd();
  end;
  ...
  if (__isset_HoraInicioV200) then
  begin
    field_.Name := 'horaInicioV200';
    field_.Type_  := TType.I64;
    field_.ID := 5;
    oprot.WriteFieldBegin(field_);
    oprot.WriteI64(HoraInicioV200);
    oprot.WriteFieldEnd();
  end;
  if (__isset_HoraFimV200) then
  begin
    field_.Name := 'horaFimV200';
    field_.Type_  := TType.I64;
    field_.ID := 6;
    oprot.WriteFieldBegin(field_);
    oprot.WriteI64(HoraFimV200);
    oprot.WriteFieldEnd();
  end;
  ...
  if (__isset_ResponsavelCnsV200) then
  begin
    field_.Name := 'responsavelCnsV200';
    field_.Type_  := TType.String_;
    field_.ID := 8;
    oprot.WriteFieldBegin(field_);
    oprot.WriteString(ResponsavelCnsV200);
    oprot.WriteFieldEnd();
  end;
  if (__isset_ResponsavelCnesUnidadeV200) then
  begin
    field_.Name := 'responsavelCnesUnidadeV200';
    field_.Type_  := TType.String_;
    field_.ID := 9;
    oprot.WriteFieldBegin(field_);
    oprot.WriteString(ResponsavelCnesUnidadeV200);
    oprot.WriteFieldEnd();
  end;
  if (__isset_ResponsavelNumIneV200) then
  begin
    field_.Name := 'responsavelNumIneV200';
    field_.Type_  := TType.String_;
    field_.ID := 10;
    oprot.WriteFieldBegin(field_);
    oprot.WriteString(ResponsavelNumIneV200);
    oprot.WriteFieldEnd();
  end;
  ...
  begin
    ...
    field_.ID := 13;
    oprot.WriteFieldBegin(field_);
    list_25 := TListImpl.Create(TType.Struct, Profissionais.Count);
    oprot.WriteListBegin( list_25);
    for _iter26 in Profissionais do
    begin
      _iter26.Write(oprot);
    end;
    oprot.WriteListEnd();
  ...
  begin
    ...
    field_.ID := 15;
    oprot.WriteFieldBegin(field_);
    list_27 := TListImpl.Create(TType.I64, TemasParaReuniao.Count);
    oprot.WriteListBegin( list_27);
    for _iter28 in TemasParaReuniao do
    begin
  ...
  begin
    ...
    field_.ID := 16;
    oprot.WriteFieldBegin(field_);
    list_29 := TListImpl.Create(TType.I64, PublicoAlvo.Count);
    oprot.WriteListBegin( list_29);
    for _iter30 in PublicoAlvo do
    begin
  ...
  if (PraticasTemasParaSaudeV200 <> nil) and __isset_PraticasTemasParaSaudeV200 then
  begin
    field_.Name := 'praticasTemasParaSaudeV200';
    field_.Type_  := TType.List;
    field_.ID := 17;
    oprot.WriteFieldBegin(field_);
    list_31 := TListImpl.Create(TType.I64, PraticasTemasParaSaudeV200.Count);
    oprot.WriteListBegin( list_31);
    for _iter32 in PraticasTemasParaSaudeV200 do
    begin
  ...
  begin
    ...
    field_.ID := 18;
    oprot.WriteFieldBegin(field_);
    list_33 := TListImpl.Create(TType.Struct, Participantes.Count);
    oprot.WriteListBegin( list_33);
    for _iter34 in Participantes do
    begin
      _iter34.Write(oprot);
    end;
    oprot.WriteListEnd();
  ...
  if (__isset_CodigoIbgeMunicipioV200) then
  begin
    field_.Name := 'codigoIbgeMunicipioV200';
    field_.Type_  := TType.String_;
    field_.ID := 20;
    oprot.WriteFieldBegin(field_);
    oprot.WriteString(CodigoIbgeMunicipioV200);
    oprot.WriteFieldEnd();
  end;
  ...
  begin
    ...
    field_.ID := 25;
    oprot.WriteFieldBegin(field_);
    list_35 := TListImpl.Create(TType.I64, TemasParaSaude.Count);
    oprot.WriteListBegin( list_35);
    for _iter36 in TemasParaSaude do
    begin
  ...
  begin
    ...
    field_.ID := 26;
    oprot.WriteFieldBegin(field_);
    list_37 := TListImpl.Create(TType.I64, PraticasEmSaude.Count);
    oprot.WriteListBegin( list_37);
    for _iter38 in PraticasEmSaude do
    begin
...
begin
  ...
  try
    _sb39.Append(', UuidFicha: ');
    _sb39.Append(UuidFicha);
    if (__isset_DtAtividadeColetivaV200) then begin
      _sb39.Append(', DtAtividadeColetivaV200: ');
      _sb39.Append(DtAtividadeColetivaV200);
    end;
    if (__isset_NumParticipantesProgramadosV200) then begin
      _sb39.Append(', NumParticipantesProgramadosV200: ');
      _sb39.Append(NumParticipantesProgramadosV200);
    end;
    if (__isset_OutraLocalidade) then begin
      _sb39.Append(', OutraLocalidade: ');
      _sb39.Append(OutraLocalidade);
    end;
    if (__isset_HoraInicioV200) then begin
      _sb39.Append(', HoraInicioV200: ');
      _sb39.Append(HoraInicioV200);
    end;
    if (__isset_HoraFimV200) then begin
      _sb39.Append(', HoraFimV200: ');
      _sb39.Append(HoraFimV200);
    end;
    ...
    if (__isset_ResponsavelCnsV200) then begin
      _sb39.Append(', ResponsavelCnsV200: ');
      _sb39.Append(ResponsavelCnsV200);
    end;
    if (__isset_ResponsavelCnesUnidadeV200) then begin
      _sb39.Append(', ResponsavelCnesUnidadeV200: ');
      _sb39.Append(ResponsavelCnesUnidadeV200);
    end;
    if (__isset_ResponsavelNumIneV200) then begin
      _sb39.Append(', ResponsavelNumIneV200: ');
      _sb39.Append(ResponsavelNumIneV200);
    end;
    if (__isset_NumParticipantes) then begin
      _sb39.Append(', NumParticipantes: ');
      _sb39.Append(NumParticipantes);
    end;
    if (__isset_NumAvaliacoesAlteradas) then begin
      _sb39.Append(', NumAvaliacoesAlteradas: ');
      _sb39.Append(NumAvaliacoesAlteradas);
    end;
    if (Profissionais <> nil) and __isset_Profissionais then begin
      _sb39.Append(', Profissionais: ');
      _sb39.Append(Profissionais);
    end;
    if (__isset_AtividadeTipo) then begin
      _sb39.Append(', AtividadeTipo: ');
      _sb39.Append(AtividadeTipo);
    end;
    if (TemasParaReuniao <> nil) and __isset_TemasParaReuniao then begin
      _sb39.Append(', TemasParaReuniao: ');
      _sb39.Append(TemasParaReuniao);
    end;
    if (PublicoAlvo <> nil) and __isset_PublicoAlvo then begin
      _sb39.Append(', PublicoAlvo: ');
      _sb39.Append(PublicoAlvo);
    end;
    if (PraticasTemasParaSaudeV200 <> nil) and __isset_PraticasTemasParaSaudeV200 then begin
      _sb39.Append(', PraticasTemasParaSaudeV200: ');
      _sb39.Append(PraticasTemasParaSaudeV200);
    end;
    if (Participantes <> nil) and __isset_Participantes then begin
      _sb39.Append(', Participantes: ');
      _sb39.Append(Participantes);
    end;
    if (__isset_TbCdsOrigem) then begin
      _sb39.Append(', TbCdsOrigem: ');
      _sb39.Append(TbCdsOrigem);
    end;
    if (__isset_CodigoIbgeMunicipioV200) then begin
      _sb39.Append(', CodigoIbgeMunicipioV200: ');
      _sb39.Append(CodigoIbgeMunicipioV200);
    end;
    if (__isset_CnesLocalAtividade) then begin
      _sb39.Append(', CnesLocalAtividade: ');
      _sb39.Append(CnesLocalAtividade);
    end;
    if (__isset_Procedimento) then begin
      _sb39.Append(', Procedimento: ');
      _sb39.Append(Procedimento);
    end;
    ...
    if (HeaderTransport <> nil) and __isset_HeaderTransport then begin
      _sb39.Append(', HeaderTransport: ');
      if (HeaderTransport = nil) then _sb39.Append('<null>') else _sb39.Append(HeaderTransport.ToString());
    end;
    if (TemasParaSaude <> nil) and __isset_TemasParaSaude then begin
      _sb39.Append(', TemasParaSaude: ');
      _sb39.Append(TemasParaSaude);
    end;
    if (PraticasEmSaude <> nil) and __isset_PraticasEmSaude then begin
      _sb39.Append(', PraticasEmSaude: ');
      _sb39.Append(PraticasEmSaude);
    end;
    if (__isset_PseEducacao) then begin
      _sb39.Append(', PseEducacao: ');
      _sb39.Append(PseEducacao);
    end;
    if (__isset_PseSaude) then begin
      _sb39.Append(', PseSaude: ');
      _sb39.Append(PseSaude);
    end;
    _sb39.Append(')');

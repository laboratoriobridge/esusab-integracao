...
unit br.gov.saude.esus.cds.transport.generated.thrift.atendimentoodontologico;
...
const
  cbr_gov_saude_esus_cds_transport_generated_thrift_atendimentoodontologico_Option_AnsiStr_Binary = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_atendimentoodontologico_Option_Register_Types = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_atendimentoodontologico_Option_ConstPrefix    = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_atendimentoodontologico_Option_Events         = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_atendimentoodontologico_Option_XmlDoc         = False;
...
type
  ...
  IFichaAtendimentoOdontologicoChildThrift = interface(IBase)
    ...
    function GetNumCartaoSus: string;
    procedure SetNumCartaoSus( const Value: string);
    ...
    function GetOutrosSiaProcedimentos: IThriftList<IProcedimentoQuantidadeThrift>;
    procedure SetOutrosSiaProcedimentos( const Value: IThriftList<IProcedimentoQuantidadeThrift>);
    ...
    property NumCartaoSus: string read GetNumCartaoSus write SetNumCartaoSus;
    ...
    property OutrosSiaProcedimentos: IThriftList<IProcedimentoQuantidadeThrift> read GetOutrosSiaProcedimentos write SetOutrosSiaProcedimentos;
    ...
    function Get__isset_NumCartaoSus: Boolean;
    ...
    property __isset_NumCartaoSus: Boolean read Get__isset_NumCartaoSus;
  ...
  private
    ...
    FOutrosSiaProcedimentos: IThriftList<IProcedimentoQuantidadeThrift>;
    FSexo: Int64;
    FTurno: Int64;
    
    F__isset_DtNascimento: Boolean;
    F__isset_NumCartaoSus: Boolean;
...
function TFichaAtendimentoOdontologicoChildThriftImpl.GetNumCartaoSus: string;
begin
  Result := FNumCartaoSus;
end;

procedure TFichaAtendimentoOdontologicoChildThriftImpl.SetNumCartaoSus( const Value: string);
begin
  F__isset_NumCartaoSus := True;
  FNumCartaoSus := Value;
end;

function TFichaAtendimentoOdontologicoChildThriftImpl.Get__isset_NumCartaoSus: Boolean;
begin
  Result := F__isset_NumCartaoSus;
end;
...
function TFichaAtendimentoOdontologicoChildThriftImpl.GetOutrosSiaProcedimentos: IThriftList<IProcedimentoQuantidadeThrift>;
begin
  Result := FOutrosSiaProcedimentos;
end;

procedure TFichaAtendimentoOdontologicoChildThriftImpl.SetOutrosSiaProcedimentos( const Value: IThriftList<IProcedimentoQuantidadeThrift>);
begin
  F__isset_OutrosSiaProcedimentos := True;
  FOutrosSiaProcedimentos := Value;
end;

function TFichaAtendimentoOdontologicoChildThriftImpl.Get__isset_OutrosSiaProcedimentos: Boolean;
begin
...
var
  ...
  _list17: IList;
  _i18: Integer;
  _elem19: IProcedimentoQuantidadeThrift;
    ...
    begin
      ...
      case field_.ID of
        ...
        13: begin
          if (field_.Type_ = TType.List) then
          begin
            OutrosSiaProcedimentos := TThriftListImpl<IProcedimentoQuantidadeThrift>.Create;
            _list17 := iprot.ReadListBegin();
            for _i18 := 0 to _list17.Count - 1 do
            begin
              _elem19 := TProcedimentoQuantidadeThriftImpl.Create;
              _elem19.Read(iprot);
              OutrosSiaProcedimentos.Add(_elem19);
            end;
            iprot.ReadListEnd();
          end else
          begin
...
var
  ...
  _iter27: Int64;
  list_28 : IList;
  _iter29: IProcedimentoQuantidadeThrift;
  list_30 : IList;
  _iter31: IProcedimentoQuantidadeThrift;
begin
  ...
  if (__isset_NumCartaoSus) then
  begin
    field_.Name := 'numCartaoSus';
    field_.Type_  := TType.String_;
    field_.ID := 2;
    oprot.WriteFieldBegin(field_);
  ...
  begin
    ...
    field_.ID := 8;
    oprot.WriteFieldBegin(field_);
    list_20 := TListImpl.Create(TType.I64, TiposEncamOdonto.Count);
    oprot.WriteListBegin( list_20);
    for _iter21 in TiposEncamOdonto do
    begin
  ...
  begin
    ...
    field_.ID := 9;
    oprot.WriteFieldBegin(field_);
    list_22 := TListImpl.Create(TType.I64, TiposFornecimOdonto.Count);
    oprot.WriteListBegin( list_22);
    for _iter23 in TiposFornecimOdonto do
    begin
  ...
  begin
    ...
    field_.ID := 10;
    oprot.WriteFieldBegin(field_);
    list_24 := TListImpl.Create(TType.I64, TiposVigilanciaSaudeBucal.Count);
    oprot.WriteListBegin( list_24);
    for _iter25 in TiposVigilanciaSaudeBucal do
    begin
  ...
  begin
    ...
    field_.ID := 11;
    oprot.WriteFieldBegin(field_);
    list_26 := TListImpl.Create(TType.I64, TiposConsultaOdonto.Count);
    oprot.WriteListBegin( list_26);
    for _iter27 in TiposConsultaOdonto do
    begin
  ...
  begin
    ...
    field_.ID := 12;
    oprot.WriteFieldBegin(field_);
    list_28 := TListImpl.Create(TType.Struct, ProcedimentosRealizados.Count);
    oprot.WriteListBegin( list_28);
    for _iter29 in ProcedimentosRealizados do
    begin
      _iter29.Write(oprot);
    end;
    oprot.WriteListEnd();
  ...
  begin
    ...
    field_.ID := 13;
    oprot.WriteFieldBegin(field_);
    list_30 := TListImpl.Create(TType.Struct, OutrosSiaProcedimentos.Count);
    oprot.WriteListBegin( list_30);
    for _iter31 in OutrosSiaProcedimentos do
    begin
      _iter31.Write(oprot);
    end;
    oprot.WriteListEnd();
...
var
  ...
  _list34: IList;
  _i35: Integer;
  _elem36: IFichaAtendimentoOdontologicoChildThrift;
      ...
      case field_.ID of
        ...
        3: begin
          ...
          begin
            ...
            begin
              _elem36 := TFichaAtendimentoOdontologicoChildThriftImpl.Create;
              _elem36.Read(iprot);
              AtendimentosOdontologicos.Add(_elem36);
            end;
            iprot.ReadListEnd();
          end else
          begin
...
var
  ...
  field_ : IField;
  list_37 : IList;
  _iter38: IFichaAtendimentoOdontologicoChildThrift;
begin
  ...
  begin
    ...
    field_.ID := 3;
    oprot.WriteFieldBegin(field_);
    list_37 := TListImpl.Create(TType.Struct, AtendimentosOdontologicos.Count);
    oprot.WriteListBegin( list_37);
    for _iter38 in AtendimentosOdontologicos do
    begin
      _iter38.Write(oprot);
    end;
    oprot.WriteListEnd();
...
begin
  ...
  try
    ...
    if (AtendimentosOdontologicos <> nil) and __isset_AtendimentosOdontologicos then begin
      _sb39.Append(', AtendimentosOdontologicos: ');
      _sb39.Append(AtendimentosOdontologicos);
    end;
    if (__isset_TpCdsOrigem) then begin
      _sb39.Append(', TpCdsOrigem: ');
      _sb39.Append(TpCdsOrigem);
    end;
    _sb39.Append(')');

...
class FichaAtendimentoDomiciliarChildThrift {
   ...
   * @var bool
   */
  public $statusInicioAcompanhamentoPosObito = null;
  ...
  public function __construct($vals=null) {
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        14 => array(
          'var' => 'statusInicioAcompanhamentoPosObito',
          'type' => TType::BOOL,
          ),
        );
    }
    if (is_array($vals)) {
      ...
      if (isset($vals['statusInicioAcompanhamentoPosObito'])) {
        $this->statusInicioAcompanhamentoPosObito = $vals['statusInicioAcompanhamentoPosObito'];
      }
    }
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 14:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->statusInicioAcompanhamentoPosObito);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->situacoesPresentes !== null) {
      ...
      $xfer += $output->writeFieldBegin('situacoesPresentes', TType::LST, 8);
      {
        $output->writeListBegin(TType::I64, count($this->situacoesPresentes));
        {
          foreach ($this->situacoesPresentes as $iter18)
          {
    ...
    if ($this->statusInicioAcompanhamentoPosObito !== null) {
      $xfer += $output->writeFieldBegin('statusInicioAcompanhamentoPosObito', TType::BOOL, 14);
      $xfer += $output->writeBool($this->statusInicioAcompanhamentoPosObito);
      $xfer += $output->writeFieldEnd();
    }

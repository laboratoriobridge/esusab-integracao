...
class CondicoesDeSaudeThrift {
   ...
   * @var bool
   */
  public $statusTratamentoPsiquicoOuProblemaMentalV2000 = null;
  /**
   * @var bool
   */
  ...
  public function __construct($vals=null) {
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        28 => array(
          'var' => 'statusTratamentoPsiquicoOuProblemaMentalV2000',
          'type' => TType::BOOL,
          ),
        29 => array(
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['statusTratamentoPsiquicoOuProblemaMentalV2000'])) {
        $this->statusTratamentoPsiquicoOuProblemaMentalV2000 = $vals['statusTratamentoPsiquicoOuProblemaMentalV2000'];
      }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 28:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->statusTratamentoPsiquicoOuProblemaMentalV2000);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->statusTratamentoPsiquicoOuProblemaMentalV2000 !== null) {
      $xfer += $output->writeFieldBegin('statusTratamentoPsiquicoOuProblemaMentalV2000', TType::BOOL, 28);
      $xfer += $output->writeBool($this->statusTratamentoPsiquicoOuProblemaMentalV2000);
      $xfer += $output->writeFieldEnd();
    }
...
class IdentificacaoUsuarioCidadaoThrift {
   ...
   * @var int
   */
  public $dataNascimentoResponsavelV2000 = null;
  /**
   * @var bool
   */
  ...
  public function __construct($vals=null) {
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        4 => array(
          'var' => 'dataNascimentoResponsavelV2000',
          'type' => TType::I64,
          ),
        5 => array(
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['dataNascimentoResponsavelV2000'])) {
        $this->dataNascimentoResponsavelV2000 = $vals['dataNascimentoResponsavelV2000'];
      }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 4:
          if ($ftype == TType::I64) {
            $xfer += $input->readI64($this->dataNascimentoResponsavelV2000);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->dataNascimentoResponsavelV2000 !== null) {
      $xfer += $output->writeFieldBegin('dataNascimentoResponsavelV2000', TType::I64, 4);
      $xfer += $output->writeI64($this->dataNascimentoResponsavelV2000);
      $xfer += $output->writeFieldEnd();
    }
...
class InformacoesSocioDemograficasThrift {
   ...
   * @var int
   */
  public $motivoSaidaCidadaoV2000 = null;
  /**
   * @var string
   */
   ...
   * @var int
   */
  public $responsavelPorCriancaV2000 = null;
  /**
   * @var int
   */
  ...
  public function __construct($vals=null) {
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        8 => array(
          'var' => 'responsavelPorCriancaV2000',
          'type' => TType::I64,
          ),
        9 => array(
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['motivoSaidaCidadaoV2000'])) {
        $this->motivoSaidaCidadaoV2000 = $vals['motivoSaidaCidadaoV2000'];
      }
      ...
      if (isset($vals['responsavelPorCriancaV2000'])) {
        $this->responsavelPorCriancaV2000 = $vals['responsavelPorCriancaV2000'];
      }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::I64) {
            $xfer += $input->readI64($this->motivoSaidaCidadaoV2000);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        ...
        case 8:
          if ($ftype == TType::I64) {
            $xfer += $input->readI64($this->responsavelPorCriancaV2000);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->motivoSaidaCidadaoV2000 !== null) {
      $xfer += $output->writeFieldBegin('motivoSaidaCidadaoV2000', TType::I64, 3);
      $xfer += $output->writeI64($this->motivoSaidaCidadaoV2000);
      $xfer += $output->writeFieldEnd();
    }
    ...
    if ($this->responsavelPorCriancaV2000 !== null) {
      $xfer += $output->writeFieldBegin('responsavelPorCriancaV2000', TType::I64, 8);
      $xfer += $output->writeI64($this->responsavelPorCriancaV2000);
      $xfer += $output->writeFieldEnd();
    }
...
class CadastroIndividualThrift {
  ...
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\cadastroindividual\SaidaCidadaoCadastroThrift
   */
  ...
  public function __construct($vals=null) {
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        12 => array(
          ...
          'type' => TType::STRUCT,
          'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\cadastroindividual\SaidaCidadaoCadastroThrift',
          ),
        13 => array(
          'var' => 'headerTransport',
          'type' => TType::STRUCT,
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['dadosGeraisV2000'])) {
        $this->dadosGeraisV2000 = $vals['dadosGeraisV2000'];
      }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->dadosGeraisV2000 = new \br\gov\saude\esus\cds\transport\generated\thrift\common\HeaderCdsCadastroThrift();
            $xfer += $this->dadosGeraisV2000->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        ...
        case 12:
          if ($ftype == TType::STRUCT) {
            $this->saidaCidadaoCadastro = new \br\gov\saude\esus\cds\transport\generated\thrift\cadastroindividual\SaidaCidadaoCadastroThrift();
  ...
  public function write($output) {
    ...
    if ($this->dadosGeraisV2000 !== null) {
      if (!is_object($this->dadosGeraisV2000)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('dadosGeraisV2000', TType::STRUCT, 2);
      $xfer += $this->dadosGeraisV2000->write($output);
      $xfer += $output->writeFieldEnd();
    }

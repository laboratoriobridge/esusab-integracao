...
type
  ...
  IVariasLotacoesHeaderThrift = interface(IBase)
    function GetLotacaoFormPrincipalV2000: IUnicaLotacaoHeaderThrift;
    procedure SetLotacaoFormPrincipalV2000( const Value: IUnicaLotacaoHeaderThrift);
    function GetProfissionalCNS1v2000: string;
    procedure SetProfissionalCNS1v2000( const Value: string);
    function GetCboCodigo_2002_1v2000: string;
    procedure SetCboCodigo_2002_1v2000( const Value: string);
    function GetProfissionalCNS2v2000: string;
    procedure SetProfissionalCNS2v2000( const Value: string);
    function GetCboCodigo_2002_2v2000: string;
    procedure SetCboCodigo_2002_2v2000( const Value: string);
    ...
    property LotacaoFormPrincipalV2000: IUnicaLotacaoHeaderThrift read GetLotacaoFormPrincipalV2000 write SetLotacaoFormPrincipalV2000;
    property ProfissionalCNS1v2000: string read GetProfissionalCNS1v2000 write SetProfissionalCNS1v2000;
    property CboCodigo_2002_1v2000: string read GetCboCodigo_2002_1v2000 write SetCboCodigo_2002_1v2000;
    property ProfissionalCNS2v2000: string read GetProfissionalCNS2v2000 write SetProfissionalCNS2v2000;
    property CboCodigo_2002_2v2000: string read GetCboCodigo_2002_2v2000 write SetCboCodigo_2002_2v2000;
    ...
    function Get__isset_LotacaoFormPrincipalV2000: Boolean;
    function Get__isset_ProfissionalCNS1v2000: Boolean;
    function Get__isset_CboCodigo_2002_1v2000: Boolean;
    function Get__isset_ProfissionalCNS2v2000: Boolean;
    function Get__isset_CboCodigo_2002_2v2000: Boolean;
    function Get__isset_LotacaoFormPrincipal: Boolean;
    function Get__isset_LotacaoFormAtendimentoCompartilhado: Boolean;
    function Get__isset_DataAtendimento: Boolean;
    function Get__isset_CodigoIbgeMunicipio: Boolean;

    property __isset_LotacaoFormPrincipalV2000: Boolean read Get__isset_LotacaoFormPrincipalV2000;
    property __isset_ProfissionalCNS1v2000: Boolean read Get__isset_ProfissionalCNS1v2000;
    property __isset_CboCodigo_2002_1v2000: Boolean read Get__isset_CboCodigo_2002_1v2000;
    property __isset_ProfissionalCNS2v2000: Boolean read Get__isset_ProfissionalCNS2v2000;
    property __isset_CboCodigo_2002_2v2000: Boolean read Get__isset_CboCodigo_2002_2v2000;
  ...
  private
    FLotacaoFormPrincipalV2000: IUnicaLotacaoHeaderThrift;
    FProfissionalCNS1v2000: string;
    FCboCodigo_2002_1v2000: string;
    FProfissionalCNS2v2000: string;
    FCboCodigo_2002_2v2000: string;
    FLotacaoFormPrincipal: ILotacaoHeaderThrift;
    FLotacaoFormAtendimentoCompartilhado: ILotacaoHeaderThrift;
    FDataAtendimento: Int64;
    FCodigoIbgeMunicipio: string;
    
    F__isset_LotacaoFormPrincipalV2000: Boolean;
    F__isset_ProfissionalCNS1v2000: Boolean;
    F__isset_CboCodigo_2002_1v2000: Boolean;
    F__isset_ProfissionalCNS2v2000: Boolean;
    F__isset_CboCodigo_2002_2v2000: Boolean;
...
function TVariasLotacoesHeaderThriftImpl.GetLotacaoFormPrincipalV2000: IUnicaLotacaoHeaderThrift;
begin
  Result := FLotacaoFormPrincipalV2000;
end;

procedure TVariasLotacoesHeaderThriftImpl.SetLotacaoFormPrincipalV2000( const Value: IUnicaLotacaoHeaderThrift);
begin
  F__isset_LotacaoFormPrincipalV2000 := True;
  FLotacaoFormPrincipalV2000 := Value;
end;

function TVariasLotacoesHeaderThriftImpl.Get__isset_LotacaoFormPrincipalV2000: Boolean;
begin
  Result := F__isset_LotacaoFormPrincipalV2000;
end;

function TVariasLotacoesHeaderThriftImpl.GetProfissionalCNS1v2000: string;
begin
  Result := FProfissionalCNS1v2000;
end;

procedure TVariasLotacoesHeaderThriftImpl.SetProfissionalCNS1v2000( const Value: string);
begin
  F__isset_ProfissionalCNS1v2000 := True;
  FProfissionalCNS1v2000 := Value;
end;

function TVariasLotacoesHeaderThriftImpl.Get__isset_ProfissionalCNS1v2000: Boolean;
begin
  Result := F__isset_ProfissionalCNS1v2000;
end;

function TVariasLotacoesHeaderThriftImpl.GetCboCodigo_2002_1v2000: string;
begin
  Result := FCboCodigo_2002_1v2000;
end;

procedure TVariasLotacoesHeaderThriftImpl.SetCboCodigo_2002_1v2000( const Value: string);
begin
  F__isset_CboCodigo_2002_1v2000 := True;
  FCboCodigo_2002_1v2000 := Value;
end;

function TVariasLotacoesHeaderThriftImpl.Get__isset_CboCodigo_2002_1v2000: Boolean;
begin
  Result := F__isset_CboCodigo_2002_1v2000;
end;

function TVariasLotacoesHeaderThriftImpl.GetProfissionalCNS2v2000: string;
begin
  Result := FProfissionalCNS2v2000;
end;

procedure TVariasLotacoesHeaderThriftImpl.SetProfissionalCNS2v2000( const Value: string);
begin
  F__isset_ProfissionalCNS2v2000 := True;
  FProfissionalCNS2v2000 := Value;
end;

function TVariasLotacoesHeaderThriftImpl.Get__isset_ProfissionalCNS2v2000: Boolean;
begin
  Result := F__isset_ProfissionalCNS2v2000;
end;

function TVariasLotacoesHeaderThriftImpl.GetCboCodigo_2002_2v2000: string;
begin
  Result := FCboCodigo_2002_2v2000;
end;

procedure TVariasLotacoesHeaderThriftImpl.SetCboCodigo_2002_2v2000( const Value: string);
begin
  F__isset_CboCodigo_2002_2v2000 := True;
  FCboCodigo_2002_2v2000 := Value;
end;

function TVariasLotacoesHeaderThriftImpl.Get__isset_CboCodigo_2002_2v2000: Boolean;
begin
  Result := F__isset_CboCodigo_2002_2v2000;
end;
    ...
    begin
      ...
      case field_.ID of
        1: begin
          ...
          begin
            LotacaoFormPrincipalV2000 := TUnicaLotacaoHeaderThriftImpl.Create;
...
begin
  ...
  oprot.WriteStructBegin(struc);
  field_ := TFieldImpl.Create;
  if (LotacaoFormPrincipalV2000 <> nil) and __isset_LotacaoFormPrincipalV2000 then
  begin
    field_.Name := 'lotacaoFormPrincipalV2000';
  ...
  if (__isset_ProfissionalCNS1v2000) then
  begin
    field_.Name := 'profissionalCNS1v2000';
    field_.Type_  := TType.String_;
    field_.ID := 2;
    oprot.WriteFieldBegin(field_);
  ...
  if (__isset_CboCodigo_2002_1v2000) then
  begin
    field_.Name := 'cboCodigo_2002_1v2000';
    field_.Type_  := TType.String_;
    field_.ID := 3;
    oprot.WriteFieldBegin(field_);
  ...
  if (__isset_ProfissionalCNS2v2000) then
  begin
    field_.Name := 'profissionalCNS2v2000';
    field_.Type_  := TType.String_;
    field_.ID := 4;
    oprot.WriteFieldBegin(field_);
  ...
  if (__isset_CboCodigo_2002_2v2000) then
  begin
    field_.Name := 'cboCodigo_2002_2v2000';
    field_.Type_  := TType.String_;
    field_.ID := 5;
    oprot.WriteFieldBegin(field_);
...
begin
  ...
  try
    _first7 := TRUE;
    if (LotacaoFormPrincipalV2000 <> nil) and __isset_LotacaoFormPrincipalV2000 then begin
      if not _first7 then _sb6.Append(',');
      _first7 := FALSE;
      _sb6.Append('LotacaoFormPrincipalV2000: ');
      if (LotacaoFormPrincipalV2000 = nil) then _sb6.Append('<null>') else _sb6.Append(LotacaoFormPrincipalV2000.ToString());
    end;
    if (__isset_ProfissionalCNS1v2000) then begin
      if not _first7 then _sb6.Append(',');
      _first7 := FALSE;
      _sb6.Append('ProfissionalCNS1v2000: ');
      _sb6.Append(ProfissionalCNS1v2000);
    end;
    if (__isset_CboCodigo_2002_1v2000) then begin
      if not _first7 then _sb6.Append(',');
      _first7 := FALSE;
      _sb6.Append('CboCodigo_2002_1v2000: ');
      _sb6.Append(CboCodigo_2002_1v2000);
    end;
    if (__isset_ProfissionalCNS2v2000) then begin
      if not _first7 then _sb6.Append(',');
      _first7 := FALSE;
      _sb6.Append('ProfissionalCNS2v2000: ');
      _sb6.Append(ProfissionalCNS2v2000);
    end;
    if (__isset_CboCodigo_2002_2v2000) then begin
      if not _first7 then _sb6.Append(',');
      _first7 := FALSE;
      _sb6.Append('CboCodigo_2002_2v2000: ');
      _sb6.Append(CboCodigo_2002_2v2000);
    end;
...
begin
  ...
  try
    ...
    if (__isset_Latitude) then begin
      if not _first9 then _sb8.Append(',');
      _first9 := FALSE;
      _sb8.Append('Latitude: ');
      _sb8.Append(Latitude);
    end;
    if (__isset_Longitude) then begin
      if not _first9 then _sb8.Append(',');
      _first9 := FALSE;
      _sb8.Append('Longitude: ');
      _sb8.Append(Longitude);
    end;
    _sb8.Append(')');

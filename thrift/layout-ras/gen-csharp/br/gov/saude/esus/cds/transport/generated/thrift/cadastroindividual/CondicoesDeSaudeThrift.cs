...
namespace br.gov.saude.esus.cds.transport.generated.thrift.cadastroindividual
{
  ...
  public partial class CondicoesDeSaudeThrift : TBase
  {
    ...
    private bool _statusTratamentoPsiquicoOuProblemaMental;
    ...
    public bool StatusTratamentoPsiquicoOuProblemaMental
    {
      get
      {
        return _statusTratamentoPsiquicoOuProblemaMental;
      }
      set
      {
        __isset.statusTratamentoPsiquicoOuProblemaMental = true;
        this._statusTratamentoPsiquicoOuProblemaMental = value;
      }
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      if (__isset.statusTratamentoPsiquicoOuProblemaMental) {
        field.Name = "statusTratamentoPsiquicoOuProblemaMental";
        field.Type = TType.Bool;
        field.ID = 28;
        oprot.WriteFieldBegin(field);
    ...
    public override string ToString() {
      ...
      if (__isset.statusTratamentoPsiquicoOuProblemaMental) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("StatusTratamentoPsiquicoOuProblemaMental: ");
        __sb.Append(StatusTratamentoPsiquicoOuProblemaMental);
      }
      if (__isset.statusUsaOutrasPraticasIntegrativasOuComplementares) {
        if(!__first) { __sb.Append(", "); }

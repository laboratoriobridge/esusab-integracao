...
class CadastroDomiciliarThrift:
  ...
  thrift_spec = (
    ...
    (3, TType.STRUCT, 'dadosGeraisV2000', (common.ttypes.HeaderCdsCadastroThrift, common.ttypes.HeaderCdsCadastroThrift.thrift_spec), None, ), # 3
    (4, TType.STRUCT, 'enderecoLocalPermanencia', (common.ttypes.EnderecoLocalPermanenciaThrift, common.ttypes.EnderecoLocalPermanenciaThrift.thrift_spec), None, ), # 4
    ...
    (15, TType.STRUCT, 'headerTransport', (common.ttypes.UnicaLotacaoHeaderThrift, common.ttypes.UnicaLotacaoHeaderThrift.thrift_spec), None, ), # 15
    (16, TType.BOOL, 'statusGeradoAutomaticamente', None, None, ), # 16
  )

  def __init__(self, animaisNoDomicilio=None, condicaoMoradia=None, dadosGeraisV2000=None, enderecoLocalPermanencia=None, familias=None, fichaAtualizada=None, quantosAnimaisNoDomicilio=None, stAnimaisNoDomicilio=None, statusTermoRecusa=None, tpCdsOrigem=None, uuid=None, uuidFichaOriginadora=None, tipoDeImovel=None, instituicaoPermanencia=None, headerTransport=None, statusGeradoAutomaticamente=None,):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.enderecoLocalPermanencia = common.ttypes.EnderecoLocalPermanenciaThrift()
  ...
  def write(self, oprot):
    ...
    if self.dadosGeraisV2000 is not None:
      oprot.writeFieldBegin('dadosGeraisV2000', TType.STRUCT, 3)

...
type
  ...
  IFichaAtendimentoDomiciliarChildThrift = interface(IBase)
    ...
    function GetOutrosProcedimentosV321: IThriftList<string>;
    procedure SetOutrosProcedimentosV321( const Value: IThriftList<string>);
    function GetCondutaDesfecho: Int64;
    procedure SetCondutaDesfecho( const Value: Int64);
    function GetStatusInicioAcompanhamentoPosObitoV200: Boolean;
    procedure SetStatusInicioAcompanhamentoPosObitoV200( const Value: Boolean);
    ...
    property OutrosProcedimentosV321: IThriftList<string> read GetOutrosProcedimentosV321 write SetOutrosProcedimentosV321;
    property CondutaDesfecho: Int64 read GetCondutaDesfecho write SetCondutaDesfecho;
    property StatusInicioAcompanhamentoPosObitoV200: Boolean read GetStatusInicioAcompanhamentoPosObitoV200 write SetStatusInicioAcompanhamentoPosObitoV200;
    ...
    function Get__isset_OutrosProcedimentosV321: Boolean;
    function Get__isset_CondutaDesfecho: Boolean;
    function Get__isset_StatusInicioAcompanhamentoPosObitoV200: Boolean;
    ...
    property __isset_OutrosProcedimentosV321: Boolean read Get__isset_OutrosProcedimentosV321;
    property __isset_CondutaDesfecho: Boolean read Get__isset_CondutaDesfecho;
    property __isset_StatusInicioAcompanhamentoPosObitoV200: Boolean read Get__isset_StatusInicioAcompanhamentoPosObitoV200;
  ...
  private
    ...
    FOutrosProcedimentosV321: IThriftList<string>;
    FCondutaDesfecho: Int64;
    FStatusInicioAcompanhamentoPosObitoV200: Boolean;
    FCpfCidadao: string;
    ...
    F__isset_OutrosProcedimentosV321: Boolean;
    F__isset_CondutaDesfecho: Boolean;
    F__isset_StatusInicioAcompanhamentoPosObitoV200: Boolean;
...
function TFichaAtendimentoDomiciliarChildThriftImpl.GetOutrosProcedimentosV321: IThriftList<string>;
begin
  Result := FOutrosProcedimentosV321;
end;

procedure TFichaAtendimentoDomiciliarChildThriftImpl.SetOutrosProcedimentosV321( const Value: IThriftList<string>);
begin
  F__isset_OutrosProcedimentosV321 := True;
  FOutrosProcedimentosV321 := Value;
end;

function TFichaAtendimentoDomiciliarChildThriftImpl.Get__isset_OutrosProcedimentosV321: Boolean;
begin
  Result := F__isset_OutrosProcedimentosV321;
end;
...
function TFichaAtendimentoDomiciliarChildThriftImpl.GetStatusInicioAcompanhamentoPosObitoV200: Boolean;
begin
  Result := FStatusInicioAcompanhamentoPosObitoV200;
end;

procedure TFichaAtendimentoDomiciliarChildThriftImpl.SetStatusInicioAcompanhamentoPosObitoV200( const Value: Boolean);
begin
  F__isset_StatusInicioAcompanhamentoPosObitoV200 := True;
  FStatusInicioAcompanhamentoPosObitoV200 := Value;
end;

function TFichaAtendimentoDomiciliarChildThriftImpl.Get__isset_StatusInicioAcompanhamentoPosObitoV200: Boolean;
begin
  Result := F__isset_StatusInicioAcompanhamentoPosObitoV200;
end;
    ...
    begin
      ...
      case field_.ID of
        ...
        12: begin
          if (field_.Type_ = TType.List) then
          begin
            OutrosProcedimentosV321 := TThriftListImpl<string>.Create;
            _list6 := iprot.ReadListBegin();
            for _i7 := 0 to _list6.Count - 1 do
            begin
              _elem8 := iprot.ReadString();
              OutrosProcedimentosV321.Add(_elem8);
            end;
            iprot.ReadListEnd();
          end else
          begin
        ...
        14: begin
          ...
          begin
            StatusInicioAcompanhamentoPosObitoV200 := iprot.ReadBool();
          end else
          begin
            TProtocolUtil.Skip(iprot, field_.Type_);
          end;
...
begin
  ...
  if (OutrosProcedimentosV321 <> nil) and __isset_OutrosProcedimentosV321 then
  begin
    field_.Name := 'outrosProcedimentosV321';
    field_.Type_  := TType.List;
    field_.ID := 12;
    oprot.WriteFieldBegin(field_);
    list_13 := TListImpl.Create(TType.String_, OutrosProcedimentosV321.Count);
    oprot.WriteListBegin( list_13);
    for _iter14 in OutrosProcedimentosV321 do
    begin
  ...
  if (__isset_StatusInicioAcompanhamentoPosObitoV200) then
  begin
    field_.Name := 'statusInicioAcompanhamentoPosObitoV200';
    field_.Type_  := TType.Bool_;
    field_.ID := 14;
    oprot.WriteFieldBegin(field_);
    oprot.WriteBool(StatusInicioAcompanhamentoPosObitoV200);
    oprot.WriteFieldEnd();
  end;
...
begin
  ...
  try
    ...
    if (OutrosProcedimentosV321 <> nil) and __isset_OutrosProcedimentosV321 then begin
      if not _first16 then _sb15.Append(',');
      _first16 := FALSE;
      _sb15.Append('OutrosProcedimentosV321: ');
      _sb15.Append(OutrosProcedimentosV321);
    end;
    ...
    if (__isset_StatusInicioAcompanhamentoPosObitoV200) then begin
      if not _first16 then _sb15.Append(',');
      _first16 := FALSE;
      _sb15.Append('StatusInicioAcompanhamentoPosObitoV200: ');
      _sb15.Append(StatusInicioAcompanhamentoPosObitoV200);
    end;
...
function TFichaAtendimentoDomiciliarMasterThriftImpl.GetHeaderTransportV200: IUnicaLotacaoHeaderThrift;
begin
  Result := FHeaderTransportV200;
end;

procedure TFichaAtendimentoDomiciliarMasterThriftImpl.SetHeaderTransportV200( const Value: IUnicaLotacaoHeaderThrift);
begin
  F__isset_HeaderTransportV200 := True;
  FHeaderTransportV200 := Value;
end;

function TFichaAtendimentoDomiciliarMasterThriftImpl.Get__isset_HeaderTransportV200: Boolean;
begin
...
begin
  ...
  try
    ...
    if (HeaderTransportV200 <> nil) and __isset_HeaderTransportV200 then begin
      _sb22.Append(', HeaderTransportV200: ');
      if (HeaderTransportV200 = nil) then _sb22.Append('<null>') else _sb22.Append(HeaderTransportV200.ToString());
    end;

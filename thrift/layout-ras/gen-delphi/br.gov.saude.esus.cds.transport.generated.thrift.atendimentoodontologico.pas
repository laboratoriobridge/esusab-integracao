...
type
  ...
  IFichaAtendimentoOdontologicoChildThrift = interface(IBase)
    ...
    function GetOutrosSiaProcedimentosV321: IThriftList<IProcedimentoQuantidadeThrift>;
    procedure SetOutrosSiaProcedimentosV321( const Value: IThriftList<IProcedimentoQuantidadeThrift>);
    ...
    function GetResultadosExames: IThriftList<IResultadoExameThrift>;
    procedure SetResultadosExames( const Value: IThriftList<IResultadoExameThrift>);
    ...
    property OutrosSiaProcedimentosV321: IThriftList<IProcedimentoQuantidadeThrift> read GetOutrosSiaProcedimentosV321 write SetOutrosSiaProcedimentosV321;
    ...
    property ResultadosExames: IThriftList<IResultadoExameThrift> read GetResultadosExames write SetResultadosExames;
    ...
    function Get__isset_OutrosSiaProcedimentosV321: Boolean;
    ...
    property __isset_OutrosSiaProcedimentosV321: Boolean read Get__isset_OutrosSiaProcedimentosV321;
  ...
  private
    ...
    FOutrosSiaProcedimentosV321: IThriftList<IProcedimentoQuantidadeThrift>;
    FSexo: Int64;
    FTurno: Int64;
    ...
    FResultadosExames: IThriftList<IResultadoExameThrift>;
    ...
    F__isset_OutrosSiaProcedimentosV321: Boolean;
...
function TFichaAtendimentoOdontologicoChildThriftImpl.GetOutrosSiaProcedimentosV321: IThriftList<IProcedimentoQuantidadeThrift>;
begin
  Result := FOutrosSiaProcedimentosV321;
end;

procedure TFichaAtendimentoOdontologicoChildThriftImpl.SetOutrosSiaProcedimentosV321( const Value: IThriftList<IProcedimentoQuantidadeThrift>);
begin
  F__isset_OutrosSiaProcedimentosV321 := True;
  FOutrosSiaProcedimentosV321 := Value;
end;

function TFichaAtendimentoOdontologicoChildThriftImpl.Get__isset_OutrosSiaProcedimentosV321: Boolean;
begin
  Result := F__isset_OutrosSiaProcedimentosV321;
end;
...
function TFichaAtendimentoOdontologicoChildThriftImpl.GetResultadosExames: IThriftList<IResultadoExameThrift>;
begin
  Result := FResultadosExames;
end;

procedure TFichaAtendimentoOdontologicoChildThriftImpl.SetResultadosExames( const Value: IThriftList<IResultadoExameThrift>);
begin
...
var
  ...
  _list20: IList;
  _i21: Integer;
  _elem22: IMedicamentoThrift;
  _list23: IList;
  _i24: Integer;
  _elem25: IEncaminhamentoExternoThrift;
  _list26: IList;
  _i27: Integer;
  _elem28: IResultadoExameThrift;
    ...
    begin
      ...
      case field_.ID of
        ...
        13: begin
          if (field_.Type_ = TType.List) then
          begin
            OutrosSiaProcedimentosV321 := TThriftListImpl<IProcedimentoQuantidadeThrift>.Create;
            _list17 := iprot.ReadListBegin();
            for _i18 := 0 to _list17.Count - 1 do
            begin
              _elem19 := TProcedimentoQuantidadeThriftImpl.Create;
              _elem19.Read(iprot);
              OutrosSiaProcedimentosV321.Add(_elem19);
            end;
            iprot.ReadListEnd();
          end else
          begin
        ...
        19: begin
          ...
          begin
            ...
            begin
              _elem22 := TMedicamentoThriftImpl.Create;
              _elem22.Read(iprot);
              Medicamentos.Add(_elem22);
            end;
            iprot.ReadListEnd();
          end else
          begin
        ...
        20: begin
          ...
          begin
            ...
            begin
              _elem25 := TEncaminhamentoExternoThriftImpl.Create;
              _elem25.Read(iprot);
              Encaminhamentos.Add(_elem25);
            end;
            iprot.ReadListEnd();
          end else
          begin
        ...
        21: begin
          if (field_.Type_ = TType.List) then
          begin
            ResultadosExames := TThriftListImpl<IResultadoExameThrift>.Create;
            _list26 := iprot.ReadListBegin();
            for _i27 := 0 to _list26.Count - 1 do
            begin
              _elem28 := TResultadoExameThriftImpl.Create;
              _elem28.Read(iprot);
              ResultadosExames.Add(_elem28);
            end;
            iprot.ReadListEnd();
          end else
          begin
...
var
  ...
  list_39 : IList;
  _iter40: IProcedimentoQuantidadeThrift;
  list_41 : IList;
  _iter42: IMedicamentoThrift;
  list_43 : IList;
  _iter44: IEncaminhamentoExternoThrift;
  list_45 : IList;
  _iter46: IResultadoExameThrift;
begin
  tracker := oprot.NextRecursionLevel;
  ...
  if (OutrosSiaProcedimentosV321 <> nil) and __isset_OutrosSiaProcedimentosV321 then
  begin
    field_.Name := 'outrosSiaProcedimentosV321';
    field_.Type_  := TType.List;
    field_.ID := 13;
    oprot.WriteFieldBegin(field_);
    list_39 := TListImpl.Create(TType.Struct, OutrosSiaProcedimentosV321.Count);
    oprot.WriteListBegin( list_39);
    for _iter40 in OutrosSiaProcedimentosV321 do
    begin
      _iter40.Write(oprot);
    end;
    oprot.WriteListEnd();
...
begin
  ...
  try
    ...
    if (OutrosSiaProcedimentosV321 <> nil) and __isset_OutrosSiaProcedimentosV321 then begin
      if not _first48 then _sb47.Append(',');
      _first48 := FALSE;
      _sb47.Append('OutrosSiaProcedimentosV321: ');
      _sb47.Append(OutrosSiaProcedimentosV321);
    end;

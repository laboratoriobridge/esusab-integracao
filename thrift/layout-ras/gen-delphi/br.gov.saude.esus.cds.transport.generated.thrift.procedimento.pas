...
function TFichaProcedimentoChildThriftImpl.GetNumCartaoSus: string;
begin
  Result := FNumCartaoSus;
end;

procedure TFichaProcedimentoChildThriftImpl.SetNumCartaoSus( const Value: string);
begin
  F__isset_NumCartaoSus := True;
  FNumCartaoSus := Value;
end;

function TFichaProcedimentoChildThriftImpl.Get__isset_NumCartaoSus: Boolean;
begin

...
type FichaAtendimentoDomiciliarChildThrift struct {
  ...
  OutrosProcedimentosV321 []string `thrift:"outrosProcedimentosV321,12" json:"outrosProcedimentosV321,omitempty"`
  CondutaDesfecho *int64 `thrift:"condutaDesfecho,13" json:"condutaDesfecho,omitempty"`
  StatusInicioAcompanhamentoPosObitoV200 *bool `thrift:"statusInicioAcompanhamentoPosObitoV200,14" json:"statusInicioAcompanhamentoPosObitoV200,omitempty"`
...
var FichaAtendimentoDomiciliarChildThrift_OutrosProcedimentosV321_DEFAULT []string

func (p *FichaAtendimentoDomiciliarChildThrift) GetOutrosProcedimentosV321() []string {
  return p.OutrosProcedimentosV321
}
...
var FichaAtendimentoDomiciliarChildThrift_StatusInicioAcompanhamentoPosObitoV200_DEFAULT bool
func (p *FichaAtendimentoDomiciliarChildThrift) GetStatusInicioAcompanhamentoPosObitoV200() bool {
  if !p.IsSetStatusInicioAcompanhamentoPosObitoV200() {
    return FichaAtendimentoDomiciliarChildThrift_StatusInicioAcompanhamentoPosObitoV200_DEFAULT
  }
return *p.StatusInicioAcompanhamentoPosObitoV200
}
...
func (p *FichaAtendimentoDomiciliarChildThrift) IsSetOutrosProcedimentosV321() bool {
  return p.OutrosProcedimentosV321 != nil
}
...
func (p *FichaAtendimentoDomiciliarChildThrift) IsSetStatusInicioAcompanhamentoPosObitoV200() bool {
  return p.StatusInicioAcompanhamentoPosObitoV200 != nil
}
...
func (p *FichaAtendimentoDomiciliarChildThrift)  readField12(iprot thrift.TProtocol) error {
  ...
  tSlice := make([]string, 0, size)
  p.OutrosProcedimentosV321 =  tSlice
  for i := 0; i < size; i ++ {
var _elem2 string
    if v, err := iprot.ReadString(); err != nil {
    return thrift.PrependError("error reading field 0: ", err)
    ...
    p.OutrosProcedimentosV321 = append(p.OutrosProcedimentosV321, _elem2)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *FichaAtendimentoDomiciliarChildThrift)  readField14(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadBool(); err != nil {
  return thrift.PrependError("error reading field 14: ", err)
} else {
  p.StatusInicioAcompanhamentoPosObitoV200 = &v
}
  return nil
}
...
func (p *FichaAtendimentoDomiciliarChildThrift) writeField12(oprot thrift.TProtocol) (err error) {
  if p.IsSetOutrosProcedimentosV321() {
    if err := oprot.WriteFieldBegin("outrosProcedimentosV321", thrift.LIST, 12); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 12:outrosProcedimentosV321: ", p), err) }
    if err := oprot.WriteListBegin(thrift.STRING, len(p.OutrosProcedimentosV321)); err != nil {
      return thrift.PrependError("error writing list begin: ", err)
    }
    for _, v := range p.OutrosProcedimentosV321 {
      if err := oprot.WriteString(string(v)); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T. (0) field write error: ", p), err) }
    }
    if err := oprot.WriteListEnd(); err != nil {
    ...
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 12:outrosProcedimentosV321: ", p), err) }
  }
  return err
}
...
func (p *FichaAtendimentoDomiciliarChildThrift) writeField14(oprot thrift.TProtocol) (err error) {
  if p.IsSetStatusInicioAcompanhamentoPosObitoV200() {
    if err := oprot.WriteFieldBegin("statusInicioAcompanhamentoPosObitoV200", thrift.BOOL, 14); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 14:statusInicioAcompanhamentoPosObitoV200: ", p), err) }
    if err := oprot.WriteBool(bool(*p.StatusInicioAcompanhamentoPosObitoV200)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T.statusInicioAcompanhamentoPosObitoV200 (14) field write error: ", p), err) }
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 14:statusInicioAcompanhamentoPosObitoV200: ", p), err) }
  }
  return err
}
...
var FichaAtendimentoDomiciliarMasterThrift_HeaderTransportV200_DEFAULT *common.UnicaLotacaoHeaderThrift
func (p *FichaAtendimentoDomiciliarMasterThrift) GetHeaderTransportV200() *common.UnicaLotacaoHeaderThrift {
  if !p.IsSetHeaderTransportV200() {
    return FichaAtendimentoDomiciliarMasterThrift_HeaderTransportV200_DEFAULT
  }
...
func (p *FichaAtendimentoDomiciliarMasterThrift) IsSetHeaderTransportV200() bool {
...
func (p *FichaAtendimentoDomiciliarMasterThrift)  readField3(iprot thrift.TProtocol) error {
...
func (p *FichaAtendimentoDomiciliarMasterThrift) writeField3(oprot thrift.TProtocol) (err error) {
  if p.IsSetHeaderTransportV200() {

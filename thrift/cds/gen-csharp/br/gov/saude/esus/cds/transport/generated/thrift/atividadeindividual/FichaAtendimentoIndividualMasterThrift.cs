...
namespace br.gov.saude.esus.cds.transport.generated.thrift.atividadeindividual
{
  ...
  public partial class FichaAtendimentoIndividualMasterThrift : TBase
  {
    ...
    public br.gov.saude.esus.cds.transport.generated.thrift.common.VariasLotacoesHeaderThrift HeaderTransport { get; set; }
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  FichaAtendimentoIndividualChildThrift _elem30;
                  _elem30 = new FichaAtendimentoIndividualChildThrift();
                  _elem30.Read(iprot);
                  AtendimentosIndividuais.Add(_elem30);
                }
                iprot.ReadListEnd();
              }
            } else { 

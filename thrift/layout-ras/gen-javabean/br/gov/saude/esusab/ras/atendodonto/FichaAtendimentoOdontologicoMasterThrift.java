            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.atendimentosOdontologicos = new ArrayList<FichaAtendimentoOdontologicoChildThrift>(_list80.size);
                FichaAtendimentoOdontologicoChildThrift _elem81;
                for (int _i82 = 0; _i82 < _list80.size; ++_i82)
                {
                  _elem81 = new FichaAtendimentoOdontologicoChildThrift();
                  _elem81.read(iprot);
                  struct.atendimentosOdontologicos.add(_elem81);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.atendimentosOdontologicos != null) {
        if (struct.isSetAtendimentosOdontologicos()) {
          oprot.writeFieldBegin(ATENDIMENTOS_ODONTOLOGICOS_FIELD_DESC);
          {
            ...
            for (FichaAtendimentoOdontologicoChildThrift _iter83 : struct.atendimentosOdontologicos)
            {
              _iter83.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetAtendimentosOdontologicos()) {
        {
          ...
          for (FichaAtendimentoOdontologicoChildThrift _iter84 : struct.atendimentosOdontologicos)
          {
            _iter84.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.atendimentosOdontologicos = new ArrayList<FichaAtendimentoOdontologicoChildThrift>(_list85.size);
          FichaAtendimentoOdontologicoChildThrift _elem86;
          for (int _i87 = 0; _i87 < _list85.size; ++_i87)
          {
            _elem86 = new FichaAtendimentoOdontologicoChildThrift();
            _elem86.read(iprot);
            struct.atendimentosOdontologicos.add(_elem86);
          }
        }
        struct.setAtendimentosOdontologicosIsSet(true);
      }

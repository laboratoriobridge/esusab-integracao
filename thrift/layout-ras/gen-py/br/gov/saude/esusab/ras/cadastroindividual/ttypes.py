...
class InformacoesSocioEconomicasThrift:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.BOOL, 'alimentosAcabaramAntesTerDinheiroComprarMais', None, None, ), # 1
    (2, TType.BOOL, 'comeuAlgunsAlimentosQueTinhaDinheiroAcabou', None, None, ), # 2
  )

  def __init__(self, alimentosAcabaramAntesTerDinheiroComprarMais=None, comeuAlgunsAlimentosQueTinhaDinheiroAcabou=None,):
    self.alimentosAcabaramAntesTerDinheiroComprarMais = alimentosAcabaramAntesTerDinheiroComprarMais
    self.comeuAlgunsAlimentosQueTinhaDinheiroAcabou = comeuAlgunsAlimentosQueTinhaDinheiroAcabou
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.BOOL:
          self.alimentosAcabaramAntesTerDinheiroComprarMais = iprot.readBool()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.BOOL:
          self.comeuAlgunsAlimentosQueTinhaDinheiroAcabou = iprot.readBool()
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('InformacoesSocioEconomicasThrift')
    if self.alimentosAcabaramAntesTerDinheiroComprarMais is not None:
      oprot.writeFieldBegin('alimentosAcabaramAntesTerDinheiroComprarMais', TType.BOOL, 1)
      oprot.writeBool(self.alimentosAcabaramAntesTerDinheiroComprarMais)
      oprot.writeFieldEnd()
    if self.comeuAlgunsAlimentosQueTinhaDinheiroAcabou is not None:
      oprot.writeFieldBegin('comeuAlgunsAlimentosQueTinhaDinheiroAcabou', TType.BOOL, 2)
      oprot.writeBool(self.comeuAlgunsAlimentosQueTinhaDinheiroAcabou)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.alimentosAcabaramAntesTerDinheiroComprarMais)
    value = (value * 31) ^ hash(self.comeuAlgunsAlimentosQueTinhaDinheiroAcabou)
    return value
...
class CadastroIndividualThrift:
  ...
  thrift_spec = (
    ...
    None, # 14
    None, # 15
    (16, TType.STRUCT, 'informacoesSocioEconomicas', (InformacoesSocioEconomicasThrift, InformacoesSocioEconomicasThrift.thrift_spec), None, ), # 16
  )

  def __init__(self, condicoesDeSaude=None, emSituacaoDeRua=None, fichaAtualizada=None, identificacaoUsuarioCidadao=None, informacoesSocioDemograficas=None, statusTermoRecusaCadastroIndividualAtencaoBasica=None, tpCdsOrigem=None, uuid=None, uuidFichaOriginadora=None, saidaCidadaoCadastro=None, headerTransport=None, informacoesSocioEconomicas=None,):
    ...
    self.informacoesSocioEconomicas = informacoesSocioEconomicas
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.informacoesSocioEconomicas = InformacoesSocioEconomicasThrift()
          self.informacoesSocioEconomicas.read(iprot)
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.headerTransport is not None:
      ...
      oprot.writeFieldEnd()
    if self.informacoesSocioEconomicas is not None:
      oprot.writeFieldBegin('informacoesSocioEconomicas', TType.STRUCT, 16)
      self.informacoesSocioEconomicas.write(oprot)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.informacoesSocioEconomicas)
    return value

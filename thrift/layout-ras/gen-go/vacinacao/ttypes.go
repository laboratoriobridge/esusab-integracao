...
type VacinaRowThrift struct {
  ...
  StRegistroAnterior *bool `thrift:"stRegistroAnterior,6" json:"stRegistroAnterior,omitempty"`
  DataRegistroAnterior *int64 `thrift:"dataRegistroAnterior,7" json:"dataRegistroAnterior,omitempty"`
}
...
func (p *VacinaRowThrift) writeField6(oprot thrift.TProtocol) (err error) {
  if p.IsSetStRegistroAnterior() {
    if err := oprot.WriteFieldBegin("stRegistroAnterior", thrift.BOOL, 6); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:stRegistroAnterior: ", p), err) }
    if err := oprot.WriteBool(bool(*p.StRegistroAnterior)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T.stRegistroAnterior (6) field write error: ", p), err) }
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 6:stRegistroAnterior: ", p), err) }
  }
  return err
}
...
func (p *VacinaRowThrift) writeField7(oprot thrift.TProtocol) (err error) {
  if p.IsSetDataRegistroAnterior() {
    if err := oprot.WriteFieldBegin("dataRegistroAnterior", thrift.I64, 7); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 7:dataRegistroAnterior: ", p), err) }
    if err := oprot.WriteI64(int64(*p.DataRegistroAnterior)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T.dataRegistroAnterior (7) field write error: ", p), err) }
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 7:dataRegistroAnterior: ", p), err) }
  }
  return err
}

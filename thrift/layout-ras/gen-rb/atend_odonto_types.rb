      ...
      module Esus
        module Cds
          module Transport
            module Generated
              module Thrift
                module Atendimentoodontologico
                  ...
                  class FichaAtendimentoOdontologicoChildThrift
                    ...
                    FIELDS = {
                      ...
                      PROCEDIMENTOSREALIZADOS => {:type => ::Thrift::Types::LIST, :name => 'procedimentosRealizados', :element => {:type => ::Thrift::Types::STRUCT, :class => ::Br::Gov::Saude::Esus::Cds::Transport::Generated::Thrift::Atendimentoodontologico::ProcedimentoQuantidadeThrift}, :optional => true},
                      OUTROSSIAPROCEDIMENTOSV321 => {:type => ::Thrift::Types::LIST, :name => 'outrosSiaProcedimentosV321', :element => {:type => ::Thrift::Types::STRUCT, :class => ::Br::Gov::Saude::Esus::Cds::Transport::Generated::Thrift::Atendimentoodontologico::ProcedimentoQuantidadeThrift}, :optional => true},
                      ...
                      RESULTADOSEXAMES => {:type => ::Thrift::Types::LIST, :name => 'resultadosExames', :element => {:type => ::Thrift::Types::STRUCT, :class => ::Br::Gov::Saude::Esus::Cds::Transport::Generated::Thrift::Common::ResultadoExameThrift}, :optional => true}
                    }
                  ...
                  class FichaAtendimentoOdontologicoMasterThrift
                    ...
                    FIELDS = {
                      ...
                      ATENDIMENTOSODONTOLOGICOS => {:type => ::Thrift::Types::LIST, :name => 'atendimentosOdontologicos', :element => {:type => ::Thrift::Types::STRUCT, :class => ::Br::Gov::Saude::Esus::Cds::Transport::Generated::Thrift::Atendimentoodontologico::FichaAtendimentoOdontologicoChildThrift}, :optional => true},

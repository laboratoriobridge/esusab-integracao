 ...
 *  @generated
 */
package br.gov.saude.esusab.dadotransp;
...
public class DadoInstalacaoThrift implements org.apache.thrift.TBase<DadoInstalacaoThrift, DadoInstalacaoThrift._Fields>, java.io.Serializable, Cloneable, Comparable<DadoInstalacaoThrift> {
  ...
  private static final org.apache.thrift.protocol.TField VERSAO_SISTEMA_FIELD_DESC = new org.apache.thrift.protocol.TField("versaoSistema", org.apache.thrift.protocol.TType.STRING, (short)7);
  private static final org.apache.thrift.protocol.TField NOME_BANCO_DADOS_FIELD_DESC = new org.apache.thrift.protocol.TField("nomeBancoDados", org.apache.thrift.protocol.TType.STRING, (short)8);
  ...
  private String versaoSistema; // optional
  private String nomeBancoDados; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * Versão do software
     */
    VERSAO_SISTEMA((short)7, "versaoSistema"),
    /**
     * Nome do banco de dados que o software utiliza
     */
    NOME_BANCO_DADOS((short)8, "nomeBancoDados");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 6: // EMAIL
          return EMAIL;
        case 7: // VERSAO_SISTEMA
          return VERSAO_SISTEMA;
        case 8: // NOME_BANCO_DADOS
  ...
  private static final _Fields optionals[] = {_Fields.UUID_INSTALACAO,_Fields.FONE,_Fields.EMAIL,_Fields.VERSAO_SISTEMA,_Fields.NOME_BANCO_DADOS};
  ...
  static {
    ...
    tmpMap.put(_Fields.EMAIL, new org.apache.thrift.meta_data.FieldMetaData("email", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.VERSAO_SISTEMA, new org.apache.thrift.meta_data.FieldMetaData("versaoSistema", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.NOME_BANCO_DADOS, new org.apache.thrift.meta_data.FieldMetaData("nomeBancoDados", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public DadoInstalacaoThrift(DadoInstalacaoThrift other) {
    ...
    if (other.isSetVersaoSistema()) {
      this.versaoSistema = other.versaoSistema;
    }
    if (other.isSetNomeBancoDados()) {
      this.nomeBancoDados = other.nomeBancoDados;
    }
  }
  ...
  public void unsetVersaoSistema() {
    this.versaoSistema = null;
  }

  /** Returns true if field versaoSistema is set (has been assigned a value) and false otherwise */
  public boolean isSetVersaoSistema() {
    return this.versaoSistema != null;
  }

  public void setVersaoSistemaIsSet(boolean value) {
    if (!value) {
      this.versaoSistema = null;
    }
  }
  ...
  public void unsetNomeBancoDados() {
    this.nomeBancoDados = null;
  }

  /** Returns true if field nomeBancoDados is set (has been assigned a value) and false otherwise */
  public boolean isSetNomeBancoDados() {
    return this.nomeBancoDados != null;
  }

  public void setNomeBancoDadosIsSet(boolean value) {
    if (!value) {
      this.nomeBancoDados = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case VERSAO_SISTEMA:
      if (value == null) {
        ...
        setVersaoSistema((String)value);
      }
      break;

    case NOME_BANCO_DADOS:
      if (value == null) {
        unsetNomeBancoDados();
      } else {
        setNomeBancoDados((String)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case VERSAO_SISTEMA:
      return getVersaoSistema();

    case NOME_BANCO_DADOS:
      return getNomeBancoDados();
  ...
  public boolean isSet(_Fields field) {
    ...
    case EMAIL:
      return isSetEmail();
    case VERSAO_SISTEMA:
      return isSetVersaoSistema();
    case NOME_BANCO_DADOS:
      return isSetNomeBancoDados();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(DadoInstalacaoThrift that) {
    ...
    boolean this_present_versaoSistema = true && this.isSetVersaoSistema();
    boolean that_present_versaoSistema = true && that.isSetVersaoSistema();
    if (this_present_versaoSistema || that_present_versaoSistema) {
      if (!(this_present_versaoSistema && that_present_versaoSistema))
        return false;
      if (!this.versaoSistema.equals(that.versaoSistema))
        return false;
    }

    boolean this_present_nomeBancoDados = true && this.isSetNomeBancoDados();
    boolean that_present_nomeBancoDados = true && that.isSetNomeBancoDados();
    if (this_present_nomeBancoDados || that_present_nomeBancoDados) {
      if (!(this_present_nomeBancoDados && that_present_nomeBancoDados))
        return false;
      if (!this.nomeBancoDados.equals(that.nomeBancoDados))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_versaoSistema = true && (isSetVersaoSistema());
    list.add(present_versaoSistema);
    if (present_versaoSistema)
      list.add(versaoSistema);

    boolean present_nomeBancoDados = true && (isSetNomeBancoDados());
    list.add(present_nomeBancoDados);
    if (present_nomeBancoDados)
      list.add(nomeBancoDados);
  ...
  public int compareTo(DadoInstalacaoThrift other) {
    ...
    lastComparison = Boolean.valueOf(isSetVersaoSistema()).compareTo(other.isSetVersaoSistema());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVersaoSistema()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.versaoSistema, other.versaoSistema);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNomeBancoDados()).compareTo(other.isSetNomeBancoDados());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNomeBancoDados()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.nomeBancoDados, other.nomeBancoDados);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetVersaoSistema()) {
      if (!first) sb.append(", ");
      sb.append("versaoSistema:");
      if (this.versaoSistema == null) {
        sb.append("null");
      } else {
        sb.append(this.versaoSistema);
      }
      first = false;
    }
    if (isSetNomeBancoDados()) {
      if (!first) sb.append(", ");
      sb.append("nomeBancoDados:");
      if (this.nomeBancoDados == null) {
        sb.append("null");
      } else {
        sb.append(this.nomeBancoDados);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class DadoInstalacaoThriftStandardScheme extends StandardScheme<DadoInstalacaoThrift> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, DadoInstalacaoThrift struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 7: // VERSAO_SISTEMA
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.versaoSistema = iprot.readString();
              struct.setVersaoSistemaIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 8: // NOME_BANCO_DADOS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.nomeBancoDados = iprot.readString();
              struct.setNomeBancoDadosIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DadoInstalacaoThrift struct) throws org.apache.thrift.TException {
      ...
      if (struct.versaoSistema != null) {
        if (struct.isSetVersaoSistema()) {
          oprot.writeFieldBegin(VERSAO_SISTEMA_FIELD_DESC);
          oprot.writeString(struct.versaoSistema);
          oprot.writeFieldEnd();
        }
      }
      if (struct.nomeBancoDados != null) {
        if (struct.isSetNomeBancoDados()) {
          oprot.writeFieldBegin(NOME_BANCO_DADOS_FIELD_DESC);
          oprot.writeString(struct.nomeBancoDados);
          oprot.writeFieldEnd();
        }
      }

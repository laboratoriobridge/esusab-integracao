            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.atendimentosOdontologicos = new ArrayList<FichaAtendimentoOdontologicoChildThrift>(_list40.size);
                FichaAtendimentoOdontologicoChildThrift _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new FichaAtendimentoOdontologicoChildThrift();
                  _elem41.read(iprot);
                  struct.atendimentosOdontologicos.add(_elem41);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.atendimentosOdontologicos != null) {
        if (struct.isSetAtendimentosOdontologicos()) {
          oprot.writeFieldBegin(ATENDIMENTOS_ODONTOLOGICOS_FIELD_DESC);
          {
            ...
            for (FichaAtendimentoOdontologicoChildThrift _iter43 : struct.atendimentosOdontologicos)
            {
              _iter43.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetAtendimentosOdontologicos()) {
        {
          ...
          for (FichaAtendimentoOdontologicoChildThrift _iter44 : struct.atendimentosOdontologicos)
          {
            _iter44.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.atendimentosOdontologicos = new ArrayList<FichaAtendimentoOdontologicoChildThrift>(_list45.size);
          FichaAtendimentoOdontologicoChildThrift _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new FichaAtendimentoOdontologicoChildThrift();
            _elem46.read(iprot);
            struct.atendimentosOdontologicos.add(_elem46);
          }
        }
        struct.setAtendimentosOdontologicosIsSet(true);
      }

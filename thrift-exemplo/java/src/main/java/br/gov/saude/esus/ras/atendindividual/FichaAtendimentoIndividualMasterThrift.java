            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.atendimentosIndividuais = new ArrayList<FichaAtendimentoIndividualChildThrift>(_list40.size);
                FichaAtendimentoIndividualChildThrift _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new FichaAtendimentoIndividualChildThrift();
                  _elem41.read(iprot);
                  struct.atendimentosIndividuais.add(_elem41);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.atendimentosIndividuais != null) {
        if (struct.isSetAtendimentosIndividuais()) {
          oprot.writeFieldBegin(ATENDIMENTOS_INDIVIDUAIS_FIELD_DESC);
          {
            ...
            for (FichaAtendimentoIndividualChildThrift _iter43 : struct.atendimentosIndividuais)
            {
              _iter43.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetAtendimentosIndividuais()) {
        {
          ...
          for (FichaAtendimentoIndividualChildThrift _iter44 : struct.atendimentosIndividuais)
          {
            _iter44.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.atendimentosIndividuais = new ArrayList<FichaAtendimentoIndividualChildThrift>(_list45.size);
          FichaAtendimentoIndividualChildThrift _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new FichaAtendimentoIndividualChildThrift();
            _elem46.read(iprot);
            struct.atendimentosIndividuais.add(_elem46);
          }
        }
        struct.setAtendimentosIndividuaisIsSet(true);
      }

<?php
namespace br\gov\saude\esus\cds\transport\generated\thrift\atividadeindividual;
...
class FichaAtendimentoIndividualChildThrift {
  ...
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\atividadeindividual\ProblemaCondicaoAvaliacaoAIThrift
   */
  public $problemaCondicaoAvaliada = null;
  /**
   * @var string[]
   */
  public $examesSolicitados = null;
  /**
   * @var string[]
   */
  public $examesAvaliados = null;
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\atividadeindividual\OutrosSiaThrift[]
   */
  public $outrosSia = null;
  /**
   * @var bool
   */
  ...
  public function __construct($vals=null) {
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        14 => array(
          ...
          'type' => TType::STRUCT,
          'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\atividadeindividual\ProblemaCondicaoAvaliacaoAIThrift',
          ),
        15 => array(
          'var' => 'examesSolicitados',
          'type' => TType::LST,
          'etype' => TType::STRING,
          'elem' => array(
            'type' => TType::STRING,
        ...
        17 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\atividadeindividual\OutrosSiaThrift',
            ),
          ),
        18 => array(
          'var' => 'vacinaEmDia',
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['examesSolicitados'])) {
        $this->examesSolicitados = $vals['examesSolicitados'];
      }
      if (isset($vals['examesAvaliados'])) {
        $this->examesAvaliados = $vals['examesAvaliados'];
      }
      if (isset($vals['outrosSia'])) {
        $this->outrosSia = $vals['outrosSia'];
      }
      ...
      switch ($fid)
      {
        ...
        case 14:
          if ($ftype == TType::STRUCT) {
            $this->problemaCondicaoAvaliada = new \br\gov\saude\esus\cds\transport\generated\thrift\atividadeindividual\ProblemaCondicaoAvaliacaoAIThrift();
        ...
        case 17:
          if ($ftype == TType::LST) {
            ...
            {
              $elem31 = null;
              $elem31 = new \br\gov\saude\esus\cds\transport\generated\thrift\atividadeindividual\OutrosSiaThrift();
              $xfer += $elem31->read($input);
              $this->outrosSia []= $elem31;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->examesSolicitados !== null) {
      if (!is_array($this->examesSolicitados)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('examesSolicitados', TType::LST, 15);
      {
        $output->writeListBegin(TType::STRING, count($this->examesSolicitados));
        {
          foreach ($this->examesSolicitados as $iter44)
          {
    ...
    if ($this->examesAvaliados !== null) {
      if (!is_array($this->examesAvaliados)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('examesAvaliados', TType::LST, 16);
      {
        $output->writeListBegin(TType::STRING, count($this->examesAvaliados));
        {
          foreach ($this->examesAvaliados as $iter45)
          {
    ...
    if ($this->outrosSia !== null) {
      if (!is_array($this->outrosSia)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('outrosSia', TType::LST, 17);
      {
        $output->writeListBegin(TType::STRUCT, count($this->outrosSia));
        {
          foreach ($this->outrosSia as $iter46)
          {
    ...
    if ($this->condutas !== null) {
      ...
      $xfer += $output->writeFieldBegin('condutas', TType::LST, 22);
      {
        ...
        {
          foreach ($this->condutas as $iter48)
          {
...
class FichaAtendimentoIndividualMasterThrift {
  ...
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\atividadeindividual\FichaAtendimentoIndividualChildThrift[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\atividadeindividual\FichaAtendimentoIndividualChildThrift',
            ),
          ),
        3 => array(
          'var' => 'uuidFicha',
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem54 = null;
              $elem54 = new \br\gov\saude\esus\cds\transport\generated\thrift\atividadeindividual\FichaAtendimentoIndividualChildThrift();

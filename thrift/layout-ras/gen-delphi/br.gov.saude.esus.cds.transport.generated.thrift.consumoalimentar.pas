...
unit br.gov.saude.esus.cds.transport.generated.thrift.consumoalimentar;
...
const
  cbr_gov_saude_esus_cds_transport_generated_thrift_consumoalimentar_Option_AnsiStr_Binary = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_consumoalimentar_Option_Register_Types = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_consumoalimentar_Option_ConstPrefix    = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_consumoalimentar_Option_Events         = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_consumoalimentar_Option_XmlDoc         = False;
...
function TFichaConsumoAlimentarThriftImpl.GetNumeroCartaoSus: string;
begin
  Result := FNumeroCartaoSus;
end;

procedure TFichaConsumoAlimentarThriftImpl.SetNumeroCartaoSus( const Value: string);
begin
  F__isset_NumeroCartaoSus := True;
  FNumeroCartaoSus := Value;
end;

function TFichaConsumoAlimentarThriftImpl.Get__isset_NumeroCartaoSus: Boolean;
begin

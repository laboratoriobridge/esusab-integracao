...
class VacinaRowThrift:
  ...
  thrift_spec = (
    ...
    (6, TType.BOOL, 'stRegistroAnterior', None, None, ), # 6
    (7, TType.I64, 'dataRegistroAnterior', None, None, ), # 7
  )

  def __init__(self, imunobiologico=None, estrategiaVacinacao=None, dose=None, lote=None, fabricante=None, stRegistroAnterior=None, dataRegistroAnterior=None,):
  ...
  def write(self, oprot):
    ...
    if self.stRegistroAnterior is not None:
      oprot.writeFieldBegin('stRegistroAnterior', TType.BOOL, 6)
      oprot.writeBool(self.stRegistroAnterior)
      oprot.writeFieldEnd()
    if self.dataRegistroAnterior is not None:
      oprot.writeFieldBegin('dataRegistroAnterior', TType.I64, 7)

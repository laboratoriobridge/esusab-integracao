<?php
namespace br\gov\saude\esus\cds\transport\generated\thrift\atendimentoodontologico;
...
class FichaAtendimentoOdontologicoChildThrift {
  ...
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\atendimentoodontologico\ProcedimentoQuantidadeThrift[]
   */
  public $procedimentosRealizados = null;
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\atendimentoodontologico\ProcedimentoQuantidadeThrift[]
   */
  public $outrosSiaProcedimentosV321 = null;
  /**
   * @var int
   */
  public $sexo = null;
  ...
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\common\ResultadoExameThrift[]
   */
  ...
  public function __construct($vals=null) {
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        12 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\atendimentoodontologico\ProcedimentoQuantidadeThrift',
            ),
          ),
        13 => array(
          'var' => 'outrosSiaProcedimentosV321',
          'type' => TType::LST,
          'etype' => TType::STRUCT,
          'elem' => array(
            'type' => TType::STRUCT,
        ...
        21 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\common\ResultadoExameThrift',
            ),
          ),
        );
    }
    if (is_array($vals)) {
      ...
      if (isset($vals['outrosSiaProcedimentosV321'])) {
        $this->outrosSiaProcedimentosV321 = $vals['outrosSiaProcedimentosV321'];
      }
      if (isset($vals['sexo'])) {
        $this->sexo = $vals['sexo'];
      }
      ...
      switch ($fid)
      {
        ...
        case 12:
          if ($ftype == TType::LST) {
            ...
            {
              $elem29 = null;
              $elem29 = new \br\gov\saude\esus\cds\transport\generated\thrift\atendimentoodontologico\ProcedimentoQuantidadeThrift();
        ...
        case 13:
          if ($ftype == TType::LST) {
            $this->outrosSiaProcedimentosV321 = array();
            $_size30 = 0;
            $_etype33 = 0;
            ...
            {
              $elem35 = null;
              $elem35 = new \br\gov\saude\esus\cds\transport\generated\thrift\atendimentoodontologico\ProcedimentoQuantidadeThrift();
              $xfer += $elem35->read($input);
              $this->outrosSiaProcedimentosV321 []= $elem35;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 19:
          if ($ftype == TType::LST) {
            ...
            {
              $elem41 = null;
              $elem41 = new \br\gov\saude\esus\cds\transport\generated\thrift\common\MedicamentoThrift();
              $xfer += $elem41->read($input);
              $this->medicamentos []= $elem41;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 20:
          if ($ftype == TType::LST) {
            ...
            {
              $elem47 = null;
              $elem47 = new \br\gov\saude\esus\cds\transport\generated\thrift\common\EncaminhamentoExternoThrift();
              $xfer += $elem47->read($input);
              $this->encaminhamentos []= $elem47;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 21:
          if ($ftype == TType::LST) {
            ...
            {
              $elem53 = null;
              $elem53 = new \br\gov\saude\esus\cds\transport\generated\thrift\common\ResultadoExameThrift();
              $xfer += $elem53->read($input);
              $this->resultadosExames []= $elem53;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->outrosSiaProcedimentosV321 !== null) {
      if (!is_array($this->outrosSiaProcedimentosV321)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('outrosSiaProcedimentosV321', TType::LST, 13);
      {
        $output->writeListBegin(TType::STRUCT, count($this->outrosSiaProcedimentosV321));
        {
          foreach ($this->outrosSiaProcedimentosV321 as $iter59)
          {
    ...
    if ($this->medicamentos !== null) {
      ...
      $xfer += $output->writeFieldBegin('medicamentos', TType::LST, 19);
      {
        ...
        {
          foreach ($this->medicamentos as $iter60)
          {
    ...
    if ($this->encaminhamentos !== null) {
      ...
      $xfer += $output->writeFieldBegin('encaminhamentos', TType::LST, 20);
      {
        ...
        {
          foreach ($this->encaminhamentos as $iter61)
          {
    ...
    if ($this->resultadosExames !== null) {
      ...
      $xfer += $output->writeFieldBegin('resultadosExames', TType::LST, 21);
      {
        ...
        {
          foreach ($this->resultadosExames as $iter62)
          {
...
class FichaAtendimentoOdontologicoMasterThrift {
  ...
  /**
   * @var \br\gov\saude\esus\cds\transport\generated\thrift\atendimentoodontologico\FichaAtendimentoOdontologicoChildThrift[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        3 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\br\gov\saude\esus\cds\transport\generated\thrift\atendimentoodontologico\FichaAtendimentoOdontologicoChildThrift',
            ),
          ),
        4 => array(
          'var' => 'tpCdsOrigem',
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem68 = null;
              $elem68 = new \br\gov\saude\esus\cds\transport\generated\thrift\atendimentoodontologico\FichaAtendimentoOdontologicoChildThrift();

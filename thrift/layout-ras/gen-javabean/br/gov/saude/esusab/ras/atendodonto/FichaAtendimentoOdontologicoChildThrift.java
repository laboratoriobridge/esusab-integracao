...
public class FichaAtendimentoOdontologicoChildThrift implements org.apache.thrift.TBase<FichaAtendimentoOdontologicoChildThrift, FichaAtendimentoOdontologicoChildThrift._Fields>, java.io.Serializable, Cloneable, Comparable<FichaAtendimentoOdontologicoChildThrift> {
  ...
  private List<br.gov.saude.esusab.ras.common.ResultadoExameThrift> resultadosExames; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.RESULTADOS_EXAMES, new org.apache.thrift.meta_data.FieldMetaData("resultadosExames", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, br.gov.saude.esusab.ras.common.ResultadoExameThrift.class))));
  ...
  public FichaAtendimentoOdontologicoChildThrift(FichaAtendimentoOdontologicoChildThrift other) {
    ...
    if (other.isSetResultadosExames()) {
      List<br.gov.saude.esusab.ras.common.ResultadoExameThrift> __this__resultadosExames = new ArrayList<br.gov.saude.esusab.ras.common.ResultadoExameThrift>(other.resultadosExames.size());
      for (br.gov.saude.esusab.ras.common.ResultadoExameThrift other_element : other.resultadosExames) {
        __this__resultadosExames.add(new br.gov.saude.esusab.ras.common.ResultadoExameThrift(other_element));
      }
  ...
  public java.util.Iterator<br.gov.saude.esusab.ras.common.ResultadoExameThrift> getResultadosExamesIterator() {
    return (this.resultadosExames == null) ? null : this.resultadosExames.iterator();
  }

  public void addToResultadosExames(br.gov.saude.esusab.ras.common.ResultadoExameThrift elem) {
    if (this.resultadosExames == null) {
      this.resultadosExames = new ArrayList<br.gov.saude.esusab.ras.common.ResultadoExameThrift>();
    }
    this.resultadosExames.add(elem);
  }

  public List<br.gov.saude.esusab.ras.common.ResultadoExameThrift> getResultadosExames() {
    return this.resultadosExames;
  }

  public void setResultadosExames(List<br.gov.saude.esusab.ras.common.ResultadoExameThrift> resultadosExames) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULTADOS_EXAMES:
      if (value == null) {
        ...
        setResultadosExames((List<br.gov.saude.esusab.ras.common.ResultadoExameThrift>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultadosExames = new ArrayList<br.gov.saude.esusab.ras.common.ResultadoExameThrift>(_list21.size);
                br.gov.saude.esusab.ras.common.ResultadoExameThrift _elem22;
                for (int _i23 = 0; _i23 < _list21.size; ++_i23)
                {
                  _elem22 = new br.gov.saude.esusab.ras.common.ResultadoExameThrift();
                  _elem22.read(iprot);
      ...
      if (struct.medicamentos != null) {
        if (struct.isSetMedicamentos()) {
          oprot.writeFieldBegin(MEDICAMENTOS_FIELD_DESC);
          {
            ...
            for (br.gov.saude.esusab.ras.common.MedicamentoThrift _iter29 : struct.medicamentos)
            {
              _iter29.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.encaminhamentos != null) {
        if (struct.isSetEncaminhamentos()) {
          oprot.writeFieldBegin(ENCAMINHAMENTOS_FIELD_DESC);
          {
            ...
            for (br.gov.saude.esusab.ras.common.EncaminhamentoExternoThrift _iter30 : struct.encaminhamentos)
            {
              _iter30.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.resultadosExames != null) {
        if (struct.isSetResultadosExames()) {
          oprot.writeFieldBegin(RESULTADOS_EXAMES_FIELD_DESC);
          {
            ...
            for (br.gov.saude.esusab.ras.common.ResultadoExameThrift _iter31 : struct.resultadosExames)
            {
              _iter31.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetTiposEncamOdonto()) {
        {
          ...
          for (long _iter32 : struct.tiposEncamOdonto)
          {
      ...
      if (struct.isSetTiposFornecimOdonto()) {
        {
          ...
          for (long _iter33 : struct.tiposFornecimOdonto)
          {
      ...
      if (struct.isSetTiposVigilanciaSaudeBucal()) {
        {
          ...
          for (long _iter34 : struct.tiposVigilanciaSaudeBucal)
          {
      ...
      if (struct.isSetTiposConsultaOdonto()) {
        {
          ...
          for (long _iter35 : struct.tiposConsultaOdonto)
          {
      ...
      if (struct.isSetProcedimentosRealizados()) {
        {
          ...
          for (ProcedimentoQuantidadeThrift _iter36 : struct.procedimentosRealizados)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (struct.isSetResultadosExames()) {
        {
          ...
          for (br.gov.saude.esusab.ras.common.ResultadoExameThrift _iter39 : struct.resultadosExames)
          {
            _iter39.write(oprot);
          }
        }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.tiposEncamOdonto = new ArrayList<Long>(_list40.size);
          long _elem41;
          for (int _i42 = 0; _i42 < _list40.size; ++_i42)
          {
            _elem41 = iprot.readI64();
            struct.tiposEncamOdonto.add(_elem41);
          }
        }
        struct.setTiposEncamOdontoIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.tiposFornecimOdonto = new ArrayList<Long>(_list43.size);
          long _elem44;
          for (int _i45 = 0; _i45 < _list43.size; ++_i45)
          {
            _elem44 = iprot.readI64();
            struct.tiposFornecimOdonto.add(_elem44);
          }
        }
        struct.setTiposFornecimOdontoIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.tiposVigilanciaSaudeBucal = new ArrayList<Long>(_list46.size);
          long _elem47;
          for (int _i48 = 0; _i48 < _list46.size; ++_i48)
          {
            _elem47 = iprot.readI64();
            struct.tiposVigilanciaSaudeBucal.add(_elem47);
          }
        }
        struct.setTiposVigilanciaSaudeBucalIsSet(true);
      }
      if (incoming.get(10)) {
        {
          ...
          struct.tiposConsultaOdonto = new ArrayList<Long>(_list49.size);
          long _elem50;
          for (int _i51 = 0; _i51 < _list49.size; ++_i51)
          {
            _elem50 = iprot.readI64();
            struct.tiposConsultaOdonto.add(_elem50);
          }
        }
        struct.setTiposConsultaOdontoIsSet(true);
      }
      if (incoming.get(11)) {
        {
          ...
          struct.procedimentosRealizados = new ArrayList<ProcedimentoQuantidadeThrift>(_list52.size);
          ProcedimentoQuantidadeThrift _elem53;
          for (int _i54 = 0; _i54 < _list52.size; ++_i54)
          {
            _elem53 = new ProcedimentoQuantidadeThrift();
            _elem53.read(iprot);
            struct.procedimentosRealizados.add(_elem53);
          }
        }
        struct.setProcedimentosRealizadosIsSet(true);
      }
      ...
      if (incoming.get(19)) {
        {
          ...
          struct.resultadosExames = new ArrayList<br.gov.saude.esusab.ras.common.ResultadoExameThrift>(_list61.size);
          br.gov.saude.esusab.ras.common.ResultadoExameThrift _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = new br.gov.saude.esusab.ras.common.ResultadoExameThrift();
            _elem62.read(iprot);

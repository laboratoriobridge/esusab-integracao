...
unit br.gov.saude.esus.cds.transport.generated.thrift.atendimentoindividual;
...
const
  cbr_gov_saude_esus_cds_transport_generated_thrift_atendimentoindividual_Option_AnsiStr_Binary = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_atendimentoindividual_Option_Register_Types = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_atendimentoindividual_Option_ConstPrefix    = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_atendimentoindividual_Option_Events         = False;
  cbr_gov_saude_esus_cds_transport_generated_thrift_atendimentoindividual_Option_XmlDoc         = False;
...
type
  ...
  IFichaAtendimentoIndividualChildThrift = interface(IBase)
    ...
    function GetExamesSolicitadosV321: IThriftList<string>;
    procedure SetExamesSolicitadosV321( const Value: IThriftList<string>);
    function GetExamesAvaliadosV321: IThriftList<string>;
    procedure SetExamesAvaliadosV321( const Value: IThriftList<string>);
    function GetExame: IThriftList<IOutrosSiaThrift>;
    procedure SetExame( const Value: IThriftList<IOutrosSiaThrift>);
    ...
    property ExamesSolicitadosV321: IThriftList<string> read GetExamesSolicitadosV321 write SetExamesSolicitadosV321;
    property ExamesAvaliadosV321: IThriftList<string> read GetExamesAvaliadosV321 write SetExamesAvaliadosV321;
    property Exame: IThriftList<IOutrosSiaThrift> read GetExame write SetExame;
    ...
    function Get__isset_ExamesSolicitadosV321: Boolean;
    function Get__isset_ExamesAvaliadosV321: Boolean;
    ...
    property __isset_ExamesSolicitadosV321: Boolean read Get__isset_ExamesSolicitadosV321;
    property __isset_ExamesAvaliadosV321: Boolean read Get__isset_ExamesAvaliadosV321;
  ...
  private
    ...
    FExamesSolicitadosV321: IThriftList<string>;
    FExamesAvaliadosV321: IThriftList<string>;
    FExame: IThriftList<IOutrosSiaThrift>;
    ...
    F__isset_ExamesSolicitadosV321: Boolean;
    F__isset_ExamesAvaliadosV321: Boolean;
...
function TFichaAtendimentoIndividualChildThriftImpl.GetExamesSolicitadosV321: IThriftList<string>;
begin
  Result := FExamesSolicitadosV321;
end;

procedure TFichaAtendimentoIndividualChildThriftImpl.SetExamesSolicitadosV321( const Value: IThriftList<string>);
begin
  F__isset_ExamesSolicitadosV321 := True;
  FExamesSolicitadosV321 := Value;
end;

function TFichaAtendimentoIndividualChildThriftImpl.Get__isset_ExamesSolicitadosV321: Boolean;
begin
  Result := F__isset_ExamesSolicitadosV321;
end;

function TFichaAtendimentoIndividualChildThriftImpl.GetExamesAvaliadosV321: IThriftList<string>;
begin
  Result := FExamesAvaliadosV321;
end;

procedure TFichaAtendimentoIndividualChildThriftImpl.SetExamesAvaliadosV321( const Value: IThriftList<string>);
begin
  F__isset_ExamesAvaliadosV321 := True;
  FExamesAvaliadosV321 := Value;
end;

function TFichaAtendimentoIndividualChildThriftImpl.Get__isset_ExamesAvaliadosV321: Boolean;
begin
  Result := F__isset_ExamesAvaliadosV321;
end;

function TFichaAtendimentoIndividualChildThriftImpl.GetExame: IThriftList<IOutrosSiaThrift>;
begin
  Result := FExame;
end;

procedure TFichaAtendimentoIndividualChildThriftImpl.SetExame( const Value: IThriftList<IOutrosSiaThrift>);
begin
  F__isset_Exame := True;
  FExame := Value;
end;
...
var
  ...
  _list29: IList;
  _i30: Integer;
  _elem31: IMedicamentoThrift;
  _list32: IList;
  _i33: Integer;
  _elem34: IEncaminhamentoExternoThrift;
  _list35: IList;
  _i36: Integer;
  _elem37: IResultadosExameThrift;
    ...
    begin
      ...
      case field_.ID of
        ...
        15: begin
          if (field_.Type_ = TType.List) then
          begin
            ExamesSolicitadosV321 := TThriftListImpl<string>.Create;
            _list14 := iprot.ReadListBegin();
            for _i15 := 0 to _list14.Count - 1 do
            begin
              _elem16 := iprot.ReadString();
              ExamesSolicitadosV321.Add(_elem16);
            end;
            iprot.ReadListEnd();
          end else
          begin
        ...
        16: begin
          if (field_.Type_ = TType.List) then
          begin
            ExamesAvaliadosV321 := TThriftListImpl<string>.Create;
            _list17 := iprot.ReadListBegin();
            for _i18 := 0 to _list17.Count - 1 do
            begin
              _elem19 := iprot.ReadString();
              ExamesAvaliadosV321.Add(_elem19);
            end;
            iprot.ReadListEnd();
          end else
          begin
        ...
        17: begin
          if (field_.Type_ = TType.List) then
          begin
            Exame := TThriftListImpl<IOutrosSiaThrift>.Create;
        ...
        31: begin
          ...
          begin
            ...
            begin
              _elem31 := TMedicamentoThriftImpl.Create;
              _elem31.Read(iprot);
              Medicamentos.Add(_elem31);
            end;
            iprot.ReadListEnd();
          end else
          begin
        ...
        32: begin
          ...
          begin
            ...
            begin
              _elem34 := TEncaminhamentoExternoThriftImpl.Create;
              _elem34.Read(iprot);
              Encaminhamentos.Add(_elem34);
            end;
            iprot.ReadListEnd();
          end else
          begin
        ...
        33: begin
          ...
          begin
            ...
            begin
              _elem37 := TResultadosExameThriftImpl.Create;
              _elem37.Read(iprot);
              ResultadosExames.Add(_elem37);
            end;
            iprot.ReadListEnd();
          end else
          begin
...
var
  ...
  _iter41: string;
  list_42 : IList;
  _iter43: IOutrosSiaThrift;
  list_44 : IList;
  _iter45: Int64;
  list_46 : IList;
  _iter47: Int64;
  list_48 : IList;
  _iter49: IMedicamentoThrift;
  list_50 : IList;
  _iter51: IEncaminhamentoExternoThrift;
  list_52 : IList;
  _iter53: IResultadosExameThrift;
begin
  tracker := oprot.NextRecursionLevel;
  ...
  if (ExamesSolicitadosV321 <> nil) and __isset_ExamesSolicitadosV321 then
  begin
    field_.Name := 'examesSolicitadosV321';
    field_.Type_  := TType.List;
    field_.ID := 15;
    oprot.WriteFieldBegin(field_);
    list_38 := TListImpl.Create(TType.String_, ExamesSolicitadosV321.Count);
    oprot.WriteListBegin( list_38);
    for _iter39 in ExamesSolicitadosV321 do
    begin
  ...
  if (ExamesAvaliadosV321 <> nil) and __isset_ExamesAvaliadosV321 then
  begin
    field_.Name := 'examesAvaliadosV321';
    field_.Type_  := TType.List;
    field_.ID := 16;
    oprot.WriteFieldBegin(field_);
    list_40 := TListImpl.Create(TType.String_, ExamesAvaliadosV321.Count);
    oprot.WriteListBegin( list_40);
    for _iter41 in ExamesAvaliadosV321 do
    begin
  ...
  begin
    ...
    field_.ID := 17;
    oprot.WriteFieldBegin(field_);
    list_42 := TListImpl.Create(TType.Struct, Exame.Count);
    oprot.WriteListBegin( list_42);
    for _iter43 in Exame do
    begin
      _iter43.Write(oprot);
    end;
    oprot.WriteListEnd();
  ...
  begin
    ...
    field_.ID := 21;
    oprot.WriteFieldBegin(field_);
    list_44 := TListImpl.Create(TType.I64, Nasfs.Count);
    oprot.WriteListBegin( list_44);
    for _iter45 in Nasfs do
    begin
  ...
  begin
    ...
    field_.ID := 22;
    oprot.WriteFieldBegin(field_);
    list_46 := TListImpl.Create(TType.I64, Condutas.Count);
    oprot.WriteListBegin( list_46);
    for _iter47 in Condutas do
    begin
  ...
  begin
    ...
    field_.ID := 31;
    oprot.WriteFieldBegin(field_);
    list_48 := TListImpl.Create(TType.Struct, Medicamentos.Count);
    oprot.WriteListBegin( list_48);
    for _iter49 in Medicamentos do
    begin
      _iter49.Write(oprot);
    end;
    oprot.WriteListEnd();
  ...
  begin
    ...
    field_.ID := 32;
    oprot.WriteFieldBegin(field_);
    list_50 := TListImpl.Create(TType.Struct, Encaminhamentos.Count);
    oprot.WriteListBegin( list_50);
    for _iter51 in Encaminhamentos do
    begin
      _iter51.Write(oprot);
    end;
    oprot.WriteListEnd();
  ...
  begin
    ...
    field_.ID := 33;
    oprot.WriteFieldBegin(field_);
    list_52 := TListImpl.Create(TType.Struct, ResultadosExames.Count);
    oprot.WriteListBegin( list_52);
    for _iter53 in ResultadosExames do
    begin
      _iter53.Write(oprot);
    end;
    oprot.WriteListEnd();
...
begin
  ...
  try
    ...
    if (ExamesSolicitadosV321 <> nil) and __isset_ExamesSolicitadosV321 then begin
      if not _first55 then _sb54.Append(',');
      _first55 := FALSE;
      _sb54.Append('ExamesSolicitadosV321: ');
      _sb54.Append(ExamesSolicitadosV321);
    end;
    if (ExamesAvaliadosV321 <> nil) and __isset_ExamesAvaliadosV321 then begin
      if not _first55 then _sb54.Append(',');
      _first55 := FALSE;
      _sb54.Append('ExamesAvaliadosV321: ');
      _sb54.Append(ExamesAvaliadosV321);
    end;

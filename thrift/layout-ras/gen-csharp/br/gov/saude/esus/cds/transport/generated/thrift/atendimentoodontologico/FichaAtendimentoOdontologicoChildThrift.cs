...
namespace br.gov.saude.esus.cds.transport.generated.thrift.atendimentoodontologico
{
  ...
  public partial class FichaAtendimentoOdontologicoChildThrift : TBase
  {
    ...
    private List<ProcedimentoQuantidadeThrift> _outrosSiaProcedimentosV321;
    private long _sexo;
    private long _turno;
    ...
    private List<br.gov.saude.esus.cds.transport.generated.thrift.common.ResultadoExameThrift> _resultadosExames;
    ...
    public List<ProcedimentoQuantidadeThrift> OutrosSiaProcedimentosV321
    {
      get
      {
        return _outrosSiaProcedimentosV321;
      }
      set
      {
        __isset.outrosSiaProcedimentosV321 = true;
        this._outrosSiaProcedimentosV321 = value;
      }
    }
    ...
    public List<br.gov.saude.esus.cds.transport.generated.thrift.common.ResultadoExameThrift> ResultadosExames
    {
      get
      {
    ...
    public struct Isset {
      ...
      public bool outrosSiaProcedimentosV321;
      public bool sexo;
      public bool turno;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 13:
              if (field.Type == TType.List) {
                {
                  OutrosSiaProcedimentosV321 = new List<ProcedimentoQuantidadeThrift>();
                  ...
                  for( int _i16 = 0; _i16 < _list15.Count; ++_i16)
                  {
                    ...
                    _elem17.Read(iprot);
                    OutrosSiaProcedimentosV321.Add(_elem17);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    br.gov.saude.esus.cds.transport.generated.thrift.common.MedicamentoThrift _elem20;
                    _elem20 = new br.gov.saude.esus.cds.transport.generated.thrift.common.MedicamentoThrift();
                    _elem20.Read(iprot);
                    Medicamentos.Add(_elem20);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    br.gov.saude.esus.cds.transport.generated.thrift.common.EncaminhamentoExternoThrift _elem23;
                    _elem23 = new br.gov.saude.esus.cds.transport.generated.thrift.common.EncaminhamentoExternoThrift();
                    _elem23.Read(iprot);
                    Encaminhamentos.Add(_elem23);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 21:
              if (field.Type == TType.List) {
                {
                  ResultadosExames = new List<br.gov.saude.esus.cds.transport.generated.thrift.common.ResultadoExameThrift>();
                  TList _list24 = iprot.ReadListBegin();
                  for( int _i25 = 0; _i25 < _list24.Count; ++_i25)
                  {
                    br.gov.saude.esus.cds.transport.generated.thrift.common.ResultadoExameThrift _elem26;
                    _elem26 = new br.gov.saude.esus.cds.transport.generated.thrift.common.ResultadoExameThrift();
                    _elem26.Read(iprot);
                    ResultadosExames.Add(_elem26);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (OutrosSiaProcedimentosV321 != null && __isset.outrosSiaProcedimentosV321) {
          field.Name = "outrosSiaProcedimentosV321";
          field.Type = TType.List;
          field.ID = 13;
          oprot.WriteFieldBegin(field);
          {
            oprot.WriteListBegin(new TList(TType.Struct, OutrosSiaProcedimentosV321.Count));
            foreach (ProcedimentoQuantidadeThrift _iter32 in OutrosSiaProcedimentosV321)
            {
              _iter32.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (Medicamentos != null && __isset.medicamentos) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (br.gov.saude.esus.cds.transport.generated.thrift.common.MedicamentoThrift _iter33 in Medicamentos)
            {
              _iter33.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (Encaminhamentos != null && __isset.encaminhamentos) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (br.gov.saude.esus.cds.transport.generated.thrift.common.EncaminhamentoExternoThrift _iter34 in Encaminhamentos)
            {
              _iter34.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (ResultadosExames != null && __isset.resultadosExames) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (br.gov.saude.esus.cds.transport.generated.thrift.common.ResultadoExameThrift _iter35 in ResultadosExames)
            {
              _iter35.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    public override string ToString() {
      ...
      if (OutrosSiaProcedimentosV321 != null && __isset.outrosSiaProcedimentosV321) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("OutrosSiaProcedimentosV321: ");
        __sb.Append(OutrosSiaProcedimentosV321);
      }
      if (__isset.sexo) {
        if(!__first) { __sb.Append(", "); }

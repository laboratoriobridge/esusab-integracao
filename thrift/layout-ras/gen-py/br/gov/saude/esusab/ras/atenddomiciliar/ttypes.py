...
class FichaAtendimentoDomiciliarChildThrift:
  ...
  thrift_spec = (
    ...
    (12, TType.LIST, 'outrosProcedimentos', (TType.STRING,None), None, ), # 12
    (13, TType.I64, 'condutaDesfecho', None, None, ), # 13
  )

  def __init__(self, turno=None, cnsCidadao=None, dataNascimento=None, sexo=None, localAtendimento=None, atencaoDomiciliarModalidade=None, tipoAtendimento=None, condicoesAvaliadas=None, cid=None, ciap=None, procedimentos=None, outrosProcedimentos=None, condutaDesfecho=None,):
    self.turno = turno
    ...
    self.outrosProcedimentos = outrosProcedimentos
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          self.outrosProcedimentos = []
          (_etype15, _size12) = iprot.readListBegin()
          for _i16 in xrange(_size12):
            _elem17 = iprot.readString();
            self.outrosProcedimentos.append(_elem17)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 13:
  ...
  def write(self, oprot):
    ...
    if self.procedimentos is not None:
      ...
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.outrosProcedimentos is not None:
      oprot.writeFieldBegin('outrosProcedimentos', TType.LIST, 12)
      oprot.writeListBegin(TType.STRING, len(self.outrosProcedimentos))
      for iter20 in self.outrosProcedimentos:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.outrosProcedimentos)

...
class OutrosSiaThrift:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      ...
      return
    oprot.writeStructBegin('OutrosSiaThrift')
...
class FichaAtendimentoIndividualChildThrift:
  ...
  thrift_spec = (
    ...
    (15, TType.LIST, 'examesSolicitadosV321', (TType.STRING,None), None, ), # 15
    (16, TType.LIST, 'examesAvaliadosV321', (TType.STRING,None), None, ), # 16
    (17, TType.LIST, 'exame', (TType.STRUCT,(OutrosSiaThrift, OutrosSiaThrift.thrift_spec)), None, ), # 17
  ...
  def __init__(self, numeroProntuario=None, cns=None, dataNascimento=None, localDeAtendimento=None, sexo=None, turno=None, tipoAtendimento=None, pesoAcompanhamentoNutricional=None, alturaAcompanhamentoNutricional=None, aleitamentoMaterno=None, dumDaGestante=None, idadeGestacional=None, atencaoDomiciliarModalidade=None, problemaCondicaoAvaliada=None, examesSolicitadosV321=None, examesAvaliadosV321=None, exame=None, vacinaEmDia=None, pic=None, ficouEmObservacao=None, nasfs=None, condutas=None, stGravidezPlanejada=None, nuGestasPrevias=None, nuPartos=None, racionalidadeSaude=None, perimetroCefalico=None, dataHoraInicialAtendimento=None, dataHoraFinalAtendimento=None, cpfCidadao=None, medicamentos=None, encaminhamentos=None, resultadosExames=None,):
    ...
    self.examesSolicitadosV321 = examesSolicitadosV321
    self.examesAvaliadosV321 = examesAvaliadosV321
    self.exame = exame
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          self.examesSolicitadosV321 = []
          (_etype17, _size14) = iprot.readListBegin()
          for _i18 in xrange(_size14):
            _elem19 = iprot.readString()
            self.examesSolicitadosV321.append(_elem19)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 16:
        if ftype == TType.LIST:
          self.examesAvaliadosV321 = []
          (_etype23, _size20) = iprot.readListBegin()
          for _i24 in xrange(_size20):
            _elem25 = iprot.readString()
            self.examesAvaliadosV321.append(_elem25)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 17:
        if ftype == TType.LIST:
          ...
          for _i30 in xrange(_size26):
            _elem31 = OutrosSiaThrift()
            _elem31.read(iprot)
            self.exame.append(_elem31)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 18:
        ...
        if ftype == TType.LIST:
          ...
          for _i48 in xrange(_size44):
            _elem49 = common.ttypes.MedicamentoThrift()
            _elem49.read(iprot)
            self.medicamentos.append(_elem49)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 32:
        if ftype == TType.LIST:
          ...
          for _i54 in xrange(_size50):
            _elem55 = common.ttypes.EncaminhamentoExternoThrift()
            _elem55.read(iprot)
            self.encaminhamentos.append(_elem55)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 33:
        if ftype == TType.LIST:
          ...
          for _i60 in xrange(_size56):
            _elem61 = common.ttypes.ResultadosExameThrift()
            _elem61.read(iprot)
            self.resultadosExames.append(_elem61)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.problemaCondicaoAvaliada is not None:
      ...
      oprot.writeFieldEnd()
    if self.examesSolicitadosV321 is not None:
      oprot.writeFieldBegin('examesSolicitadosV321', TType.LIST, 15)
      oprot.writeListBegin(TType.STRING, len(self.examesSolicitadosV321))
      for iter62 in self.examesSolicitadosV321:
        oprot.writeString(iter62)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.examesAvaliadosV321 is not None:
      oprot.writeFieldBegin('examesAvaliadosV321', TType.LIST, 16)
      oprot.writeListBegin(TType.STRING, len(self.examesAvaliadosV321))
      for iter63 in self.examesAvaliadosV321:
    ...
    if self.medicamentos is not None:
      ...
      for iter67 in self.medicamentos:
        iter67.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.encaminhamentos is not None:
      ...
      for iter68 in self.encaminhamentos:
        iter68.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.resultadosExames is not None:
      ...
      for iter69 in self.resultadosExames:
        iter69.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.examesSolicitadosV321)
    value = (value * 31) ^ hash(self.examesAvaliadosV321)
...
class FichaAtendimentoIndividualMasterThrift:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'headerTransport', (common.ttypes.VariasLotacoesHeaderThrift, common.ttypes.VariasLotacoesHeaderThrift.thrift_spec), None, ), # 1

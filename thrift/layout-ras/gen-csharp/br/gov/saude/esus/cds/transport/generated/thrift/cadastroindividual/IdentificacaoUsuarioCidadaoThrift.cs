...
namespace br.gov.saude.esus.cds.transport.generated.thrift.cadastroindividual
{
  ...
  public partial class IdentificacaoUsuarioCidadaoThrift : TBase
  {
    ...
    private long _dataNascimentoResponsavelV2000;
    ...
    public long DataNascimentoResponsavelV2000
    {
      get
      {
        return _dataNascimentoResponsavelV2000;
      }
      set
      {
        __isset.dataNascimentoResponsavelV2000 = true;
        this._dataNascimentoResponsavelV2000 = value;
      }
    }
    ...
    public struct Isset {
      ...
      public bool dataNascimentoResponsavelV2000;
      public bool desconheceNomeMae;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (__isset.dataNascimentoResponsavelV2000) {
          field.Name = "dataNascimentoResponsavelV2000";
          field.Type = TType.I64;
          field.ID = 4;
          oprot.WriteFieldBegin(field);
        ...
        if (CpfResponsavelFamiliar != null && __isset.cpfResponsavelFamiliar) {
          field.Name = "cpfResponsavelFamiliar";
          field.Type = TType.String;
          field.ID = 27;
          oprot.WriteFieldBegin(field);
    ...
    public override string ToString() {
      ...
      if (__isset.dataNascimentoResponsavelV2000) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("DataNascimentoResponsavelV2000: ");
        __sb.Append(DataNascimentoResponsavelV2000);
      }
      if (__isset.desconheceNomeMae) {
        if(!__first) { __sb.Append(", "); }

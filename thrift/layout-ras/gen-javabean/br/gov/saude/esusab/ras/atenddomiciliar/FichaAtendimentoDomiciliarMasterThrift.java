...
public class FichaAtendimentoDomiciliarMasterThrift implements org.apache.thrift.TBase<FichaAtendimentoDomiciliarMasterThrift, FichaAtendimentoDomiciliarMasterThrift._Fields>, java.io.Serializable, Cloneable, Comparable<FichaAtendimentoDomiciliarMasterThrift> {
  ...
  private static final _Fields optionals[] = {_Fields.TP_CDS_ORIGEM,_Fields.ATENDIMENTOS_DOMICILIARES,_Fields.HEADER_TRANSPORT};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.atendimentosDomiciliares = new ArrayList<FichaAtendimentoDomiciliarChildThrift>(_list16.size);
                FichaAtendimentoDomiciliarChildThrift _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new FichaAtendimentoDomiciliarChildThrift();
                  _elem17.read(iprot);
                  struct.atendimentosDomiciliares.add(_elem17);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.atendimentosDomiciliares != null) {
        if (struct.isSetAtendimentosDomiciliares()) {
          oprot.writeFieldBegin(ATENDIMENTOS_DOMICILIARES_FIELD_DESC);
          {
            ...
            for (FichaAtendimentoDomiciliarChildThrift _iter19 : struct.atendimentosDomiciliares)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetAtendimentosDomiciliares()) {
        {
          ...
          for (FichaAtendimentoDomiciliarChildThrift _iter20 : struct.atendimentosDomiciliares)
          {
            _iter20.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.atendimentosDomiciliares = new ArrayList<FichaAtendimentoDomiciliarChildThrift>(_list21.size);
          FichaAtendimentoDomiciliarChildThrift _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new FichaAtendimentoDomiciliarChildThrift();
            _elem22.read(iprot);
            struct.atendimentosDomiciliares.add(_elem22);
          }
        }
        struct.setAtendimentosDomiciliaresIsSet(true);
      }
